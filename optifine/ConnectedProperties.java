...
public class ConnectedProperties {
  ...
  public ConnectedProperties(Properties p_i27_1_, String p_i27_2_) {
    ...
    this.matchTiles = parseMatchTiles(p_i27_1_.getProperty("matchTiles"));
    this.method = parseMethod(p_i27_1_.getProperty("method"));
    this.tiles = parseTileNames(p_i27_1_.getProperty("tiles"));
    ...
    this.ctmTileIndexes = parseCtmTileIndexes(p_i27_1_);
    ...
    this.connectTiles = parseMatchTiles(p_i27_1_.getProperty("connectTiles"));
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\optifine\ConnectedProperties.class
