...
public class RenderEnv {
  ...
  public boolean isBreakingAnimation(List p_isBreakingAnimation_1_) {
    if (this.breakingAnimation == -1 && p_isBreakingAnimation_1_.size() > 0)
      if (p_isBreakingAnimation_1_.get(0) instanceof net.minecraft.client.renderer.block.model.BakedQuadRetextured) {
        this.breakingAnimation = 1;
      } else {
  ...
  public boolean isBreakingAnimation(BakedQuad p_isBreakingAnimation_1_) {
    if (this.breakingAnimation < 0)
      if (p_isBreakingAnimation_1_ instanceof net.minecraft.client.renderer.block.model.BakedQuadRetextured) {
        this.breakingAnimation = 1;
      } else {
        this.breakingAnimation = 0;
      }  
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\optifine\RenderEnv.class
