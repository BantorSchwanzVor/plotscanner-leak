...
public class ConnectedTextures {
  ...
  private static boolean skipConnectedTexture(IBlockAccess p_skipConnectedTexture_0_, IBlockState p_skipConnectedTexture_1_, BlockPos p_skipConnectedTexture_2_, BakedQuad p_skipConnectedTexture_3_, RenderEnv p_skipConnectedTexture_4_) {
    ...
    if (block instanceof BlockPane) {
      ...
      if (iblockstate.getBlock() != block)
        return false; 
      if (block == Blocks.STAINED_GLASS_PANE && iblockstate.getValue((IProperty)BlockStainedGlassPane.COLOR) != p_skipConnectedTexture_1_.getValue((IProperty)BlockStainedGlassPane.COLOR))
        return false; 
  ...
  private static BakedQuad[] getConnectedTexture(ConnectedProperties p_getConnectedTexture_0_, IBlockAccess p_getConnectedTexture_1_, BlockStateBase p_getConnectedTexture_2_, BlockPos p_getConnectedTexture_3_, int p_getConnectedTexture_4_, BakedQuad p_getConnectedTexture_5_, int p_getConnectedTexture_6_, RenderEnv p_getConnectedTexture_7_) {
    ...
    if (i1 >= p_getConnectedTexture_0_.minHeight && i1 <= p_getConnectedTexture_0_.maxHeight) {
      ...
      switch (p_getConnectedTexture_0_.method) {
        case 1:
          return getQuads(getConnectedTextureCtm(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, textureatlassprite, j, p_getConnectedTexture_7_), p_getConnectedTexture_5_, p_getConnectedTexture_7_);
        case 2:
          return getQuads(getConnectedTextureHorizontal(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, textureatlassprite, j), p_getConnectedTexture_5_, p_getConnectedTexture_7_);
        case 3:
          return getQuads(getConnectedTextureTop(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, textureatlassprite, j), p_getConnectedTexture_5_, p_getConnectedTexture_7_);
        case 4:
        ...
        case 6:
          return getQuads(getConnectedTextureVertical(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, textureatlassprite, j), p_getConnectedTexture_5_, p_getConnectedTexture_7_);
        case 7:
          return getQuads(getConnectedTextureFixed(p_getConnectedTexture_0_), p_getConnectedTexture_5_, p_getConnectedTexture_7_);
        case 8:
          return getQuads(getConnectedTextureHorizontalVertical(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, textureatlassprite, j), p_getConnectedTexture_5_, p_getConnectedTexture_7_);
        case 9:
          return getQuads(getConnectedTextureVerticalHorizontal(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, textureatlassprite, j), p_getConnectedTexture_5_, p_getConnectedTexture_7_);
        case 10:
          if (p_getConnectedTexture_6_ == 0)
            return getConnectedTextureCtmCompact(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, p_getConnectedTexture_5_, j, p_getConnectedTexture_7_); 
        default:
          return null;
        case 11:
          break;
      } 
      return getConnectedTextureOverlay(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, p_getConnectedTexture_5_, j, p_getConnectedTexture_7_);
    } 
    return null;
  }
  ...
  private static boolean isNeighbourOverlay(ConnectedProperties p_isNeighbourOverlay_0_, IBlockAccess p_isNeighbourOverlay_1_, IBlockState p_isNeighbourOverlay_2_, BlockPos p_isNeighbourOverlay_3_, int p_isNeighbourOverlay_4_, TextureAtlasSprite p_isNeighbourOverlay_5_, int p_isNeighbourOverlay_6_) {
    ...
    if (p_isNeighbourOverlay_0_.connectTileIcons != null) {
      ...
      if (!Config.isSameOne(textureatlassprite, (Object[])p_isNeighbourOverlay_0_.connectTileIcons))
        return false; 
    } 
  ...
  private static boolean isFullCubeModel(IBlockState p_isFullCubeModel_0_) {
    ...
    if (block instanceof net.minecraft.block.BlockGlass)
      return true; 
    return block instanceof net.minecraft.block.BlockStainedGlass;
  }
  ...
  private static TextureAtlasSprite getNeighbourIcon(IBlockAccess p_getNeighbourIcon_0_, IBlockState p_getNeighbourIcon_1_, BlockPos p_getNeighbourIcon_2_, IBlockState p_getNeighbourIcon_3_, int p_getNeighbourIcon_4_) {
    ...
    List<BakedQuad> list = ibakedmodel.getQuads(p_getNeighbourIcon_3_, enumfacing, 0L);
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\optifine\ConnectedTextures.class
