...
public class CustomColors {
  ...
  public static int getDurabilityColor(float p_getDurabilityColor_0_, int p_getDurabilityColor_1_) {
    ...
    int i = (int)(p_getDurabilityColor_0_ * durabilityColors.getLength());
  ...
  public static Vec3d getWorldFogColor(Vec3d p_getWorldFogColor_0_, World p_getWorldFogColor_1_, Entity p_getWorldFogColor_2_, float p_getWorldFogColor_3_) {
    ...
    switch (dimensiontype) {
      ...
      case OVERWORLD:
        ...
        p_getWorldFogColor_0_ = getFogColor(p_getWorldFogColor_0_, (IBlockAccess)minecraft.world, p_getWorldFogColor_2_.posX, p_getWorldFogColor_2_.posY + 1.0D, p_getWorldFogColor_2_.posZ);
        break;
      case THE_END:
  ...
  public static Vec3d getWorldSkyColor(Vec3d p_getWorldSkyColor_0_, World p_getWorldSkyColor_1_, Entity p_getWorldSkyColor_2_, float p_getWorldSkyColor_3_) {
    ...
    switch (dimensiontype) {
      case OVERWORLD:
        minecraft = Minecraft.getMinecraft();
        p_getWorldSkyColor_0_ = getSkyColor(p_getWorldSkyColor_0_, (IBlockAccess)minecraft.world, p_getWorldSkyColor_2_.posX, p_getWorldSkyColor_2_.posY + 1.0D, p_getWorldSkyColor_2_.posZ);
        break;
      case THE_END:
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\optifine\CustomColors.class
