...
public class CustomColormap implements CustomColors.IColorizer {
  ...
  public CustomColormap(Properties p_i29_1_, String p_i29_2_, int p_i29_3_, int p_i29_4_, String p_i29_5_) {
    ...
    this.format = parseFormat(p_i29_1_.getProperty("format", p_i29_5_));
  ...
  public boolean isValid(String p_isValid_1_) {
    if (this.format != 0 && this.format != 1) {
      ...
      if (this.color < 0) {
        ...
        if (this.format == 1)
          this.color = getColorGrid(Biomes.PLAINS, new BlockPos(0, 64, 0)); 
      } 
    } 
    return true;
  }
  ...
  public int getColor(Biome p_getColor_1_, BlockPos p_getColor_2_) {
    ...
    return (this.format == 1) ? getColorGrid(p_getColor_1_, p_getColor_2_) : this.color;
  }
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\optifine\CustomColormap.class
