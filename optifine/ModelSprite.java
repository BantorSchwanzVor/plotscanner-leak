...
public class ModelSprite {
  ...
  public static void renderItemIn2D(Tessellator p_renderItemIn2D_0_, float p_renderItemIn2D_1_, float p_renderItemIn2D_2_, float p_renderItemIn2D_3_, float p_renderItemIn2D_4_, int p_renderItemIn2D_5_, int p_renderItemIn2D_6_, float p_renderItemIn2D_7_, float p_renderItemIn2D_8_, float p_renderItemIn2D_9_) {
    ...
    for (int i = 0; i < p_renderItemIn2D_5_; i++) {
      ...
      bufferbuilder.pos(f4 * d0, d1, p_renderItemIn2D_7_).tex(f5, p_renderItemIn2D_4_).endVertex();
      bufferbuilder.pos(f4 * d0, d1, 0.0D).tex(f5, p_renderItemIn2D_4_).endVertex();
      bufferbuilder.pos(f4 * d0, 0.0D, 0.0D).tex(f5, p_renderItemIn2D_2_).endVertex();
      bufferbuilder.pos(f4 * d0, 0.0D, p_renderItemIn2D_7_).tex(f5, p_renderItemIn2D_2_).endVertex();
    } 
    p_renderItemIn2D_0_.draw();
    GL11.glNormal3f(1.0F, 0.0F, 0.0F);
    bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
    for (int j = 0; j < p_renderItemIn2D_5_; j++) {
      ...
      bufferbuilder.pos(f6 * d0, 0.0D, p_renderItemIn2D_7_).tex(f10, p_renderItemIn2D_2_).endVertex();
      bufferbuilder.pos(f6 * d0, 0.0D, 0.0D).tex(f10, p_renderItemIn2D_2_).endVertex();
      bufferbuilder.pos(f6 * d0, d1, 0.0D).tex(f10, p_renderItemIn2D_4_).endVertex();
      bufferbuilder.pos(f6 * d0, d1, p_renderItemIn2D_7_).tex(f10, p_renderItemIn2D_4_).endVertex();
    } 
    p_renderItemIn2D_0_.draw();
    ...
    for (int k = 0; k < p_renderItemIn2D_6_; k++) {
      ...
      bufferbuilder.pos(0.0D, f13 * d1, p_renderItemIn2D_7_).tex(p_renderItemIn2D_1_, f11).endVertex();
      bufferbuilder.pos(d0, f13 * d1, p_renderItemIn2D_7_).tex(p_renderItemIn2D_3_, f11).endVertex();
      bufferbuilder.pos(d0, f13 * d1, 0.0D).tex(p_renderItemIn2D_3_, f11).endVertex();
      bufferbuilder.pos(0.0D, f13 * d1, 0.0D).tex(p_renderItemIn2D_1_, f11).endVertex();
    } 
    p_renderItemIn2D_0_.draw();
    GL11.glNormal3f(0.0F, -1.0F, 0.0F);
    bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
    for (int l = 0; l < p_renderItemIn2D_6_; l++) {
      ...
      bufferbuilder.pos(d0, f9 * d1, p_renderItemIn2D_7_).tex(p_renderItemIn2D_3_, f12).endVertex();
      bufferbuilder.pos(0.0D, f9 * d1, p_renderItemIn2D_7_).tex(p_renderItemIn2D_1_, f12).endVertex();
      bufferbuilder.pos(0.0D, f9 * d1, 0.0D).tex(p_renderItemIn2D_1_, f12).endVertex();
      bufferbuilder.pos(d0, f9 * d1, 0.0D).tex(p_renderItemIn2D_3_, f12).endVertex();
    } 
    p_renderItemIn2D_0_.draw();
  }
}
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\optifine\ModelSprite.class
