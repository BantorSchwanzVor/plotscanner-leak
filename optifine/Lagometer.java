  ...
  public static void showLagometer(ScaledResolution p_showLagometer_0_) {
    if (gameSettings != null)
      if (gameSettings.ofLagometer || gameSettings.showLagometer) {
        ...
        renderTimeDivider(0, timesFrame.length, 33333333L, 196, 196, 196, mc.displayHeight, bufferbuilder);
        renderTimeDivider(0, timesFrame.length, 16666666L, 196, 196, 196, mc.displayHeight, bufferbuilder);
        tessellator.draw();
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\optifine\Lagometer.class
