  ...
  private class AddAltThread extends Thread {
    ...
    private final void checkAndAddAlt(String username, String password) throws IOException {
      ...
      try {
        ...
        GuiAddAlt.this.status = "§c" + "Alt failed!";
        e.printStackTrace();
      } 
    }
    ...
    public void run() {
      if (this.password.equals("")) {
        ...
        GuiAddAlt.this.status = "§a" + "Alt added. (" + this.username + " - offline name)";
        return;
      } 
      GuiAddAlt.this.status = "§e" + "Trying alt...";
      try {
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\org\seltak\anubis\al\\ui\GuiAddAlt.class
