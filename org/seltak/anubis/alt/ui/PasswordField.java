...
public class PasswordField extends Gui {
  ...
  public void mouseClicked(int par1, int par2, int par3) {
    ...
    if (this.isFocused && par3 == 0) {
      ...
      if (this.enableBackgroundDrawing)
        var5 -= 4; 
      String var6 = this.fontRenderer.trimStringToWidth(this.text.substring(this.i), getWidth());
      setCursorPosition(this.fontRenderer.trimStringToWidth(var6, var5).length() + this.i);
    } 
  }
  ...
  public void drawTextBox() {
    if (func_73778_q()) {
      ...
      String var4 = this.fontRenderer.trimStringToWidth(this.text.substring(this.i), getWidth());
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\org\seltak\anubis\al\\ui\PasswordField.class
