...
public class Graphics {
  ...
  public void copyArea(Image target, int x, int y) {
    ...
    target.bind();
    GL.glCopyTexImage2D(3553, 0, format, x, this.screenHeight - 
  ...
  public Color getPixel(int x, int y) {
    predraw();
    GL.glReadPixels(x, this.screenHeight - y, 1, 1, 6408, 
        5121, this.readBuffer);
    postdraw();
    return new Color(translate(this.readBuffer.get(0)), translate(this.readBuffer
          .get(1)), translate(this.readBuffer.get(2)), translate(this.readBuffer
          .get(3)));
  }
  ...
  public void getArea(int x, int y, int width, int height, ByteBuffer target) {
    ...
    predraw();
    GL.glReadPixels(x, this.screenHeight - y - height, width, height, 6408, 
        5121, target);
    postdraw();
  }
