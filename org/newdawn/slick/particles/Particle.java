...
public class Particle {
  ...
  public void render() {
    if ((this.engine.usePoints() && this.usePoints == 1) || 
      this.usePoints == 2) {
      ...
      this.image.draw((int)-(this.size / 2.0F), (int)-(this.size / 2.0F), (int)this.size, 
          (int)this.size, this.color);
      GL.glPopMatrix();
    } else {
      this.color.bind();
      this.image.drawEmbedded((int)(this.x - this.size / 2.0F), (int)(this.y - this.size / 2.0F), 
