...
public class Line extends Shape {
  ...
  public boolean intersect(Line other, boolean limit, Vector2f result) {
    ...
    if (denom == 0.0F)
      return false; 
    float ua = dx2 * (this.start.getY() - other.start.getY()) - 
      dy2 * (this.start.getX() - other.start.getX());
    ua /= denom;
    float ub = dx1 * (this.start.getY() - other.start.getY()) - 
      dy1 * (this.start.getX() - other.start.getX());
    ub /= denom;
