...
public class InputProvider {
  ...
  public InputProvider(Input input) {
    this.input = input;
    input.addListener((InputListener)new InputListenerImpl(null));
  ...
  private class InputListenerImpl extends InputAdapter {
    ...
    public void mousePressed(int button, int x, int y) {
      Command command = (Command)InputProvider.this.commands.get(new MouseButtonControl(
            button));
      if (command != null)
        InputProvider.this.firePressed(command); 
    }
    ...
    public void controllerLeftPressed(int controller) {
      Command command = (Command)InputProvider.this.commands
