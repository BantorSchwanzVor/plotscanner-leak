...
public class FontTest extends BasicGame {
  ...
  public void render(GameContainer container, Graphics g) {
    ...
    this.font.drawString(100.0F, (36 + this.font.getHeight("We Here is a more complete line that hopefully")), 
    ...
    this.font2.drawString(100.0F, (136 + this.font2.getHeight("We - Here is a more complete line that hopefully")), 
        "will show some kerning.");
