...
public class ScalableGame implements Game {
  ...
  public void recalculateScale() throws SlickException {
    ...
    this.container.getInput().setScale(this.normalWidth / this.targetWidth, 
        this.normalHeight / this.targetHeight);
    int yoffset = 0;
    int xoffset = 0;
    ...
    this.container.getInput().setOffset(-xoffset / this.targetWidth / this.normalWidth, 
