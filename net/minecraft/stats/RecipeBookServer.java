...
public class RecipeBookServer extends RecipeBook {
  ...
  private void func_194081_a(SPacketRecipeBook.State p_194081_1_, EntityPlayerMP p_194081_2_, List<IRecipe> p_194081_3_) {
    p_194081_2_.connection.sendPacket((Packet)new SPacketRecipeBook(p_194081_1_, p_194081_3_, Collections.emptyList(), this.field_192818_b, this.field_192819_c));
  }
  ...
  public NBTTagCompound func_192824_e() {
    ...
    for (IRecipe irecipe : func_194079_d())
      nbttaglist.appendTag((NBTBase)new NBTTagString(((ResourceLocation)CraftingManager.field_193380_a.getNameForObject(irecipe)).toString())); 
    nbttagcompound.setTag("recipes", (NBTBase)nbttaglist);
    NBTTagList nbttaglist1 = new NBTTagList();
    for (IRecipe irecipe1 : func_194080_e())
      nbttaglist1.appendTag((NBTBase)new NBTTagString(((ResourceLocation)CraftingManager.field_193380_a.getNameForObject(irecipe1)).toString())); 
    nbttagcompound.setTag("toBeDisplayed", (NBTBase)nbttaglist1);
  ...
  private List<IRecipe> func_194079_d() {
    ...
    for (int i = this.field_194077_a.nextSetBit(0); i >= 0; i = this.field_194077_a.nextSetBit(i + 1))
      list.add((IRecipe)CraftingManager.field_193380_a.getObjectById(i)); 
    return list;
  }
  ...
  public void func_192826_c(EntityPlayerMP p_192826_1_) {
    p_192826_1_.connection.sendPacket((Packet)new SPacketRecipeBook(SPacketRecipeBook.State.INIT, func_194079_d(), func_194080_e(), this.field_192818_b, this.field_192819_c));
  }
}
