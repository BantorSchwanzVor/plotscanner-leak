...
public abstract class CreativeTabs {
  ...
  public static final CreativeTabs DECORATIONS = new CreativeTabs(1, "decorations") {
      public ItemStack getTabIconItem() {
        return new ItemStack(Item.getItemFromBlock((Block)Blocks.DOUBLE_PLANT), 1, BlockDoublePlant.EnumPlantType.PAEONIA.getMeta());
      }
    };
  ...
  public static final CreativeTabs BREWING = new CreativeTabs(10, "brewing") {
      public ItemStack getTabIconItem() {
        return PotionUtils.addPotionToItemStack(new ItemStack((Item)Items.POTIONITEM), PotionTypes.WATER);
      }
    };
  ...
  public static final CreativeTabs INVENTORY = (new CreativeTabs(11, "inventory") {
      public ItemStack getTabIconItem() {
        return new ItemStack(Item.getItemFromBlock((Block)Blocks.CHEST));
      }
  ...
  public ItemStack getIconItemStack() {
    if (this.iconItemStack.func_190926_b())
      this.iconItemStack = getTabIconItem(); 
