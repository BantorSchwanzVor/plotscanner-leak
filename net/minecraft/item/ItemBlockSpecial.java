...
public class ItemBlockSpecial extends Item {
  ...
  public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY) {
    ...
    if (block == Blocks.SNOW_LAYER && ((Integer)iblockstate.getValue((IProperty)BlockSnow.LAYERS)).intValue() < 1) {
      hand = EnumFacing.UP;
    } else if (!block.isReplaceable((IBlockAccess)playerIn, worldIn)) {
    ...
    if (!itemstack.func_190926_b() && stack.canPlayerEdit(worldIn, hand, itemstack) && playerIn.func_190527_a(this.block, worldIn, false, hand, null)) {
      IBlockState iblockstate1 = this.block.onBlockPlaced(playerIn, worldIn, hand, facing, hitX, hitY, 0, (EntityLivingBase)stack);
      ...
      if (iblockstate1.getBlock() == this.block) {
        ...
        iblockstate1.getBlock().onBlockPlacedBy(playerIn, worldIn, iblockstate1, (EntityLivingBase)stack, itemstack);
