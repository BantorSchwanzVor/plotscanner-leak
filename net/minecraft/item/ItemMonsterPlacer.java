...
public class ItemMonsterPlacer extends Item {
  ...
  public String getItemStackDisplayName(ItemStack stack) {
    String s = I18n.translateToLocal(String.valueOf(getUnlocalizedName()) + ".name").trim();
  ...
  public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY) {
    ...
    if (entity != null) {
      if (entity instanceof net.minecraft.entity.EntityLivingBase && itemstack.hasDisplayName())
  ...
  public ActionResult<ItemStack> onItemRightClick(World itemStackIn, EntityPlayer worldIn, EnumHand playerIn) {
    ...
    if (raytraceresult != null && raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK) {
      ...
      if (!(itemStackIn.getBlockState(blockpos).getBlock() instanceof net.minecraft.block.BlockLiquid))
        return new ActionResult(EnumActionResult.PASS, itemstack); 
  ...
  public static void applyEntityIdToItemStack(ItemStack stack, ResourceLocation entityId) {
    ...
    nbttagcompound.setTag("EntityTag", (NBTBase)nbttagcompound1);
