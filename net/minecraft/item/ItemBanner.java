...
public class ItemBanner extends ItemBlock {
    ...
    if (hand != EnumFacing.DOWN && (iblockstate.getMaterial().isSolid() || flag) && (!flag || hand == EnumFacing.UP)) {
      ...
      if (stack.canPlayerEdit(worldIn, hand, itemstack) && Blocks.STANDING_BANNER.canPlaceBlockAt(playerIn, worldIn)) {
        ...
        if (hand == EnumFacing.UP) {
          ...
          playerIn.setBlockState(worldIn, Blocks.STANDING_BANNER.getDefaultState().withProperty((IProperty)BlockStandingSign.ROTATION, Integer.valueOf(i)), 3);
        } else {
          playerIn.setBlockState(worldIn, Blocks.WALL_BANNER.getDefaultState().withProperty((IProperty)BlockWallSign.FACING, (Comparable)hand), 3);
        } 
  ...
  public static ItemStack func_190910_a(EnumDyeColor p_190910_0_, @Nullable NBTTagList p_190910_1_) {
    ...
    if (p_190910_1_ != null && !p_190910_1_.hasNoTags())
      itemstack.func_190925_c("BlockEntityTag").setTag("Patterns", (NBTBase)p_190910_1_.copy()); 
    return itemstack;
  }
