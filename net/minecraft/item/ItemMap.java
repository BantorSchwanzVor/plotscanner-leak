...
public class ItemMap extends ItemMapBase {
  ...
  public static ItemStack func_190906_a(World p_190906_0_, double p_190906_1_, double p_190906_3_, byte p_190906_5_, boolean p_190906_6_, boolean p_190906_7_) {
    ...
    p_190906_0_.setItemData(s, (WorldSavedData)mapdata);
            ...
            if (k1 >= 0 && l1 >= -1 && k1 < 128 && l1 < 128) {
              ...
              if (!chunk.isEmpty()) {
                ...
                if (worldIn.provider.getHasNoSky()) {
                  ...
                  if ((l3 >> 20 & 0x1) == 0) {
                    hashMultiset.add(Blocks.DIRT.getDefaultState().withProperty((IProperty)BlockDirt.VARIANT, (Comparable)BlockDirt.DirtType.DIRT).getMapColor((IBlockAccess)worldIn, BlockPos.ORIGIN), 10);
                  } else {
                    hashMultiset.add(Blocks.STONE.getDefaultState().withProperty((IProperty)BlockStone.VARIANT, (Comparable)BlockStone.EnumType.STONE).getMapColor((IBlockAccess)worldIn, BlockPos.ORIGIN), 100);
                  } 
                  d1 = 100.0D;
                } else {
                  ...
                  for (int i4 = 0; i4 < i; i4++) {
                    for (int j4 = 0; j4 < i; j4++) {
                      ...
                      if (k4 <= 1) {
                        ...
                        } while (iblockstate.getMapColor((IBlockAccess)worldIn, (BlockPos)blockpos$mutableblockpos) == MapColor.AIR && k4 > 0);
                      ...
                      d1 += 
                        ...
                        k4 / (i * i);
                      hashMultiset.add(iblockstate.getMapColor((IBlockAccess)worldIn, (BlockPos)blockpos$mutableblockpos));
                    } 
                  } 
                } 
                k3 /= i * i;
                ...
                if (d2 < -0.6D)
                  i5 = 0; 
                MapColor mapcolor = (MapColor)Iterables.getFirst((Iterable)Multisets.copyHighestCountFirst((Multiset)hashMultiset), MapColor.AIR);
  ...
  protected static void scaleMap(ItemStack p_185063_0_, World p_185063_1_, int p_185063_2_) {
    ...
    if (mapdata != null) {
      ...
      mapdata1.markDirty();
      p_185063_1_.setItemData("map_" + p_185063_0_.getMetadata(), (WorldSavedData)mapdata1);
    } 
  }
  ...
  protected static void enableMapTracking(ItemStack p_185064_0_, World p_185064_1_) {
    ...
    if (mapdata != null) {
      ...
      mapdata1.dimension = mapdata.dimension;
      mapdata1.markDirty();
      p_185064_1_.setItemData("map_" + p_185064_0_.getMetadata(), (WorldSavedData)mapdata1);
    } 
  }
  ...
  public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
    if (advanced.func_194127_a()) {
      ...
      if (mapdata != null) {
        tooltip.add(I18n.translateToLocalFormatted("filled_map.scale", new Object[] { Integer.valueOf(1 << mapdata.scale) }));
        tooltip.add(I18n.translateToLocalFormatted("filled_map.level", new Object[] { Byte.valueOf(mapdata.scale), Integer.valueOf(4) }));
      } else {
