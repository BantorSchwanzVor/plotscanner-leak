...
public class ItemBlock extends Item {
  ...
  public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY) {
    ...
    if (!itemstack.func_190926_b() && stack.canPlayerEdit(worldIn, hand, itemstack) && playerIn.func_190527_a(this.block, worldIn, false, hand, null)) {
      ...
      IBlockState iblockstate1 = this.block.onBlockPlaced(playerIn, worldIn, hand, facing, hitX, hitY, i, (EntityLivingBase)stack);
      if (playerIn.setBlockState(worldIn, iblockstate1, 11)) {
        ...
        if (iblockstate1.getBlock() == this.block) {
          ...
          this.block.onBlockPlacedBy(playerIn, worldIn, iblockstate1, (EntityLivingBase)stack, itemstack);
