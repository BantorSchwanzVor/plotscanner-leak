...
public class ShapedRecipes implements IRecipe {
  ...
  private static int func_194135_a(String p_194135_0_) {
    for (int i = 0; i < p_194135_0_.length() && p_194135_0_.charAt(i) == ' '; i++);
    return i;
  }
  
  private static int func_194136_b(String p_194136_0_) {
    for (int i = p_194136_0_.length() - 1; i >= 0 && p_194136_0_.charAt(i) == ' '; i--);
    return i;
  }
  ...
  private static Map<String, Ingredient> func_192408_a(JsonObject p_192408_0_) {
    ...
    for (Map.Entry<String, JsonElement> entry : (Iterable<Map.Entry<String, JsonElement>>)p_192408_0_.entrySet()) {
  ...
  public static Ingredient func_193361_a(@Nullable JsonElement p_193361_0_) {
    if (p_193361_0_ != null && !p_193361_0_.isJsonNull()) {
      if (p_193361_0_.isJsonObject())
        return Ingredient.func_193369_a(new ItemStack[] { func_192405_a(p_193361_0_.getAsJsonObject(), false) }); 
