...
public class RecipesBanners {
  public static class RecipeAddPattern implements IRecipe {
    ...
    private BannerPattern func_190933_c(InventoryCrafting p_190933_1_) {
      ...
      for (i = (arrayOfBannerPattern = BannerPattern.values()).length, b = 0; b < i; ) {
        BannerPattern bannerpattern = arrayOfBannerPattern[b];
        if (bannerpattern.func_191000_d()) {
          boolean flag = true;
          if (bannerpattern.func_190999_e()) {
            boolean flag1 = false;
            boolean flag2 = false;
            for (int j = 0; j < p_190933_1_.getSizeInventory() && flag; j++) {
              ItemStack itemstack = p_190933_1_.getStackInSlot(j);
