  ...
  public boolean matches(InventoryCrafting inv, World worldIn) {
    ...
    if (j <= 3 && i <= 1) {
      if (j >= 1 && i == 1 && i1 == 0) {
        ...
        nbttagcompound3.setTag("Fireworks", (NBTBase)nbttagcompound1);
        ...
        for (int l1 = 0; l1 < inv.getSizeInventory(); l1++) {
          ...
          if (!itemstack2.func_190926_b())
            if (itemstack2.getItem() == Items.DYE) {
              list.add(Integer.valueOf(ItemDye.DYE_COLORS[itemstack2.getMetadata() & 0xF]));
        ...
        for (int i2 = 0; i2 < inv.getSizeInventory(); i2++) {
          ...
          if (!itemstack1.func_190926_b())
            if (itemstack1.getItem() == Items.DYE) {
              list1.add(Integer.valueOf(ItemDye.DYE_COLORS[itemstack1.getMetadata() & 0xF]));
