...
public class ItemArmor extends Item {
  ...
  public static final IBehaviorDispenseItem DISPENSER_BEHAVIOR = (IBehaviorDispenseItem)new BehaviorDefaultDispenseItem() {
  ...
  public static ItemStack dispenseArmor(IBlockSource blockSource, ItemStack stack) {
    BlockPos blockpos = blockSource.getBlockPos().offset((EnumFacing)blockSource.getBlockState().getValue((IProperty)BlockDispenser.FACING));
  ...
  public enum ArmorMaterial {
    LEATHER("leather", 5, (String)new int[] { 1, 2, 3, 1 }, 15, (int[])SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F),
    CHAIN("chainmail", 15, (String)new int[] { 1, 4, 5, 2 }, 12, (int[])SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 0.0F),
    IRON("iron", 15, (String)new int[] { 2, 5, 6, 2 }, 9, (int[])SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F),
    GOLD("gold", 7, (String)new int[] { 1, 3, 5, 2 }, 25, (int[])SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0F),
    DIAMOND("diamond", 33, (String)new int[] { 3, 6, 8, 3 }, 10, (int[])SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F);
