...
public class Item {
  ...
  private static final IItemPropertyGetter DAMAGE_GETTER = new IItemPropertyGetter() {
      public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
        return MathHelper.clamp(stack.getItemDamage() / stack.getMaxDamage(), 0.0F, 1.0F);
      }
    };
  ...
  private final IRegistry<ResourceLocation, IItemPropertyGetter> properties = (IRegistry<ResourceLocation, IItemPropertyGetter>)new RegistrySimple();
  ...
  public String getItemStackDisplayName(ItemStack stack) {
    return I18n.translateToLocal(String.valueOf(getUnlocalizedNameInefficiently(stack)) + ".name").trim();
  }
  ...
  public static void registerItems() {
    ...
    registerItemBlock((Block)Blocks.SAND, (new ItemMultiTexture((Block)Blocks.SAND, (Block)Blocks.SAND, new ItemMultiTexture.Mapper() {
            public String apply(ItemStack p_apply_1_) {
    ...
    registerItemBlock((Block)Blocks.YELLOW_FLOWER, (new ItemMultiTexture((Block)Blocks.YELLOW_FLOWER, (Block)Blocks.YELLOW_FLOWER, new ItemMultiTexture.Mapper() {
            public String apply(ItemStack p_apply_1_) {
    ...
    registerItemBlock((Block)Blocks.RED_FLOWER, (new ItemMultiTexture((Block)Blocks.RED_FLOWER, (Block)Blocks.RED_FLOWER, new ItemMultiTexture.Mapper() {
            public String apply(ItemStack p_apply_1_) {
    ...
    registerItemBlock((Block)Blocks.PURPUR_SLAB, (new ItemSlab((Block)Blocks.PURPUR_SLAB, Blocks.PURPUR_SLAB, Blocks.PURPUR_DOUBLE_SLAB)).setUnlocalizedName("purpurSlab"));
    ...
    registerItemBlock((Block)Blocks.DOUBLE_PLANT, (new ItemMultiTexture((Block)Blocks.DOUBLE_PLANT, (Block)Blocks.DOUBLE_PLANT, new ItemMultiTexture.Mapper() {
            public String apply(ItemStack p_apply_1_) {
    ...
    registerItem(324, "wooden_door", (new ItemDoor((Block)Blocks.OAK_DOOR)).setUnlocalizedName("doorOak"));
    ...
    registerItem(330, "iron_door", (new ItemDoor((Block)Blocks.IRON_DOOR)).setUnlocalizedName("doorIron"));
    ...
    registerItem(338, "reeds", (new ItemBlockSpecial((Block)Blocks.REEDS)).setUnlocalizedName("reeds").setCreativeTab(CreativeTabs.MATERIALS));
    ...
    registerItem(356, "repeater", (new ItemBlockSpecial((Block)Blocks.UNPOWERED_REPEATER)).setUnlocalizedName("diode").setCreativeTab(CreativeTabs.REDSTONE));
    ...
    registerItem(380, "cauldron", (new ItemBlockSpecial((Block)Blocks.CAULDRON)).setUnlocalizedName("cauldron").setCreativeTab(CreativeTabs.BREWING));
    ...
    registerItem(404, "comparator", (new ItemBlockSpecial((Block)Blocks.UNPOWERED_COMPARATOR)).setUnlocalizedName("comparator").setCreativeTab(CreativeTabs.REDSTONE));
    ...
    registerItem(427, "spruce_door", (new ItemDoor((Block)Blocks.SPRUCE_DOOR)).setUnlocalizedName("doorSpruce"));
    registerItem(428, "birch_door", (new ItemDoor((Block)Blocks.BIRCH_DOOR)).setUnlocalizedName("doorBirch"));
    registerItem(429, "jungle_door", (new ItemDoor((Block)Blocks.JUNGLE_DOOR)).setUnlocalizedName("doorJungle"));
    registerItem(430, "acacia_door", (new ItemDoor((Block)Blocks.ACACIA_DOOR)).setUnlocalizedName("doorAcacia"));
    registerItem(431, "dark_oak_door", (new ItemDoor((Block)Blocks.DARK_OAK_DOOR)).setUnlocalizedName("doorDarkOak"));
