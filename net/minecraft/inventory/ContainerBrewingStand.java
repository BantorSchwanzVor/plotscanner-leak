...
public class ContainerBrewingStand extends Container {
  ...
  public ContainerBrewingStand(InventoryPlayer playerInventory, IInventory tileBrewingStandIn) {
    ...
    addSlotToContainer(new Potion(tileBrewingStandIn, 0, 56, 51));
    addSlotToContainer(new Potion(tileBrewingStandIn, 1, 79, 58));
    addSlotToContainer(new Potion(tileBrewingStandIn, 2, 102, 51));
    this.theSlot = addSlotToContainer(new Ingredient(tileBrewingStandIn, 3, 79, 17));
    addSlotToContainer(new Fuel(tileBrewingStandIn, 4, 17, 17));
    for (int i = 0; i < 3; i++) {
      for (int j = 0; j < 9; j++)
