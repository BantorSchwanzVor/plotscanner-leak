...
public class SPacketWindowItems implements Packet<INetHandlerPlayClient> {
  ...
  public SPacketWindowItems(int p_i47317_1_, NonNullList<ItemStack> p_i47317_2_) {
    ...
    this.itemStacks = (List<ItemStack>)NonNullList.func_191197_a(p_i47317_2_.size(), ItemStack.field_190927_a);
  ...
  public void readPacketData(PacketBuffer buf) throws IOException {
    ...
    int i = buf.readShort();
    this.itemStacks = (List<ItemStack>)NonNullList.func_191197_a(i, ItemStack.field_190927_a);
    for (int j = 0; j < i; j++)
