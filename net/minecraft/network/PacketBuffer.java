...
public class PacketBuffer extends ByteBuf {
  ...
  public PacketBuffer writeVarIntArray(int[] array) {
    ...
    byte b;
    int i, arrayOfInt[];
    for (i = (arrayOfInt = array).length, b = 0; b < i; ) {
      int j = arrayOfInt[b];
      writeVarIntToBuffer(j);
      b++;
    } 
    return this;
  }
  ...
  public PacketBuffer writeLongArray(long[] array) {
    ...
    int i;
    long[] arrayOfLong;
    for (i = (arrayOfLong = array).length, b = 0; b < i; ) {
  ...
  public ITextComponent readTextComponent() throws IOException {
    return ITextComponent.Serializer.jsonToComponent(readStringFromBuffer(32767));
  }
  ...
  public PacketBuffer writeString(String string) {
    ...
    if (abyte.length > 32767)
      throw new EncoderException("String too big (was " + abyte.length + " bytes encoded, max " + '翿' + ")"); 
