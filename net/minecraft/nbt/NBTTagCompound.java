...
public class NBTTagCompound extends NBTBase {
  ...
  public void setUniqueId(String key, UUID value) {
    setLong(String.valueOf(key) + "Most", value.getMostSignificantBits());
    setLong(String.valueOf(key) + "Least", value.getLeastSignificantBits());
  }
  
  @Nullable
  public UUID getUniqueId(String key) {
    return new UUID(getLong(String.valueOf(key) + "Most"), getLong(String.valueOf(key) + "Least"));
  }
  
  public boolean hasUniqueId(String key) {
    return (hasKey(String.valueOf(key) + "Most", 99) && hasKey(String.valueOf(key) + "Least", 99));
  }
