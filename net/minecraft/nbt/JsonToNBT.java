...
public class JsonToNBT {
  ...
  private String func_193614_i() {
    int i;
    for (i = this.field_193623_i; func_193612_g() && func_193599_a(func_193598_n()); this.field_193623_i++);
  ...
  private void func_193604_b(char p_193604_1_) throws NBTException {
    ...
    if (flag && func_193598_n() == p_193604_1_) {
      ...
      throw new NBTException("Expected '" + p_193604_1_ + "' but got '" + (flag ? Character.valueOf(func_193598_n()) : "<EOF>") + "'", this.field_193622_h, this.field_193623_i + 1);
    } 
  }
