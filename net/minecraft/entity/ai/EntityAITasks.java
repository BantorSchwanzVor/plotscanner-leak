...
public class EntityAITasks {
  ...
  private boolean canUse(EntityAITaskEntry taskEntry) {
    if (this.executingTaskEntries.isEmpty())
      return true; 
    if (isControlFlagDisabled(taskEntry.action.getMutexBits()))
      return false; 
  ...
  public void enableControlFlag(int p_188525_1_) {
    this.disabledControlFlags &= p_188525_1_ ^ 0xFFFFFFFF;
  }
  ...
  class EntityAITaskEntry {
    ...
    public boolean equals(@Nullable Object p_equals_1_) {
      if (this == p_equals_1_)
        return true; 
      return (p_equals_1_ != null && getClass() == p_equals_1_.getClass()) ? this.action.equals(((EntityAITaskEntry)p_equals_1_).action) : false;
    }
