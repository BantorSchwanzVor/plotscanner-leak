...
public class EntityAIAttackMelee extends EntityAIBase {
  ...
  public boolean shouldExecute() {
    ...
    if (this.entityPathEntity != null)
      return true; 
    return (getAttackReachSqr(entitylivingbase) >= this.attacker.getDistanceSq(entitylivingbase.posX, (entitylivingbase.getEntityBoundingBox()).minY, entitylivingbase.posZ));
  }
  ...
  public boolean continueExecuting() {
    ...
    if (!this.attacker.isWithinHomeDistanceFromPosition(new BlockPos((Entity)entitylivingbase)))
      return false; 
