...
public class EntityAIBreakDoor extends EntityAIDoorInteract {
  ...
  public boolean shouldExecute() {
    ...
    return !BlockDoor.isOpen((IBlockAccess)this.theEntity.world, this.doorPosition);
  }
  ...
  public boolean continueExecuting() {
    ...
    if (this.breakingTime <= 240) {
      BlockDoor blockdoor = this.doorBlock;
      if (!BlockDoor.isOpen((IBlockAccess)this.theEntity.world, this.doorPosition) && d0 < 4.0D) {
        boolean bool = true;
        return bool;
      } 
    } 
  ...
  public void updateTask() {
    ...
    if (this.breakingTime == 240 && this.theEntity.world.getDifficulty() == EnumDifficulty.HARD) {
      ...
      this.theEntity.world.playEvent(2001, this.doorPosition, Block.getIdFromBlock((Block)this.doorBlock));
    } 
  }
}
