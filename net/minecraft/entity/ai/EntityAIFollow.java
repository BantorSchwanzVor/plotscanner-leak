...
public class EntityAIFollow extends EntityAIBase {
  ...
  public EntityAIFollow(final EntityLiving p_i47417_1_, double p_i47417_2_, float p_i47417_4_, float p_i47417_5_) {
    ...
    setMutexBits(3);
    if (!(p_i47417_1_.getNavigator() instanceof net.minecraft.pathfinding.PathNavigateGround) && !(p_i47417_1_.getNavigator() instanceof net.minecraft.pathfinding.PathNavigateFlying))
  ...
  public boolean continueExecuting() {
    return (this.field_192374_c != null && !this.field_192376_e.noPath() && this.field_192372_a.getDistanceSqToEntity((Entity)this.field_192374_c) > (this.field_192378_g * this.field_192378_g));
  }
  ...
  public void updateTask() {
    if (this.field_192374_c != null && !this.field_192372_a.getLeashed()) {
      this.field_192372_a.getLookHelper().setLookPositionWithEntity((Entity)this.field_192374_c, 10.0F, this.field_192372_a.getVerticalFaceSpeed());
      if (--this.field_192377_f <= 0) {
        ...
        if (d3 > (this.field_192378_g * this.field_192378_g)) {
          this.field_192376_e.tryMoveToEntityLiving((Entity)this.field_192374_c, this.field_192375_d);
        } else {
          this.field_192376_e.clearPathEntity();
