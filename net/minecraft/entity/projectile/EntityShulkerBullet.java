...
public class EntityShulkerBullet extends Entity {
  ...
  public EntityShulkerBullet(World worldIn, EntityLivingBase ownerIn, Entity targetIn, EnumFacing.Axis p_i46772_4_) {
    ...
    setLocationAndAngles(d0, d1, d2, this.rotationYaw, this.rotationPitch);
  ...
  protected void writeEntityToNBT(NBTTagCompound compound) {
    ...
    if (this.target != null) {
      ...
      compound.setTag("Target", (NBTBase)nbttagcompound1);
    } 
  ...
  public void onUpdate() {
    if (!this.world.isRemote && this.world.getDifficulty() == EnumDifficulty.PEACEFUL) {
      ...
      if (!this.world.isRemote) {
        ...
        RayTraceResult raytraceresult = ProjectileHelper.forwardsRaycast(this, true, false, (Entity)this.owner);
