...
public class EntityFishHook extends Entity {
  ...
  private void func_190620_n() {
    ...
    this.rotationPitch = (float)(MathHelper.atan2(this.motionY, f7) * 57.29577951308232D);
  ...
  public void onUpdate() {
    ...
    if (this.angler == null) {
      setDead();
    } else if (this.world.isRemote || !func_190625_o()) {
      if (this.inGround) {
        this.ticksInGround++;
      ...
      if (iblockstate.getMaterial() == Material.WATER)
        f = BlockLiquid.func_190973_f(iblockstate, (IBlockAccess)this.world, blockpos); 
  ...
  private boolean func_190625_o() {
    ...
    if (!this.angler.isDead && this.angler.isEntityAlive() && (flag || flag1) && getDistanceSqToEntity((Entity)this.angler) <= 1024.0D)
      return false; 
    setDead();
    return true;
  }
  ...
  private void func_190624_r() {
    ...
    for (Entity entity1 : list) {
      if (canBeHooked(entity1) && (entity1 != this.angler || this.ticksInAir >= 5)) {
  ...
  private void func_190621_a(BlockPos p_190621_1_) {
    ...
    if (this.ticksCatchable > 0) {
      ...
      if (this.ticksCatchableDelay > 0) {
        ...
        double d1 = (MathHelper.floor((getEntityBoundingBox()).minY) + 1.0F);
      ...
      if (this.rand.nextFloat() < f5) {
        ...
        double d5 = (MathHelper.floor((getEntityBoundingBox()).minY) + 1.0F);
    ...
    if (!this.world.isRemote && this.angler != null) {
      ...
      if (this.caughtEntity != null) {
        ...
        for (ItemStack itemstack : this.world.getLootTableManager().getLootTableFromLocation(LootTableList.GAMEPLAY_FISHING).generateLootForPools(this.rand, lootcontext$builder.build())) {
          ...
          this.angler.world.spawnEntityInWorld((Entity)new EntityXPOrb(this.angler.world, this.angler.posX, this.angler.posY + 0.5D, this.angler.posZ + 0.5D, this.rand.nextInt(6) + 1));
