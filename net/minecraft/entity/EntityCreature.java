...
public abstract class EntityCreature extends EntityLiving {
  ...
  public boolean isWithinHomeDistanceFromPosition(BlockPos pos) {
    if (this.maximumHomeDistance == -1.0F)
      return true; 
    return (this.homePosition.distanceSq((Vec3i)pos) < (this.maximumHomeDistance * this.maximumHomeDistance));
  }
  ...
  protected void updateLeashedState() {
    ...
    if (getLeashed() && getLeashedToEntity() != null && (getLeashedToEntity()).world == this.world) {
      ...
      if (f > 10.0F) {
        ...
        getNavigator().tryMoveToXYZ(this.posX + vec3d.xCoord, this.posY + vec3d.yCoord, this.posZ + vec3d.zCoord, func_190634_dg());
      } 
    } 
  }
