...
public class EntityWither extends EntityMob implements IRangedAttackMob {
  ...
  protected void initEntityAI() {
    ...
    this.tasks.addTask(2, (EntityAIBase)new EntityAIAttackRanged(this, 1.0D, 40, 20.0F));
    ...
    this.targetTasks.addTask(2, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, EntityLiving.class, 0, false, false, NOT_UNDEAD));
  }
  ...
  public void onLivingUpdate() {
    ...
    if (!this.world.isRemote && getWatchedTargetId(0) > 0) {
    ...
    for (int j = 0; j < 2; j++) {
      ...
      if (entity1 != null) {
        ...
        this.yRotationHeads[j] = rotlerp(this.yRotationHeads[j], this.renderYawOffset, 10.0F);
      } 
    } 
  ...
  protected void updateAITasks() {
    if (getInvulTime() > 0) {
      ...
      if (j1 <= 0) {
        this.world.newExplosion((Entity)this, this.posX, this.posY + getEyeHeight(), this.posZ, 7.0F, false, this.world.getGameRules().getBoolean("mobGriefing"));
      ...
      for (int i = 1; i < 3; i++) {
        if (this.ticksExisted >= this.nextHeadUpdate[i - 1]) {
          ...
          if (k1 > 0) {
            ...
            List<EntityLivingBase> list = this.world.getEntitiesWithinAABB(EntityLivingBase.class, getEntityBoundingBox().expand(20.0D, 8.0D, 20.0D), Predicates.and(NOT_UNDEAD, EntitySelectors.NOT_SPECTATING));
      ...
      if (this.blockBreakCounter > 0) {
        ...
        if (this.blockBreakCounter == 0 && this.world.getGameRules().getBoolean("mobGriefing")) {
          ...
          if (flag)
            this.world.playEvent(null, 1022, new BlockPos((Entity)this), 0); 
        } 
      } 
  ...
  private void launchWitherSkullToCoords(int p_82209_1_, double x, double y, double z, boolean invulnerable) {
    this.world.playEvent(null, 1024, new BlockPos((Entity)this), 0);
    ...
    double d4 = y - d1;
    double d5 = z - d2;
    EntityWitherSkull entitywitherskull = new EntityWitherSkull(this.world, (EntityLivingBase)this, d3, d4, d5);
    if (invulnerable)
      entitywitherskull.setInvulnerable(true); 
    entitywitherskull.posY = d1;
    entitywitherskull.posX = d0;
    entitywitherskull.posZ = d2;
    this.world.spawnEntityInWorld((Entity)entitywitherskull);
  }
