...
public class EntityZombieVillager extends EntityZombie {
  ...
  public void writeEntityToNBT(NBTTagCompound compound) {
    ...
    compound.setInteger("ConversionTime", isConverting() ? this.conversionTime : -1);
  ...
  public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
    func_190733_a(this.world.rand.nextInt(6));
  ...
  public boolean processInteract(EntityPlayer player, EnumHand hand) {
    ...
    if (itemstack.getItem() == Items.GOLDEN_APPLE && itemstack.getMetadata() == 0 && isPotionActive(MobEffects.WEAKNESS)) {
      ...
      if (!this.world.isRemote)
        func_191991_a(player.getUniqueID(), this.rand.nextInt(2401) + 3600); 
      return true;
    } 
    return false;
  }
  ...
  protected void func_191991_a(@Nullable UUID p_191991_1_, int p_191991_2_) {
    ...
    addPotionEffect(new PotionEffect(MobEffects.STRENGTH, p_191991_2_, Math.min(this.world.getDifficulty().getDifficultyId() - 1, 0)));
  ...
  protected void func_190738_dp() {
    ...
    entityvillager.func_190672_a(this.world.getDifficultyForLocation(new BlockPos((Entity)entityvillager)), null, false);
    ...
    this.world.spawnEntityInWorld((Entity)entityvillager);
    if (this.field_191992_by != null) {
