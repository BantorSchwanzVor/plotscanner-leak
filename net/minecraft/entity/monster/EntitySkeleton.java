...
public class EntitySkeleton extends AbstractSkeleton {
  ...
  protected EntityArrow func_190726_a(float p_190726_1_) {
    ...
    if (itemstack.getItem() == Items.SPECTRAL_ARROW) {
      EntitySpectralArrow entityspectralarrow = new EntitySpectralArrow(this.world, (EntityLivingBase)this);
      entityspectralarrow.func_190547_a((EntityLivingBase)this, p_190726_1_);
      return (EntityArrow)entityspectralarrow;
    } 
