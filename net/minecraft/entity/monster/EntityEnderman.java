...
public class EntityEnderman extends EntityMob {
  ...
  public void playEndermanSound() {
    if (this.ticksExisted >= this.lastCreepySound + 400) {
      ...
      if (!isSilent())
        this.world.playSound(this.posX, this.posY + getEyeHeight(), this.posZ, SoundEvents.ENTITY_ENDERMEN_STARE, getSoundCategory(), 2.5F, 1.0F, false); 
    } 
  }
  
  public void notifyDataManagerChange(DataParameter<?> key) {
    if (SCREAMING.equals(key) && isScreaming() && this.world.isRemote)
      playEndermanSound(); 
  ...
  private boolean shouldAttackPlayer(EntityPlayer player) {
    ...
    Vec3d vec3d1 = new Vec3d(this.posX - player.posX, (getEntityBoundingBox()).minY + getEyeHeight() - player.posY + player.getEyeHeight(), this.posZ - player.posZ);
  ...
  protected void updateAITasks() {
    ...
    if (this.world.isDaytime() && this.ticksExisted >= this.targetChangeTime + 600) {
      ...
      if (f > 0.5F && this.world.canSeeSky(new BlockPos((Entity)this)) && this.rand.nextFloat() * 30.0F < (f - 0.4F) * 2.0F) {
    ...
    public boolean shouldExecute() {
      ...
      this.player = this.enderman.world.getNearestAttackablePlayer(this.enderman.posX, this.enderman.posY, this.enderman.posZ, d0, d0, null, new Predicate<EntityPlayer>() {
            public boolean apply(@Nullable EntityPlayer p_apply_1_) {
              return (p_apply_1_ != null && EntityEnderman.AIFindPlayer.this.enderman.shouldAttackPlayer(p_apply_1_));
            }
          });
      ...
      if (this.player != null) {
        ...
        if (this.targetEntity != null)
          if (this.enderman.shouldAttackPlayer((EntityPlayer)this.targetEntity)) {
            if (((EntityPlayer)this.targetEntity).getDistanceSqToEntity((Entity)this.enderman) < 16.0D)
              this.enderman.teleportRandomly(); 
            this.teleportTime = 0;
          } else if (((EntityPlayer)this.targetEntity).getDistanceSqToEntity((Entity)this.enderman) > 256.0D && this.teleportTime++ >= 30 && this.enderman.teleportToEntity((Entity)this.targetEntity)) {
            this.teleportTime = 0;
          }  
        super.updateTask();
      } 
