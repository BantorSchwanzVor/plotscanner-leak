...
public class EntityGuardian extends EntityMob {
    ...
    if (this.world.isRemote) {
      ...
      if (!isInWater()) {
        ...
        if (this.motionY > 0.0D && this.clientSideTouchedGround && !isSilent())
          this.world.playSound(this.posX, this.posY, this.posZ, func_190765_dj(), getSoundCategory(), 1.0F, 1.0F, false); 
      ...
      if (isMoving() && isInWater()) {
        ...
        for (int i = 0; i < 2; i++)
          this.world.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX + (this.rand.nextDouble() - 0.5D) * this.width - vec3d.xCoord * 1.5D, this.posY + this.rand.nextDouble() * this.height - vec3d.yCoord * 1.5D, this.posZ + (this.rand.nextDouble() - 0.5D) * this.width - vec3d.zCoord * 1.5D, 0.0D, 0.0D, 0.0D, new int[0]); 
      } 
      if (hasTargetedEntity()) {
  ...
  public void func_191986_a(float p_191986_1_, float p_191986_2_, float p_191986_3_) {
    if (isServerWorld() && isInWater()) {
      func_191958_b(p_191986_1_, p_191986_2_, p_191986_3_, 0.1F);
  ...
  static class AIGuardianAttack extends EntityAIBase {
    ...
    public boolean continueExecuting() {
      return (super.continueExecuting() && (this.field_190881_c || this.theEntity.getDistanceSqToEntity((Entity)this.theEntity.getAttackTarget()) > 9.0D));
    }
    ...
    public void updateTask() {
      ...
      if (!this.theEntity.canEntityBeSeen((Entity)entitylivingbase)) {
        ...
        if (this.tickCounter == 0) {
          ...
          this.theEntity.world.setEntityState((Entity)this.theEntity, (byte)21);
          ...
          entitylivingbase.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this.theEntity), (float)this.theEntity.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getAttributeValue());
          this.theEntity.setAttackTarget(null);
        } 
        super.updateTask();
      } 
