...
public class EntityHusk extends EntityZombie {
  ...
  public boolean getCanSpawnHere() {
    return (super.getCanSpawnHere() && this.world.canSeeSky(new BlockPos((Entity)this)));
  }
  ...
  public boolean attackEntityAsMob(Entity entityIn) {
    ...
    if (flag && getHeldItemMainhand().func_190926_b() && entityIn instanceof EntityLivingBase) {
