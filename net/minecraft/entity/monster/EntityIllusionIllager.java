...
public class EntityIllusionIllager extends EntitySpellcasterIllager implements IRangedAttackMob {
  ...
  protected void initEntityAI() {
    ...
    this.tasks.addTask(4, new AIMirriorSpell(null));
    this.tasks.addTask(5, new AIBlindnessSpell(null));
    this.tasks.addTask(6, (EntityAIBase)new EntityAIAttackRangedBow(this, 0.5D, 20, 15.0F));
    ...
    this.targetTasks.addTask(1, (EntityAIBase)new EntityAIHurtByTarget(this, true, new Class[] { EntityIllusionIllager.class }));
    ...
    this.targetTasks.addTask(3, (EntityAIBase)(new EntityAINearestAttackableTarget(this, EntityIronGolem.class, false)).func_190882_b(300));
  }
  ...
  public void onLivingUpdate() {
    ...
    if (this.world.isRemote && isInvisible()) {
      ...
      if (this.hurtTime != 1 && this.ticksExisted % 1200 != 0) {
        ...
        for (int l = 0; l < 16; l++)
          this.world.spawnParticle(EnumParticleTypes.CLOUD, this.posX + (this.rand.nextDouble() - 0.5D) * this.width, this.posY + this.rand.nextDouble() * this.height, this.posZ + (this.rand.nextDouble() - 0.5D) * this.width, 0.0D, 0.0D, 0.0D, new int[0]); 
        this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.field_193788_dg, getSoundCategory(), 1.0F, 1.0F, false);
      } 
    } 
  }
  ...
  class AIBlindnessSpell extends EntitySpellcasterIllager.AIUseSpell {
    ...
    public boolean shouldExecute() {
      ...
      if (EntityIllusionIllager.this.getAttackTarget().getEntityId() == this.field_193325_b)
        return false; 
      return EntityIllusionIllager.this.world.getDifficultyForLocation(new BlockPos((Entity)EntityIllusionIllager.this)).func_193845_a(EnumDifficulty.NORMAL.ordinal());
    }
