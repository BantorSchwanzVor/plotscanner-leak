...
public class EntityArmorStand extends EntityLivingBase {
  ...
  public static void registerFixesArmorStand(DataFixer fixer) {
    fixer.registerWalker(FixTypes.ENTITY, (IDataWalker)new ItemStackDataLists(EntityArmorStand.class, new String[] { "ArmorItems", "HandItems" }));
  }
  ...
  public void writeEntityToNBT(NBTTagCompound compound) {
    ...
    compound.setTag("Pose", (NBTBase)readPoseFromNBT());
  }
  ...
  protected void collideWithNearbyEntities() {
    List<Entity> list = this.world.getEntitiesInAABBexcluding((Entity)this, getEntityBoundingBox(), IS_RIDEABLE_MINECART);
    ...
    if (!this.world.isRemote && !this.isDead) {
      ...
      if (!isEntityInvulnerable(source) && !this.canInteract && !hasMarker()) {
        ...
        if (i - this.punchCooldown > 5L && !flag) {
          this.world.setEntityState((Entity)this, (byte)32);
  ...
  public void handleStatusUpdate(byte id) {
    if (id == 32) {
      if (this.world.isRemote) {
        this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.ENTITY_ARMORSTAND_HIT, getSoundCategory(), 0.3F, 1.0F, false);
  ...
  private void dropBlock() {
    Block.spawnAsEntity(this.world, new BlockPos((Entity)this), new ItemStack((Item)Items.ARMOR_STAND));
    dropContents();
  }
  ...
  private void dropContents() {
    ...
    for (int i = 0; i < this.handItems.size(); i++) {
      ...
      if (!itemstack.func_190926_b()) {
        Block.spawnAsEntity(this.world, (new BlockPos((Entity)this)).up(), itemstack);
    ...
    for (int j = 0; j < this.armorItems.size(); j++) {
      ...
      if (!itemstack1.func_190926_b()) {
        Block.spawnAsEntity(this.world, (new BlockPos((Entity)this)).up(), itemstack1);
  ...
  private void func_190773_I() {
    this.world.playSound(null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_ARMORSTAND_BREAK, getSoundCategory(), 1.0F, 1.0F);
  }
  ...
  private void setShowArms(boolean showArms) {
    this.dataManager.set(STATUS, Byte.valueOf(setBit(((Byte)this.dataManager.get(STATUS)).byteValue(), 4, showArms)));
  }
  ...
  private void setNoBasePlate(boolean noBasePlate) {
    this.dataManager.set(STATUS, Byte.valueOf(setBit(((Byte)this.dataManager.get(STATUS)).byteValue(), 8, noBasePlate)));
  }
  
  public boolean hasNoBasePlate() {
    return ((((Byte)this.dataManager.get(STATUS)).byteValue() & 0x8) != 0);
  }
  ...
  public boolean hasMarker() {
    return ((((Byte)this.dataManager.get(STATUS)).byteValue() & 0x10) != 0);
  }
