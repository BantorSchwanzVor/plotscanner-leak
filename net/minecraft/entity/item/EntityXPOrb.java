  ...
  public void onCollideWithPlayer(EntityPlayer entityIn) {
    if (!this.world.isRemote)
      if (this.delayBeforeCanPickup == 0 && entityIn.xpCooldown == 0) {
        ...
        ItemStack itemstack = EnchantmentHelper.getEnchantedItem(Enchantments.MENDING, (EntityLivingBase)entityIn);
        if (!itemstack.func_190926_b() && itemstack.isItemDamaged()) {
          int i = Math.min(xpToDurability(this.xpValue), itemstack.getItemDamage());
