      ...
      if (flag) {
        if (this.rand.nextBoolean())
          for (int i = 0; i < 2; i++) {
            ...
            if (enumparticletypes == EnumParticleTypes.SPELL_MOB) {
              ...
              int l = j >> 8 & 0xFF;
              int i1 = j & 0xFF;
              this.world.func_190523_a(EnumParticleTypes.SPELL_MOB.getParticleID(), this.posX + f3, this.posY, this.posZ + f4, (k / 255.0F), (l / 255.0F), (i1 / 255.0F), new int[0]);
            } else {
        ...
        for (int k1 = 0; k1 < f5; k1++) {
          ...
          if (enumparticletypes == EnumParticleTypes.SPELL_MOB) {
            ...
            int j2 = l1 >> 8 & 0xFF;
            int j1 = l1 & 0xFF;
            this.world.func_190523_a(EnumParticleTypes.SPELL_MOB.getParticleID(), this.posX + f8, this.posY, this.posZ + f9, (i2 / 255.0F), (j2 / 255.0F), (j1 / 255.0F), new int[0]);
          } else {
