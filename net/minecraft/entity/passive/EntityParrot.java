...
public class EntityParrot extends EntityShoulderRiding implements EntityFlying {
  ...
  private static final Int2ObjectMap<SoundEvent> field_192017_bK = (Int2ObjectMap<SoundEvent>)new Int2ObjectOpenHashMap(32);
  ...
  public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
    func_191997_m(this.rand.nextInt(5));
    return super.onInitialSpawn(difficulty, livingdata);
  }
  
  protected void initEntityAI() {
    this.aiSit = new EntityAISit(this);
    this.tasks.addTask(0, (EntityAIBase)new EntityAIPanic((EntityCreature)this, 1.25D));
    ...
    this.tasks.addTask(2, (EntityAIBase)new EntityAIFollowOwnerFlying(this, 1.0D, 5.0F, 1.0F));
    this.tasks.addTask(2, (EntityAIBase)new EntityAIWanderAvoidWaterFlying((EntityCreature)this, 1.0D));
    this.tasks.addTask(3, (EntityAIBase)new EntityAILandOnOwnersShoulder(this));
    this.tasks.addTask(3, (EntityAIBase)new EntityAIFollow((EntityLiving)this, 1.0D, 3.0F, 7.0F));
  }
  ...
  public void onLivingUpdate() {
    func_192006_b(this.world, (Entity)this);
  ...
  public boolean processInteract(EntityPlayer player, EnumHand hand) {
    ...
    if (!isTamed() && field_192016_bJ.contains(itemstack.getItem())) {
      ...
      if (!isSilent())
        this.world.playSound(null, this.posX, this.posY, this.posZ, SoundEvents.field_192797_eu, getSoundCategory(), 1.0F, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F); 
    ...
    if (!this.world.isRemote && !func_192002_a() && isTamed() && isOwner((EntityLivingBase)player))
  ...
  private static SoundEvent func_192003_a(Random p_192003_0_) {
    if (p_192003_0_.nextInt(1000) == 0) {
      List<Integer> list = new ArrayList<>((Collection<? extends Integer>)field_192017_bK.keySet());
