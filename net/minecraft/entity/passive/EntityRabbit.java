...
public class EntityRabbit extends EntityAnimal {
  ...
  protected void initEntityAI() {
    ...
    this.tasks.addTask(1, (EntityAIBase)new AIPanic(this, 2.2D));
    this.tasks.addTask(2, (EntityAIBase)new EntityAIMate(this, 0.8D));
    this.tasks.addTask(3, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.0D, Items.CARROT, false));
    this.tasks.addTask(3, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.0D, Items.GOLDEN_CARROT, false));
    this.tasks.addTask(3, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.0D, Item.getItemFromBlock((Block)Blocks.YELLOW_FLOWER), false));
    this.tasks.addTask(4, (EntityAIBase)new AIAvoidEntity<>(this, EntityPlayer.class, 8.0F, 2.2D, 2.2D));
    this.tasks.addTask(4, (EntityAIBase)new AIAvoidEntity<>(this, EntityWolf.class, 10.0F, 2.2D, 2.2D));
    this.tasks.addTask(4, (EntityAIBase)new AIAvoidEntity<>(this, EntityMob.class, 4.0F, 2.2D, 2.2D));
    this.tasks.addTask(5, (EntityAIBase)new AIRaidFarm(this));
    this.tasks.addTask(6, (EntityAIBase)new EntityAIWanderAvoidWater((EntityCreature)this, 0.6D));
  ...
  protected float getJumpUpwardsMotion() {
    if (!this.isCollidedHorizontally && (!this.moveHelper.isUpdating() || this.moveHelper.getY() <= this.posY + 0.5D)) {
      ...
      if (path != null && path.getCurrentPathIndex() < path.getCurrentPathLength()) {
        Vec3d vec3d = path.getPosition((Entity)this);
    ...
    if (this.onGround) {
      ...
      if (!entityrabbit$rabbitjumphelper.getIsJumping()) {
        if (this.moveHelper.isUpdating() && this.currentMoveTypeDuration == 0) {
          ...
          if (path != null && path.getCurrentPathIndex() < path.getCurrentPathLength())
            vec3d = path.getPosition((Entity)this); 
  ...
  static class AIEvilAttack extends EntityAIAttackMelee {
    public AIEvilAttack(EntityRabbit rabbit) {
      super((EntityCreature)rabbit, 1.4D, true);
    }
