...
public class Bootstrap {
  ...
  static void registerDispenserBehaviors() {
    BlockDispenser.DISPENSE_BEHAVIOR_REGISTRY.putObject(Items.ARROW, new BehaviorProjectileDispense() {
          protected IProjectile getProjectileEntity(World worldIn, IPosition position, ItemStack stackIn) {
            ...
            return (IProjectile)entitytippedarrow;
          }
        });
    ...
    BlockDispenser.DISPENSE_BEHAVIOR_REGISTRY.putObject(Items.SPECTRAL_ARROW, new BehaviorProjectileDispense() {
          protected IProjectile getProjectileEntity(World worldIn, IPosition position, ItemStack stackIn) {
            EntitySpectralArrow entitySpectralArrow = new EntitySpectralArrow(worldIn, position.getX(), position.getY(), position.getZ());
            ((EntityArrow)entitySpectralArrow).pickupStatus = EntityArrow.PickupStatus.ALLOWED;
            return (IProjectile)entitySpectralArrow;
          }
        });
    ...
    BehaviorDefaultDispenseItem behaviorDefaultDispenseItem = new BehaviorDefaultDispenseItem() {
        ...
        public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
          ...
          BlockPos blockpos = source.getBlockPos().offset((EnumFacing)source.getBlockState().getValue((IProperty)BlockDispenser.FACING));
    ...
    BlockDispenser.DISPENSE_BEHAVIOR_REGISTRY.putObject(Items.LAVA_BUCKET, behaviorDefaultDispenseItem);
    BlockDispenser.DISPENSE_BEHAVIOR_REGISTRY.putObject(Items.WATER_BUCKET, behaviorDefaultDispenseItem);
  ...
  private static void redirectOutputToLog() {
    if (LOGGER.isDebugEnabled()) {
      System.setErr((PrintStream)new DebugLoggingPrintStream("STDERR", System.err));
      System.setOut((PrintStream)new DebugLoggingPrintStream("STDOUT", SYSOUT));
    } else {
  ...
  static class BehaviorDispenseShulkerBox extends BehaviorDispenseOptional {
    ...
    protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
      ...
      if (this.field_190911_b) {
        ...
        IBlockState iblockstate = block.getDefaultState().withProperty((IProperty)BlockShulkerBox.field_190957_a, (Comparable)enumfacing1);
