...
public class CombatTracker {
  ...
  public ITextComponent getDeathMessage() {
    ...
    if (this.combatEntries.isEmpty())
      return (ITextComponent)new TextComponentTranslation("death.attack.generic", new Object[] { this.fighter.getDisplayName() }); 
      ...
      if (combatentry.getDamageSrc() != DamageSource.fall && combatentry.getDamageSrc() != DamageSource.outOfWorld) {
        if (itextcomponent2 != null && (itextcomponent1 == null || !itextcomponent2.equals(itextcomponent1))) {
          ...
          if (!itemstack1.func_190926_b() && itemstack1.hasDisplayName()) {
            TextComponentTranslation textComponentTranslation = new TextComponentTranslation("death.fell.assist.item", new Object[] { this.fighter.getDisplayName(), itextcomponent2, itemstack1.getTextComponent() });
          } else {
            TextComponentTranslation textComponentTranslation = new TextComponentTranslation("death.fell.assist", new Object[] { this.fighter.getDisplayName(), itextcomponent2 });
          } 
          ...
          if (!itemstack.func_190926_b() && itemstack.hasDisplayName()) {
            TextComponentTranslation textComponentTranslation = new TextComponentTranslation("death.fell.finish.item", new Object[] { this.fighter.getDisplayName(), itextcomponent1, itemstack.getTextComponent() });
          } else {
            TextComponentTranslation textComponentTranslation = new TextComponentTranslation("death.fell.finish", new Object[] { this.fighter.getDisplayName(), itextcomponent1 });
          } 
        } else {
          TextComponentTranslation textComponentTranslation = new TextComponentTranslation("death.fell.killer", new Object[] { this.fighter.getDisplayName() });
        } 
      } else {
        TextComponentTranslation textComponentTranslation = new TextComponentTranslation("death.fell.accident." + getFallSuffix(combatentry), new Object[] { this.fighter.getDisplayName() });
      } 
    } else {
