...
public class ServerRecipeBookHelper {
      ...
      if (this.field_194335_f != null && this.field_194336_g != null)
        if (func_194328_c() || p_194327_1_.isCreative()) {
          ...
          if (this.field_194331_b.func_194116_a(p_194327_2_, null)) {
            ...
            func_194326_a();
            p_194327_1_.connection.sendPacket((Packet)new SPacketPlaceGhostRecipe(p_194327_1_.openContainer.windowId, p_194327_2_));
          } 
  ...
  private void func_194329_b() {
    ...
    if (this.field_194331_b.func_194118_a(this.field_194333_d, (IntList)intArrayList, i1)) {
      int j1 = i1;
      ...
      if (this.field_194331_b.func_194118_a(this.field_194333_d, (IntList)intArrayList, j1)) {
        func_194326_a();
        func_194323_a(j1, (IntList)intArrayList);
      } 
    } 
  }
