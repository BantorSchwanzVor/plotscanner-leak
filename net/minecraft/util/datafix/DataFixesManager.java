...
public class DataFixesManager {
  private static void registerFixes(DataFixer fixer) {
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new EntityArmorAndHeld());
    fixer.registerFix(FixTypes.BLOCK_ENTITY, (IFixableData)new SignStrictJSON());
    fixer.registerFix(FixTypes.ITEM_INSTANCE, (IFixableData)new ItemIntIDToString());
    fixer.registerFix(FixTypes.ITEM_INSTANCE, (IFixableData)new PotionItems());
    fixer.registerFix(FixTypes.ITEM_INSTANCE, (IFixableData)new SpawnEggNames());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new MinecartEntityTypes());
    fixer.registerFix(FixTypes.BLOCK_ENTITY, (IFixableData)new SpawnerEntityTypes());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new StringToUUID());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new EntityHealth());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new HorseSaddle());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new PaintingDirection());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new RedundantChanceTags());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new RidingToPassengers());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new ArmorStandSilent());
    fixer.registerFix(FixTypes.ITEM_INSTANCE, (IFixableData)new BookPagesStrictJSON());
    fixer.registerFix(FixTypes.ITEM_INSTANCE, (IFixableData)new CookedFishIDTypo());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new ZombieProfToType());
    fixer.registerFix(FixTypes.OPTIONS, (IFixableData)new ForceVBOOn());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new ElderGuardianSplit());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new SkeletonSplit());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new ZombieSplit());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new HorseSplit());
    fixer.registerFix(FixTypes.BLOCK_ENTITY, (IFixableData)new TileEntityId());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new EntityId());
    fixer.registerFix(FixTypes.ITEM_INSTANCE, (IFixableData)new BannerItemColor());
    fixer.registerFix(FixTypes.ITEM_INSTANCE, (IFixableData)new PotionWater());
    fixer.registerFix(FixTypes.ENTITY, (IFixableData)new ShulkerBoxEntityColor());
    fixer.registerFix(FixTypes.ITEM_INSTANCE, (IFixableData)new ShulkerBoxItemColor());
    fixer.registerFix(FixTypes.BLOCK_ENTITY, (IFixableData)new ShulkerBoxTileColor());
    fixer.registerFix(FixTypes.OPTIONS, (IFixableData)new OptionsLowerCaseLanguage());
    fixer.registerFix(FixTypes.ITEM_INSTANCE, (IFixableData)new TotemItemRename());
    fixer.registerFix(FixTypes.CHUNK, (IFixableData)new AddBedTileEntity());
    fixer.registerFix(FixTypes.ITEM_INSTANCE, (IFixableData)new BedItemColor());
  }
  ...
  public static NBTTagCompound processItemStack(IDataFixer fixer, NBTTagCompound compound, int version, String key) {
    if (compound.hasKey(key, 10))
      compound.setTag(key, (NBTBase)fixer.process(FixTypes.ITEM_INSTANCE, compound.getCompoundTag(key), version)); 
    return compound;
  }
  ...
  public static NBTTagCompound processInventory(IDataFixer fixer, NBTTagCompound compound, int version, String key) {
    if (compound.hasKey(key, 9)) {
      ...
      for (int i = 0; i < nbttaglist.tagCount(); i++)
        nbttaglist.set(i, (NBTBase)fixer.process(FixTypes.ITEM_INSTANCE, nbttaglist.getCompoundTagAt(i), version)); 
    } 
    return compound;
  }
}
