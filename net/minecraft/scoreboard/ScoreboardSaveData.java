...
public class ScoreboardSaveData extends WorldSavedData {
  ...
  public NBTTagCompound writeToNBT(NBTTagCompound compound) {
    ...
    compound.setTag("Objectives", (NBTBase)objectivesToNbt());
    compound.setTag("PlayerScores", (NBTBase)scoresToNbt());
    compound.setTag("Teams", (NBTBase)teamsToNbt());
  ...
  protected void fillInDisplaySlots(NBTTagCompound compound) {
    ...
    if (flag)
      compound.setTag("DisplaySlots", (NBTBase)nbttagcompound); 
  }
