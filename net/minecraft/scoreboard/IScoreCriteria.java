  ...
  public enum EnumRenderType {
    ...
    static {
      ...
      for (i = (arrayOfEnumRenderType = values()).length, b = 0; b < i; ) {
        EnumRenderType iscorecriteria$enumrendertype = arrayOfEnumRenderType[b];
