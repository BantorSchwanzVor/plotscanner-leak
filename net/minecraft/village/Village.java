...
public class Village {
  ...
  public void tick(int tickCounterIn) {
    ...
    if (this.numIronGolems < i && this.villageDoorInfoList.size() > 20 && this.worldObj.rand.nextInt(7000) == 0) {
      Vec3d vec3d = findRandomSpawnPos(this.center, 2, 4, 2);
      if (vec3d != null) {
  ...
  public VillageDoorInfo getDoorInfo(BlockPos pos) {
    ...
    for (VillageDoorInfo villagedoorinfo1 : this.villageDoorInfoList) {
      ...
      if (j < i) {
        ...
        if (this.worldObj.getBlockState(blockpos.offset(enumfacing, 1)).getBlock().isPassable((IBlockAccess)this.worldObj, blockpos.offset(enumfacing, 1)) && this.worldObj.getBlockState(blockpos.offset(enumfacing, -1)).getBlock().isPassable((IBlockAccess)this.worldObj, blockpos.offset(enumfacing, -1)) && this.worldObj.getBlockState(blockpos.up().offset(enumfacing, 1)).getBlock().isPassable((IBlockAccess)this.worldObj, blockpos.up().offset(enumfacing, 1)) && this.worldObj.getBlockState(blockpos.up().offset(enumfacing, -1)).getBlock().isPassable((IBlockAccess)this.worldObj, blockpos.up().offset(enumfacing, -1))) {
          villagedoorinfo = villagedoorinfo1;
          i = j;
        } 
      } 
