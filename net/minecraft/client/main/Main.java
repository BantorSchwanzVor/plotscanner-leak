...
public class Main {
  public static void main(String[] p_main_0_) {
    ...
    ArgumentAcceptingOptionSpec argumentAcceptingOptionSpec20 = optionparser.accepts("versionType").withRequiredArg().defaultsTo("release", (Object[])new String[0]);
    ...
    PropertyMap propertymap = (PropertyMap)JsonUtils.gsonDeserialize(gson, (String)optionset.valueOf((OptionSpec)argumentAcceptingOptionSpec16), PropertyMap.class);
    PropertyMap propertymap1 = (PropertyMap)JsonUtils.gsonDeserialize(gson, (String)optionset.valueOf((OptionSpec)argumentAcceptingOptionSpec17), PropertyMap.class);
    String s4 = (String)optionset.valueOf((OptionSpec)argumentAcceptingOptionSpec20);
    ...
    String s5 = optionset.has((OptionSpec)argumentAcceptingOptionSpec11) ? (String)argumentAcceptingOptionSpec11.value(optionset) : (String)argumentAcceptingOptionSpec10.value(optionset);
    String s6 = optionset.has((OptionSpec)argumentAcceptingOptionSpec18) ? (String)argumentAcceptingOptionSpec18.value(optionset) : null;
    String s7 = (String)optionset.valueOf((OptionSpec)argumentAcceptingOptionSpec1);
    Integer integer = (Integer)optionset.valueOf((OptionSpec)argumentAcceptingOptionSpec2);
    Session session = new Session((String)argumentAcceptingOptionSpec10.value(optionset), s5, (String)argumentAcceptingOptionSpec12.value(optionset), (String)argumentAcceptingOptionSpec19.value(optionset));
