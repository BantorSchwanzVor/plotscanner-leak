...
public class Particle {
  ...
  public void setPosition(double p_187109_1_, double p_187109_3_, double p_187109_5_) {
    ...
    setEntityBoundingBox(new AxisAlignedBB(p_187109_1_ - f, p_187109_3_, p_187109_5_ - f, p_187109_1_ + f, p_187109_3_ + f1, p_187109_5_ + f));
  }
  
  public void moveEntity(double x, double y, double z) {
    double d0 = y;
    if (this.canCollide) {
      List<AxisAlignedBB> list = this.worldObj.getCollisionBoxes(null, getEntityBoundingBox().addCoord(x, y, z));
