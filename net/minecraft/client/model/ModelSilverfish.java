...
public class ModelSilverfish extends ModelBase {
  ...
  private static final int[][] SILVERFISH_TEXTURE_POSITIONS = new int[][] { new int[2], { 0, 4 }, { 0, 9 }, { 0, 16 }, { 0, 22 }, { 11 }, { 13, 4 } };
  ...
  public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    for (i = (arrayOfModelRenderer = this.silverfishBodyParts).length, b = 0; b < i; ) {
      ModelRenderer modelrenderer = arrayOfModelRenderer[b];
      modelrenderer.render(scale);
      b++;
    } 
    for (i = (arrayOfModelRenderer = this.silverfishWings).length, b = 0; b < i; ) {
