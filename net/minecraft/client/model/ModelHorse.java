...
public class ModelHorse extends ModelBase {
  ...
  public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
    ...
    this.backLeftLeg.rotationPointY += MathHelper.sin(1.5707964F + f12 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
    this.backLeftLeg.rotationPointZ += MathHelper.cos(-1.5707964F + f12 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
    this.backRightLeg.rotationPointY += MathHelper.sin(1.5707964F + f12 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
    this.backRightLeg.rotationPointZ += MathHelper.cos(-1.5707964F + f12 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
