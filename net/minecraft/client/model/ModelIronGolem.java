...
public class ModelIronGolem extends ModelBase {
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    this.ironGolemLeftLeg.rotateAngleX = -1.5F * triangleWave(limbSwing, 13.0F) * limbSwingAmount;
    this.ironGolemRightLeg.rotateAngleX = 1.5F * triangleWave(limbSwing, 13.0F) * limbSwingAmount;
  ...
  public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
    ...
    if (i > 0) {
      this.ironGolemRightArm.rotateAngleX = -2.0F + 1.5F * triangleWave(i - partialTickTime, 10.0F);
      this.ironGolemLeftArm.rotateAngleX = -2.0F + 1.5F * triangleWave(i - partialTickTime, 10.0F);
    } else {
