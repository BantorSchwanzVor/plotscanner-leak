...
public class JsonException extends IOException {
  ...
  public void prependJsonKey(String p_151380_1_) {
    ((Entry)this.entries.get(0)).addJsonKey(p_151380_1_);
  }
  ...
  public static class Entry {
    ...
    public String toString() {
      if (this.filename != null)
        return this.jsonKeys.isEmpty() ? this.filename : (String.valueOf(this.filename) + " " + getJsonKeys()); 
      return this.jsonKeys.isEmpty() ? "(Unknown file)" : ("(Unknown file) " + getJsonKeys());
    }
