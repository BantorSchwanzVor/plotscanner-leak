...
public class RecipeItemHelper {
  public final Int2IntMap field_194124_a = (Int2IntMap)new Int2IntOpenHashMap();
  ...
  public int func_194114_b(IRecipe p_194114_1_, @Nullable IntList p_194114_2_) {
    return func_194121_a(p_194114_1_, 2147483647, p_194114_2_);
  }
  ...
  class RecipePicker {
    ...
    private IntList field_194111_h = (IntList)new IntArrayList();
    
    public RecipePicker(IRecipe p_i47608_2_) {
      this.field_194105_b = p_i47608_2_;
      this.field_194106_c.addAll((Collection<? extends Ingredient>)p_i47608_2_.func_192400_c());
      ...
      for (int i = 0; i < this.field_194106_c.size(); i++) {
        ...
        for (int j = 0; j < this.field_194109_f; j++) {
          if (intlist.contains(this.field_194108_e[j]))
            this.field_194110_g.set(func_194095_d(true, j, i)); 
        } 
      } 
    }
    ...
    public boolean func_194092_a(int p_194092_1_, @Nullable IntList p_194092_2_) {
      if (p_194092_1_ <= 0)
        return true; 
      for (int k = 0; func_194098_a(p_194092_1_); k++) {
        ...
        func_194096_c(this.field_194111_h.getInt(l));
        for (int i1 = 0; i1 < l; i1++)
          func_194089_c(((i1 & 0x1) == 0), ((Integer)this.field_194111_h.get(i1)).intValue(), ((Integer)this.field_194111_h.get(i1 + 1)).intValue()); 
      ...
      int j1 = 0;
      NonNullList<Ingredient> nonNullList = this.field_194105_b.func_192400_c();
      for (int k1 = 0; k1 < nonNullList.size(); k1++) {
        if (flag1 && nonNullList.get(k1) == Ingredient.field_193370_a) {
          p_194092_2_.add(0);
        } else {
    ...
    private int[] func_194097_a() {
      ...
      for (Ingredient ingredient : this.field_194106_c)
        intAVLTreeSet.addAll((IntCollection)ingredient.func_194139_b()); 
    ...
    private boolean func_194091_b(int p_194091_1_) {
      return this.field_194110_g.get(func_194094_d(p_194091_1_));
    }
    
    private void func_194096_c(int p_194096_1_) {
      this.field_194110_g.set(func_194094_d(p_194096_1_));
    }
    ...
    private boolean func_194093_a(boolean p_194093_1_, int p_194093_2_, int p_194093_3_) {
      return this.field_194110_g.get(func_194095_d(p_194093_1_, p_194093_2_, p_194093_3_));
    }
    
    private boolean func_194100_b(boolean p_194100_1_, int p_194100_2_, int p_194100_3_) {
      return p_194100_1_ ^ this.field_194110_g.get(1 + func_194095_d(p_194100_1_, p_194100_2_, p_194100_3_));
    }
    
    private void func_194089_c(boolean p_194089_1_, int p_194089_2_, int p_194089_3_) {
      this.field_194110_g.flip(1 + func_194095_d(p_194089_1_, p_194089_2_, p_194089_3_));
    }
    ...
    private void func_194088_a(boolean p_194088_1_, int p_194088_2_) {
      this.field_194110_g.set(func_194099_c(p_194088_1_, p_194088_2_));
      this.field_194111_h.add(p_194088_2_);
    }
    
    private boolean func_194101_b(boolean p_194101_1_, int p_194101_2_) {
      return this.field_194110_g.get(func_194099_c(p_194101_1_, p_194101_2_));
    }
