...
public class SuffixArray<T> {
  ...
  public void func_194058_a() {
    ...
    this.field_194068_h = (IntList)new IntArrayList(intlist.size());
  ...
  public List<T> func_194055_a(String p_194055_1_) {
    ...
    if (j2 >= 0 && j2 < i2) {
      ...
      for (int k3 = i4; k3 < k4; k3++)
        intOpenHashSet.add(this.field_194067_g.getInt(k3)); 
      int[] aint4 = intOpenHashSet.toIntArray();
      Arrays.sort(aint4);
      Set<T> set = Sets.newLinkedHashSet();
      byte b;
      int i, arrayOfInt1[];
      for (i = (arrayOfInt1 = aint4).length, b = 0; b < i; ) {
        int l3 = arrayOfInt1[b];
