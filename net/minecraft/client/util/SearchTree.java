...
public class SearchTree<T> implements ISearchTree<T> {
  ...
  private Object2IntMap<T> field_194049_f = (Object2IntMap<T>)new Object2IntOpenHashMap();
  ...
  private void func_194042_b(T p_194042_1_) {
    ((Iterable)this.field_194047_d.apply(p_194042_1_)).forEach(p_194039_2_ -> this.field_194045_b.func_194057_a((T)paramObject, p_194039_2_.toString().toLowerCase(Locale.ROOT)));
    ((Iterable)this.field_194046_c.apply(p_194042_1_)).forEach(p_194041_2_ -> this.field_194044_a.func_194057_a((T)paramObject, p_194041_2_.toLowerCase(Locale.ROOT)));
  }
  
  public List<T> func_194038_a(String p_194038_1_) {
    List<T> list = this.field_194044_a.func_194055_a(p_194038_1_);
    if (p_194038_1_.indexOf(':') < 0)
      return list; 
    List<T> list1 = this.field_194045_b.func_194055_a(p_194038_1_);
    return list1.isEmpty() ? list : Lists.newArrayList((Iterator)new MergingIterator<>(list.iterator(), list1.iterator(), this.field_194049_f));
  }
