...
public class SimpleResource implements IResource {
  ...
  public <T extends IMetadataSection> T getMetadata(String sectionName) {
    ...
    IMetadataSection iMetadataSection = this.mapMetadataSections.get(sectionName);
    if (iMetadataSection == null)
      iMetadataSection = this.srMetadataSerializer.parseMetadataSection(sectionName, this.mcmetaJson); 
