...
public class ChunkProviderClient implements IChunkProvider {
  ...
  private final Long2ObjectMap<Chunk> chunkMapping = (Long2ObjectMap<Chunk>)new Long2ObjectOpenHashMap<Chunk>(8192) {
  ...
  public Chunk provideChunk(int x, int z) {
    return (Chunk)MoreObjects.firstNonNull(getLoadedChunk(x, z), this.blankChunk);
  }
