...
public class MovementStep implements ITutorialStep {
  private static final ITextComponent field_193254_a = (ITextComponent)new TextComponentTranslation("tutorial.move.title", new Object[] { Tutorial.func_193291_a("forward"), Tutorial.func_193291_a("left"), Tutorial.func_193291_a("back"), Tutorial.func_193291_a("right") });
  
  private static final ITextComponent field_193255_b = (ITextComponent)new TextComponentTranslation("tutorial.move.description", new Object[] { Tutorial.func_193291_a("jump") });
  
  private static final ITextComponent field_193256_c = (ITextComponent)new TextComponentTranslation("tutorial.look.title", new Object[0]);
  
  private static final ITextComponent field_193257_d = (ITextComponent)new TextComponentTranslation("tutorial.look.description", new Object[0]);
  ...
  public void func_193245_a() {
    ...
    if (this.field_193261_h >= 100)
      if (this.field_193266_m == -1 && this.field_193259_f == null) {
        ...
        this.field_193258_e.func_193295_e().func_193033_an().func_192988_a((IToast)this.field_193259_f);
        ...
        this.field_193258_e.func_193295_e().func_193033_an().func_192988_a((IToast)this.field_193260_g);
      }  
  }
