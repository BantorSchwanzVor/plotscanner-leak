...
public class FindTreeStep implements ITutorialStep {
  private static final Set<Block> field_193268_a = Sets.newHashSet((Object[])new Block[] { Blocks.LOG, Blocks.LOG2, (Block)Blocks.LEAVES, (Block)Blocks.LEAVES2 });
  
  private static final ITextComponent field_193269_b = (ITextComponent)new TextComponentTranslation("tutorial.find_tree.title", new Object[0]);
  
  private static final ITextComponent field_193270_c = (ITextComponent)new TextComponentTranslation("tutorial.find_tree.description", new Object[0]);
  ...
  public void func_193245_a() {
    ...
    if (this.field_193271_d.func_194072_f() != GameType.SURVIVAL) {
      ...
      if (this.field_193273_f >= 6000 && this.field_193272_e == null) {
        ...
        this.field_193271_d.func_193295_e().func_193033_an().func_192988_a((IToast)this.field_193272_e);
      } 
    } 
  }
