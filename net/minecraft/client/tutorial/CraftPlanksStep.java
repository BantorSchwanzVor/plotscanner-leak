...
public class CraftPlanksStep implements ITutorialStep {
  private static final ITextComponent field_193286_a = (ITextComponent)new TextComponentTranslation("tutorial.craft_planks.title", new Object[0]);
  
  private static final ITextComponent field_193287_b = (ITextComponent)new TextComponentTranslation("tutorial.craft_planks.description", new Object[0]);
  ...
  public void func_193245_a() {
    ...
    if (this.field_193288_c.func_194072_f() != GameType.SURVIVAL) {
      ...
      if (this.field_193290_e >= 1200 && this.field_193289_d == null) {
        ...
        this.field_193288_c.func_193295_e().func_193033_an().func_192988_a((IToast)this.field_193289_d);
      } 
    } 
  }
