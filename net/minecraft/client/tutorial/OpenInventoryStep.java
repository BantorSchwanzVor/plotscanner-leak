...
public class OpenInventoryStep implements ITutorialStep {
  private static final ITextComponent field_193281_a = (ITextComponent)new TextComponentTranslation("tutorial.open_inventory.title", new Object[0]);
  
  private static final ITextComponent field_193282_b = (ITextComponent)new TextComponentTranslation("tutorial.open_inventory.description", new Object[] { Tutorial.func_193291_a("inventory") });
  ...
  public void func_193245_a() {
    ...
    if (this.field_193283_c.func_194072_f() != GameType.SURVIVAL) {
      ...
      this.field_193283_c.func_193295_e().func_193033_an().func_192988_a((IToast)this.field_193284_d);
    } 
  }
