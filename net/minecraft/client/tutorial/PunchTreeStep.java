...
public class PunchTreeStep implements ITutorialStep {
  ...
  private static final ITextComponent field_193275_b = (ITextComponent)new TextComponentTranslation("tutorial.punch_tree.title", new Object[0]);
  
  private static final ITextComponent field_193276_c = (ITextComponent)new TextComponentTranslation("tutorial.punch_tree.description", new Object[] { Tutorial.func_193291_a("attack") });
  ...
  public void func_193245_a() {
    ...
    if (this.field_193277_d.func_194072_f() != GameType.SURVIVAL) {
      ...
      if ((this.field_193279_f >= 600 || this.field_193280_g > 3) && this.field_193278_e == null) {
        ...
        this.field_193277_d.func_193295_e().func_193033_an().func_192988_a((IToast)this.field_193278_e);
      } 
    } 
  }
