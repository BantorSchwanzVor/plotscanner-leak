...
public class GameSettings {
  ...
  public GameSettings(Minecraft mcIn, File optionsFileIn) {
    ...
    this.keyBindings = (KeyBinding[])ArrayUtils.addAll((Object[])new KeyBinding[] { 
          ...
          this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand, this.keyBindScreenshot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindFullscreen, this.keyBindSpectatorOutlines, 
          this.keyBindSwapHands, this.field_193629_ap, this.field_193630_aq, this.field_194146_ao }, (Object[])this.keyBindsHotbar);
  ...
  public static String getKeyDisplayString(int key) {
    ...
    return (key < 256) ? Keyboard.getKeyName(key) : String.format("%c", new Object[] { Character.valueOf((char)(key - 256)) }).toUpperCase();
  }
  ...
  public void setOptionValue(Options settingsOption, int value) {
    ...
    if (settingsOption == Options.RENDER_DISTANCE)
      setOptionFloatValue(settingsOption, MathHelper.clamp((this.renderDistanceChunks + value), settingsOption.getValueMin(), settingsOption.getValueMax())); 
  ...
  public float getOptionFloatValue(Options settingOption) {
    ...
    return (settingOption == Options.RENDER_DISTANCE) ? this.renderDistanceChunks : 0.0F;
  }
  ...
  public String getKeyBinding(Options settingOption) {
    ...
    if (settingOption.getEnumFloat()) {
      ...
      if (settingOption == Options.FRAMERATE_LIMIT)
        return (f1 == settingOption.valueMax) ? (String.valueOf(s1) + I18n.format("options.framerateLimit.max", new Object[0])) : (String.valueOf(s1) + I18n.format("options.framerate", new Object[] { Integer.valueOf((int)f1) })); 
      ...
      if (settingOption == Options.RENDER_DISTANCE)
        return String.valueOf(s1) + I18n.format("options.chunks", new Object[] { Integer.valueOf((int)f1) }); 
      if (settingOption == Options.MIPMAP_LEVELS)
    ...
    if (settingOption == Options.MAIN_HAND)
      return String.valueOf(s1) + this.mainHand; 
    if (settingOption == Options.GUI_SCALE)
      return (this.guiScale >= GUISCALES.length) ? (String.valueOf(s1) + this.guiScale + "x") : (String.valueOf(s1) + getTranslation(GUISCALES, this.guiScale)); 
    ...
    if (settingOption == Options.RENDER_CLOUDS)
      return String.valueOf(s1) + getTranslation(CLOUDS_TYPES, this.clouds); 
    ...
    if (settingOption == Options.ATTACK_INDICATOR)
      return String.valueOf(s1) + getTranslation(ATTACK_INDICATORS, this.attackIndicator); 
    if (settingOption == Options.NARRATOR)
      return NarratorChatListener.field_193643_a.func_193640_a() ? (String.valueOf(s1) + getTranslation(field_193632_b, this.field_192571_R)) : (String.valueOf(s1) + I18n.format("options.narrator.notavailable", new Object[0])); 
    return s1;
  }
      ...
      for (String s1 : nbttagcompound.getKeySet()) {
        ...
        try {
          if ("mouseSensitivity".equals(s1))
            this.mouseSensitivity = parseFloat(s2); 
          if ("fov".equals(s1))
            this.fovSetting = parseFloat(s2) * 40.0F + 70.0F; 
          if ("gamma".equals(s1))
            this.gammaSetting = parseFloat(s2); 
          if ("saturation".equals(s1))
            this.saturation = parseFloat(s2); 
          ...
          if ("resourcePacks".equals(s1)) {
            this.resourcePacks = (List<String>)JsonUtils.func_193840_a(GSON, s2, TYPE_LIST_STRING);
            if (this.resourcePacks == null)
              this.resourcePacks = Lists.newArrayList(); 
          } 
          if ("incompatibleResourcePacks".equals(s1)) {
            this.incompatibleResourcePacks = (List<String>)JsonUtils.func_193840_a(GSON, s2, TYPE_LIST_STRING);
          ...
          if ("chatOpacity".equals(s1))
            this.chatOpacity = parseFloat(s2); 
          ...
          if ("chatHeightFocused".equals(s1))
            this.chatHeightFocused = parseFloat(s2); 
          if ("chatHeightUnfocused".equals(s1))
            this.chatHeightUnfocused = parseFloat(s2); 
          if ("chatScale".equals(s1))
            this.chatScale = parseFloat(s2); 
          if ("chatWidth".equals(s1))
            this.chatWidth = parseFloat(s2); 
            ...
            if (s1.equals("key_" + keybinding.getKeyDescription()))
              if (Reflector.KeyModifier_valueFromString.exists()) {
                if (s2.indexOf(':') != -1) {
                  ...
                  Reflector.call(keybinding, Reflector.ForgeKeyBinding_setKeyModifierAndCode, new Object[] { object1, Integer.valueOf(Integer.parseInt(s2)) });
                } 
              } else {
          ...
          for (i = (arrayOfSoundCategory = SoundCategory.values()).length, b = 0; b < i; ) {
            ...
            if (s1.equals("soundCategory_" + soundcategory.getName()))
              this.soundLevels.put(soundcategory, Float.valueOf(parseFloat(s2))); 
            b++;
          } 
    ...
    try {
      ...
      for (i = (arrayOfKeyBinding = this.keyBindings).length, b = 0; b < i; ) {
        ...
        if (Reflector.ForgeKeyBinding_getKeyModifier.exists()) {
          ...
          printwriter.println((object1 != object2) ? (String.valueOf(s) + ":" + object1) : s);
        } else {
  ...
  public enum Options {
    ...
    public float normalizeValue(float value) {
      return MathHelper.clamp((snapToStepClamp(value) - this.valueMin) / (this.valueMax - this.valueMin), 0.0F, 1.0F);
    }
    
    public float denormalizeValue(float value) {
      return snapToStepClamp(this.valueMin + (this.valueMax - this.valueMin) * MathHelper.clamp(value, 0.0F, 1.0F));
    }
