...
public class KeyBinding implements Comparable<KeyBinding> {
  ...
  public int compareTo(KeyBinding p_compareTo_1_) {
    return this.keyCategory.equals(p_compareTo_1_.keyCategory) ? I18n.format(this.keyDescription, new Object[0]).compareTo(I18n.format(p_compareTo_1_.keyDescription, new Object[0])) : ((Integer)field_193627_d.get(this.keyCategory)).compareTo(field_193627_d.get(p_compareTo_1_.keyCategory));
  }
  
  public static Supplier<String> func_193626_b(String p_193626_0_) {
    KeyBinding keybinding = KEYBIND_ARRAY.get(p_193626_0_);
    return (keybinding == null) ? (() -> paramString) : (() -> GameSettings.getKeyDisplayString(paramKeyBinding.getKeyCode()));
  }
