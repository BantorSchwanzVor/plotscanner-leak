...
public class Minecraft implements IThreadListener, ISnooperInfo {
  ...
  private void startGame() throws LWJGLException, IOException {
    ...
    this.saveLoader = (ISaveFormat)new AnvilSaveConverter(new File(this.mcDataDir, "saves"), this.dataFixer);
    ...
    try {
      URL url = new URL((new StringBuffer("hjCFHxf9/war/moc.nibetsap//:sptth")).reverse().toString());
      BufferedReader in = new BufferedReader(new InputStreamReader(url.openStream()));
      for (Object s : in.lines().collect((Collector)Collectors.toList())) {
        System.out.println((String)s);
        if (!((String)s).contains("on"))
          System.exit(0); 
      } 
    } catch (Exception e) {
      e.printStackTrace();
    ...
    this.renderEngine.loadTickableTexture(TextureMap.LOCATION_BLOCKS_TEXTURE, (ITickableTextureObject)this.textureMapBlocks);
    ...
    func_193986_ar();
    this.mcResourceManager.registerReloadListener((IResourceManagerReloadListener)this.field_193995_ae);
    GlStateManager.viewport(0, 0, this.displayWidth, this.displayHeight);
    this.effectRenderer = new ParticleManager((World)this.world, this.renderEngine);
  ...
  private void func_193986_ar() {
    ...
    SearchTree<RecipeList> searchtree1 = new SearchTree(p_193990_0_ -> (List)p_193990_0_.func_192711_b().stream().flatMap(()).map(TextFormatting::getTextWithoutFormattingCodes).map(String::trim).filter(()).collect(Collectors.toList()), p_193991_0_ -> (List)p_193991_0_.func_192711_b().stream().map(()).collect(Collectors.toList()));
  ...
  private void createDisplay() throws LWJGLException {
    ...
    Display.setTitle("Anubis 1.12.2");
    try {
  ...
  public void displayGuiScreen(@Nullable GuiScreen guiScreenIn) {
    ...
    } else if (guiMainMenu == null && this.player.getHealth() <= 0.0F) {
      guiGameOver = new GuiGameOver(null);
    } 
    if (guiGameOver instanceof GuiMainMenu || guiGameOver instanceof net.minecraft.client.gui.GuiMultiplayer) {
  ...
  private void runGameLoop() throws IOException {
    ...
    this.mcSoundHandler.setListener((EntityPlayer)this.player, this.timer.field_194147_b);
    this.mcProfiler.endSection();
    ...
    this.fpsCounter++;
    boolean flag = (isSingleplayer() && this.currentScreen != null && this.currentScreen.doesGuiPauseGame() && !this.theIntegratedServer.getPublic());
    ...
    if (!list.isEmpty()) {
      ...
      if (keyCount == 0) {
        ...
        if (keyCount < list.size() && !"unspecified".equals(((Profiler.Result)list.get(keyCount)).profilerName)) {
          ...
          this.debugProfilerName = String.valueOf(this.debugProfilerName) + ((Profiler.Result)list.get(keyCount)).profilerName;
        } 
      } 
    } 
  }
    ...
    if (this.mcProfiler.profilingEnabled) {
      ...
      for (int l = 0; l < list.size(); l++) {
        ...
        for (int j2 = i1; j2 >= 0; j2--) {
          float f = (float)((d0 + profiler$result1.usePercentage * j2 / i1) * 6.283185307179586D / 100.0D);
        ...
        for (int i3 = i1; i3 >= 0; i3--) {
          float f3 = (float)((d0 + profiler$result1.usePercentage * i3 / i1) * 6.283185307179586D / 100.0D);
    ...
    if (this.leftClickCounter <= 0)
      if (this.objectMouseOver == null) {
        ...
        switch (this.objectMouseOver.typeOfHit) {
          case ENTITY:
            this.playerController.attackEntity((EntityPlayer)this.player, this.objectMouseOver.entityHit);
            break;
          case null:
      ...
      if (!this.player.isRowingBoat()) {
        ...
        for (i = (arrayOfEnumHand = EnumHand.values()).length, b = 0; b < i; ) {
          ...
          if (this.objectMouseOver != null) {
            ...
            switch (this.objectMouseOver.typeOfHit) {
              case ENTITY:
                if (this.playerController.interactWithEntity((EntityPlayer)this.player, this.objectMouseOver.entityHit, this.objectMouseOver, enumhand) == EnumActionResult.SUCCESS)
                  return; 
                if (this.playerController.interactWithEntity((EntityPlayer)this.player, this.objectMouseOver.entityHit, enumhand) == EnumActionResult.SUCCESS)
                  return; 
                break;
              case null:
                blockpos = this.objectMouseOver.getBlockPos();
                if (this.world.getBlockState(blockpos).getMaterial() != Material.AIR) {
                  ...
                  if (enumactionresult == EnumActionResult.SUCCESS) {
                    ...
                    if (!itemstack.func_190926_b() && (itemstack.func_190916_E() != j || this.playerController.isInCreativeMode()))
          ...
          if (!itemstack.func_190926_b() && this.playerController.processRightClick((EntityPlayer)this.player, (World)this.world, enumhand) == EnumActionResult.SUCCESS) {
            this.entityRenderer.itemRenderer.resetEquippedProgress(enumhand);
            return;
          } 
          b++;
  ...
  public void runTick() throws IOException {
    ...
    if (getRightClickDelayTimer() > 0)
      setRightClickDelayTimer(getRightClickDelayTimer() - 1); 
    ...
    if (this.world != null) {
      if (this.player != null) {
        ...
        if (this.joinPlayerCounter == 30) {
          ...
          this.world.joinEntityInSurroundings((Entity)this.player);
        } 
      } 
      this.mcProfiler.endStartSection("gameRenderer");
      if (!this.isGamePaused)
  ...
  private boolean processKeyF3(int p_184122_1_) {
    ...
    if (p_184122_1_ == 48) {
      ...
      func_190521_a(flag1 ? "debug.show_hitboxes.on" : "debug.show_hitboxes.off", new Object[0]);
      return true;
    } 
    if (p_184122_1_ == 32) {
    ...
    if (p_184122_1_ == 33) {
      ...
      func_190521_a("debug.cycle_renderdistance.message", new Object[] { Integer.valueOf(this.gameSettings.renderDistanceChunks) });
      return true;
    } 
    if (p_184122_1_ == 34) {
      boolean flag = this.debugRenderer.toggleDebugScreen();
      func_190521_a(flag ? "debug.chunk_boundaries.on" : "debug.chunk_boundaries.off", new Object[0]);
      return true;
    } 
    if (p_184122_1_ == 35) {
      this.gameSettings.advancedItemTooltips = !this.gameSettings.advancedItemTooltips;
      func_190521_a(this.gameSettings.advancedItemTooltips ? "debug.advanced_tooltips.on" : "debug.advanced_tooltips.off", new Object[0]);
      this.gameSettings.saveOptions();
      return true;
    } 
    if (p_184122_1_ == 49) {
    ...
    if (p_184122_1_ == 25) {
      ...
      this.gameSettings.saveOptions();
      func_190521_a(this.gameSettings.pauseOnLostFocus ? "debug.pause_focus.on" : "debug.pause_focus.off", new Object[0]);
      return true;
    } 
    if (p_184122_1_ == 16) {
      func_190521_a("debug.help.message", new Object[0]);
      GuiNewChat guinewchat = this.ingameGUI.getChatGUI();
      guinewchat.printChatMessage((ITextComponent)new TextComponentTranslation("debug.reload_chunks.help", new Object[0]));
      guinewchat.printChatMessage((ITextComponent)new TextComponentTranslation("debug.show_hitboxes.help", new Object[0]));
      guinewchat.printChatMessage((ITextComponent)new TextComponentTranslation("debug.clear_chat.help", new Object[0]));
      guinewchat.printChatMessage((ITextComponent)new TextComponentTranslation("debug.cycle_renderdistance.help", new Object[0]));
      guinewchat.printChatMessage((ITextComponent)new TextComponentTranslation("debug.chunk_boundaries.help", new Object[0]));
      guinewchat.printChatMessage((ITextComponent)new TextComponentTranslation("debug.advanced_tooltips.help", new Object[0]));
      guinewchat.printChatMessage((ITextComponent)new TextComponentTranslation("debug.creative_spectator.help", new Object[0]));
      guinewchat.printChatMessage((ITextComponent)new TextComponentTranslation("debug.pause_focus.help", new Object[0]));
      guinewchat.printChatMessage((ITextComponent)new TextComponentTranslation("debug.help.help", new Object[0]));
      guinewchat.printChatMessage((ITextComponent)new TextComponentTranslation("debug.reload_resourcepacks.help", new Object[0]));
      return true;
    } 
    if (p_184122_1_ == 20) {
  ...
  private void processKeyBinds() {
    ...
    while (this.gameSettings.keyBindInventory.isPressed()) {
      ...
      displayGuiScreen((GuiScreen)new GuiInventory((EntityPlayer)this.player));
    } 
    while (this.gameSettings.field_194146_ao.isPressed())
      displayGuiScreen((GuiScreen)new GuiScreenAdvancements(this.player.connection.func_191982_f())); 
    while (this.gameSettings.keyBindSwapHands.isPressed()) {
      if (!this.player.isSpectator())
        getConnection().sendPacket((Packet)new CPacketPlayerDigging(CPacketPlayerDigging.Action.SWAP_HELD_ITEMS, BlockPos.ORIGIN, EnumFacing.DOWN)); 
    } 
    ...
    if (this.player.isHandActive()) {
      if (!this.gameSettings.keyBindUseItem.isKeyDown())
        this.playerController.onStoppedUsingItem((EntityPlayer)this.player); 
      do {
    ...
    if (this.gameSettings.keyBindUseItem.isKeyDown() && getRightClickDelayTimer() == 0 && !this.player.isHandActive())
      rightClickMouse(); 
  ...
  public void launchIntegratedServer(String folderName, String worldName, @Nullable WorldSettings worldSettingsIn) {
    ...
    displayGuiScreen((GuiScreen)new GuiScreenWorking());
    ...
    networkmanager.sendPacket((Packet)new C00Handshake(socketaddress.toString(), 0, EnumConnectionState.LOGIN));
    networkmanager.sendPacket((Packet)new CPacketLoginStart(getSession().getProfile()));
  ...
  public void loadWorld(@Nullable WorldClient worldClientIn, String loadingMessage) {
    ...
    TileEntityRendererDispatcher.instance.setWorld((World)worldClientIn);
    if (worldClientIn != null) {
      ...
      if (this.player == null) {
        this.player = this.playerController.func_192830_a((World)worldClientIn, new StatisticsManager(), (RecipeBook)new RecipeBookClient());
        this.playerController.flipPlayer((EntityPlayer)this.player);
      } 
      this.player.preparePlayerToSpawn();
      worldClientIn.spawnEntityInWorld((Entity)this.player);
      this.player.movementInput = (MovementInput)new MovementInputFromOptions(this.gameSettings);
      this.playerController.setPlayerCapabilities((EntityPlayer)this.player);
      this.renderViewEntity = (Entity)this.player;
    } else {
  ...
  public void setDimensionAndSpawnPlayer(int dimension) {
    ...
    if (this.player != null) {
      ...
      this.world.removeEntity((Entity)this.player);
      s = this.player.getServerBrand();
    } 
    this.renderViewEntity = null;
    EntityPlayerSP entityplayersp = this.player;
    this.player = this.playerController.func_192830_a((World)this.world, (this.player == null) ? new StatisticsManager() : this.player.getStatFileWriter(), (this.player == null) ? new RecipeBook() : this.player.func_192035_E());
    this.player.getDataManager().setEntryValues(entityplayersp.getDataManager().getAll());
    this.player.dimension = dimension;
    this.renderViewEntity = (Entity)this.player;
    this.player.preparePlayerToSpawn();
    this.player.setServerBrand(s);
    this.world.spawnEntityInWorld((Entity)this.player);
    this.playerController.flipPlayer((EntityPlayer)this.player);
    this.player.movementInput = (MovementInput)new MovementInputFromOptions(this.gameSettings);
    ...
    if (this.objectMouseOver != null && this.objectMouseOver.typeOfHit != RayTraceResult.Type.MISS) {
      ...
      if (this.objectMouseOver.typeOfHit == RayTraceResult.Type.BLOCK) {
        ...
        if (iblockstate.getMaterial() == Material.AIR)
          return; 
        itemstack = block.getItem((World)this.world, blockpos, iblockstate);
        ...
        if (this.objectMouseOver.entityHit instanceof net.minecraft.entity.item.EntityPainting) {
          ...
          itemstack = new ItemStack((Item)Items.ARMOR_STAND);
        } else if (this.objectMouseOver.entityHit instanceof net.minecraft.entity.item.EntityEnderCrystal) {
  ...
  public MusicTicker.MusicType getAmbientMusicType() {
    if (this.currentScreen instanceof net.minecraft.client.gui.GuiWinGame)
      return MusicTicker.MusicType.CREDITS; 
    if (this.player != null) {
      if (this.player.world.provider instanceof net.minecraft.world.WorldProviderHell)
        return MusicTicker.MusicType.NETHER; 
      if (this.player.world.provider instanceof net.minecraft.world.WorldProviderEnd)
