...
public class GuiToast extends Gui {
  ...
  private final ToastInstance<?>[] field_191791_g = (ToastInstance<?>[])new ToastInstance[5];
    ...
    if (!this.field_191790_f.gameSettings.hideGUI) {
      ...
      for (int i = 0; i < this.field_191791_g.length; i++) {
        ...
        if (this.field_191791_g[i] == null && !this.field_191792_h.isEmpty())
          this.field_191791_g[i] = new ToastInstance(this.field_191792_h.removeFirst(), null); 
      } 
    } 
  }
  ...
  public <T extends IToast> T func_192990_a(Class<? extends T> p_192990_1_, Object p_192990_2_) {
    ...
    for (i = (arrayOfToastInstance = this.field_191791_g).length, b = 0; b < i; ) {
      ToastInstance<?> toastinstance = arrayOfToastInstance[b];
  ...
  public void func_191788_b() {
    Arrays.fill((Object[])this.field_191791_g, (Object)null);
  ...
  class ToastInstance<T extends IToast> {
    ...
    public boolean func_193684_a(int p_193684_1_, int p_193684_2_) {
      ...
      GlStateManager.translate(p_193684_1_ - 160.0F * func_193686_a(i), (p_193684_2_ * 32), (500 + p_193684_2_));
      ...
      if (itoast$visibility != this.field_193691_e) {
        this.field_193689_c = i - (int)((1.0F - func_193686_a(i)) * 600.0F);
