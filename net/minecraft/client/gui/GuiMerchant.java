...
public class GuiMerchant extends GuiContainer {
  ...
  public void initGui() {
    ...
    this.nextButton = (MerchantButton)addButton(new MerchantButton(1, i + 120 + 27, j + 24 - 1, true));
    this.previousButton = (MerchantButton)addButton(new MerchantButton(2, i + 36 - 19, j + 24 - 1, false));
  ...
  public void updateScreen() {
    super.updateScreen();
    MerchantRecipeList merchantrecipelist = this.merchant.getRecipes((EntityPlayer)this.mc.player);
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if (merchantrecipelist != null && !merchantrecipelist.isEmpty()) {
      ...
      GlStateManager.disableLighting();
      if (isPointInRegion(36, 24, 16, 16, mouseX, mouseY) && !itemstack.func_190926_b()) {
        renderToolTip(itemstack, mouseX, mouseY);
      } else if (!itemstack1.func_190926_b() && isPointInRegion(62, 24, 16, 16, mouseX, mouseY) && !itemstack1.func_190926_b()) {
        renderToolTip(itemstack1, mouseX, mouseY);
      } else if (!itemstack2.func_190926_b() && isPointInRegion(120, 24, 16, 16, mouseX, mouseY) && !itemstack2.func_190926_b()) {
