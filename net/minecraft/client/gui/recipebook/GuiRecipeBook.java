...
public class GuiRecipeBook extends Gui implements IRecipeUpdateListener {
  ...
  private void func_193003_g(boolean p_193003_1_) {
    List<RecipeList> list = (List<RecipeList>)RecipeBookClient.field_194086_e.get(this.field_191913_x.func_191764_e());
    ...
    if (!s.isEmpty()) {
      ObjectLinkedOpenHashSet objectLinkedOpenHashSet = new ObjectLinkedOpenHashSet(this.field_191888_F.func_193987_a(SearchTreeManager.field_194012_b).func_194038_a(s.toLowerCase(Locale.ROOT)));
      list1.removeIf(p_193947_1_ -> !paramObjectSet.contains(p_193947_1_));
    } 
  ...
  public boolean func_191862_a(int p_191862_1_, int p_191862_2_, int p_191862_3_) {
    if (func_191878_b() && !this.field_191888_F.player.isSpectator()) {
      if (this.field_193022_s.func_194196_a(p_191862_1_, p_191862_2_, p_191862_3_, (this.field_191904_o - 147) / 2 - this.field_191903_n, (this.field_191905_p - 166) / 2, 147, 166)) {
        ...
        if (irecipe != null && recipelist != null) {
          if (!recipelist.func_194213_a(irecipe) && this.field_191915_z.func_192686_c() == irecipe)
            return false; 
          this.field_191915_z.func_192682_a();
          this.field_191888_F.playerController.func_194338_a(this.field_191888_F.player.openContainer.windowId, irecipe, GuiScreen.isShiftKeyDown(), (EntityPlayer)this.field_191888_F.player);
  ...
  public void func_193951_a(IRecipe p_193951_1_, List<Slot> p_193951_2_) {
    ...
    this.field_191915_z.func_194187_a(Ingredient.func_193369_a(new ItemStack[] { itemstack }, ), ((Slot)p_193951_2_.get(0)).xDisplayPosition, ((Slot)p_193951_2_.get(0)).yDisplayPosition);
  ...
  private void func_193956_j() {
    if (this.field_191888_F.getConnection() != null)
      this.field_191888_F.getConnection().sendPacket((Packet)new CPacketRecipeInfo(func_191878_b(), this.field_193964_s.func_192815_c())); 
  }
}
