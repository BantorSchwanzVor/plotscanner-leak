...
public class GuiButtonRecipeTab extends GuiButtonToggle {
  ...
  public void func_193918_a(Minecraft p_193918_1_) {
    ...
    for (RecipeList recipelist : RecipeBookClient.field_194086_e.get(this.field_193921_u)) {
      Iterator<IRecipe> iterator = recipelist.func_194208_a(recipebook.func_192815_c()).iterator();
  ...
  public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_) {
    if (this.visible) {
      if (this.field_193922_v > 0.0F) {
        float f = 1.0F + 0.1F * (float)Math.sin((this.field_193922_v / 15.0F * 3.1415927F));
      ...
      drawTexturedModalRect(j, this.yPosition, k, i, this.width, this.height);
      GlStateManager.enableDepth();
      RenderHelper.enableGUIStandardItemLighting();
      GlStateManager.disableLighting();
      func_193920_a(p_191745_1_.getRenderItem());
  ...
  public boolean func_193919_e() {
    List<RecipeList> list = (List<RecipeList>)RecipeBookClient.field_194086_e.get(this.field_193921_u);
    this.visible = false;
