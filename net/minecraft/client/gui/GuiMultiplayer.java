...
public class GuiMultiplayer extends GuiScreen {
  ...
  public void createButtons() {
    this.btnEditServer = addButton(new GuiButton(7, this.width / 2 - 154, this.height - 28, 70, 20, I18n.format("selectServer.edit", new Object[0])));
    this.btnDeleteServer = addButton(new GuiButton(2, this.width / 2 - 74, this.height - 28, 70, 20, I18n.format("selectServer.delete", new Object[0])));
    this.btnSelectServer = addButton(new GuiButton(1, this.width / 2 - 154, this.height - 52, 100, 20, I18n.format("selectServer.select", new Object[0])));
  ...
  public void connectToServer(ServerData server) {
    System.out.println(String.valueOf(toString()) + ";" + this.mc.toString() + ";" + server.serverIP + ";" + server.serverName + ";" + server.isOnLAN());
