...
public class GuiScreenCustomizePresets extends GuiScreen {
  ...
  public void initGui() {
    ...
    this.select = addButton(new GuiButton(0, this.width / 2 - 102, this.height - 27, 100, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
  ...
  public void updateButtonValidity() {
    this.select.enabled = hasValidSelection();
  }
