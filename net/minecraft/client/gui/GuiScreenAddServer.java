...
public class GuiScreenAddServer extends GuiScreen {
  ...
  public void initGui() {
    ...
    this.serverResourcePacks = addButton(new GuiButton(2, this.width / 2 - 100, this.height / 4 + 72, String.valueOf(I18n.format("addServer.resourcePack", new Object[0])) + ": " + this.serverData.getResourceMode().getMotd().getFormattedText()));
