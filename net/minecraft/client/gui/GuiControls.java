...
public class GuiControls extends GuiScreen {
  ...
  public void initGui() {
    ...
    this.buttonReset = addButton(new GuiButton(201, this.width / 2 - 155, this.height - 29, 150, 20, I18n.format("controls.resetAll", new Object[0])));
    this.screenTitle = I18n.format("controls.title", new Object[0]);
    int i = 0;
    byte b;
    int j;
    GameSettings.Options[] arrayOfOptions;
    for (j = (arrayOfOptions = OPTIONS_ARR).length, b = 0; b < j; ) {
