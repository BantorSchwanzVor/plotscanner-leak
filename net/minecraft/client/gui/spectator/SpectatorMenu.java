...
public class SpectatorMenu {
  private static final ISpectatorMenuObject CLOSE_ITEM = new EndSpectatorObject(null);
  ...
  public void selectCategory(ISpectatorMenuView menuView) {
    this.previousCategories.add(getCurrentPage());
  ...
  static class EndSpectatorObject implements ISpectatorMenuObject {
    ...
    public ITextComponent getSpectatorName() {
      return (ITextComponent)new TextComponentTranslation("spectatorMenu.close", new Object[0]);
    }
  ...
  static class MoveMenuObject implements ISpectatorMenuObject {
    ...
    public ITextComponent getSpectatorName() {
      return (this.direction < 0) ? (ITextComponent)new TextComponentTranslation("spectatorMenu.previous_page", new Object[0]) : (ITextComponent)new TextComponentTranslation("spectatorMenu.next_page", new Object[0]);
    }
