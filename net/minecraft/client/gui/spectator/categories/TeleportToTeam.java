...
public class TeleportToTeam implements ISpectatorMenuView, ISpectatorMenuObject {
  ...
  public ITextComponent getPrompt() {
    return (ITextComponent)new TextComponentTranslation("spectatorMenu.team_teleport.prompt", new Object[0]);
  }
  ...
  public ITextComponent getSpectatorName() {
    return (ITextComponent)new TextComponentTranslation("spectatorMenu.team_teleport", new Object[0]);
  }
  ...
  class TeamSelectionObject implements ISpectatorMenuObject {
    ...
    public ITextComponent getSpectatorName() {
      return (ITextComponent)new TextComponentString(this.team.getTeamName());
    }
