...
public class PlayerMenuObject implements ISpectatorMenuObject {
  ...
  public void selectItem(SpectatorMenu menu) {
    Minecraft.getMinecraft().getConnection().sendPacket((Packet)new CPacketSpectate(this.profile.getId()));
  }
  
  public ITextComponent getSpectatorName() {
    return (ITextComponent)new TextComponentString(this.profile.getName());
  }
