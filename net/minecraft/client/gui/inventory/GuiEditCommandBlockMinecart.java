...
public class GuiEditCommandBlockMinecart extends GuiScreen implements ITabCompleter {
  ...
  public void initGui() {
    ...
    this.doneButton = addButton(new GuiButton(0, this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.done", new Object[0])));
    this.cancelButton = addButton(new GuiButton(1, this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.cancel", new Object[0])));
    this.outputButton = addButton(new GuiButton(4, this.width / 2 + 150 - 20, 150, 20, 20, "O"));
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if (button.enabled)
      if (button.id == 1) {
        ...
        this.commandBlockLogic.fillInInfo((ByteBuf)packetbuffer);
