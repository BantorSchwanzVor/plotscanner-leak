...
public class GuiBeacon extends GuiContainer {
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if (button.id == -2) {
      this.mc.player.connection.sendPacket((Packet)new CPacketCloseWindow(this.mc.player.openContainer.windowId));
  ...
  static class Button extends GuiButton {
    ...
    public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_) {
      if (this.visible) {
        ...
        drawTexturedModalRect(this.xPosition, this.yPosition, j, 219, this.width, this.height);
        if (!GuiBeacon.BEACON_GUI_TEXTURES.equals(this.iconTexture))
          p_191745_1_.getTextureManager().bindTexture(this.iconTexture); 
        drawTexturedModalRect(this.xPosition + 2, this.yPosition + 2, this.iconX, this.iconY, 18, 18);
      } 
    }
