...
public abstract class GuiContainer extends GuiScreen {
  ...
  protected void func_191948_b(int p_191948_1_, int p_191948_2_) {
    if (this.mc.player.inventory.getItemStack().func_190926_b() && this.theSlot != null && this.theSlot.getHasStack())
      renderToolTip(this.theSlot.getStack(), p_191948_1_, p_191948_2_); 
  }
      ...
      if (isShiftKeyDown()) {
        if (!this.shiftClickedSlot.func_190926_b())
          for (Slot slot2 : this.inventorySlots.inventorySlots) {
            if (slot2 != null && slot2.canTakeStack((EntityPlayer)this.mc.player) && slot2.getHasStack() && slot2.inventory == slot.inventory && Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true))
      ...
      if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
        if (state == 0 || state == 1) {
          ...
          if (k != -1 && !this.draggedStack.func_190926_b() && flag2) {
            handleMouseClick(this.clickedSlot, this.clickedSlot.slotNumber, state, ClickType.PICKUP);
        ...
        for (Slot slot1 : this.dragSplittingSlots)
          handleMouseClick(slot1, slot1.slotNumber, Container.getQuickcraftMask(1, this.dragSplittingLimit), ClickType.QUICK_CRAFT); 
  ...
  protected void handleMouseClick(Slot slotIn, int slotId, int mouseButton, ClickType type) {
    ...
    this.mc.playerController.windowClick(this.inventorySlots.windowId, slotId, mouseButton, type, (EntityPlayer)this.mc.player);
  }
  ...
  protected void keyTyped(char typedChar, int keyCode) throws IOException {
    ...
    if (this.theSlot != null && this.theSlot.getHasStack())
      if (keyCode == this.mc.gameSettings.keyBindPickBlock.getKeyCode()) {
        ...
        handleMouseClick(this.theSlot, this.theSlot.slotNumber, isCtrlKeyDown() ? 1 : 0, ClickType.THROW);
      }  
  }
    ...
    if (this.mc.player.inventory.getItemStack().func_190926_b() && this.theSlot != null)
      for (int i = 0; i < 9; i++) {
        if (keyCode == this.mc.gameSettings.keyBindsHotbar[i].getKeyCode()) {
          handleMouseClick(this.theSlot, this.theSlot.slotNumber, i, ClickType.SWAP);
          return true;
        } 
      }  
    return false;
  ...
  public void onGuiClosed() {
    if (this.mc.player != null)
      this.inventorySlots.onContainerClosed((EntityPlayer)this.mc.player); 
  }
