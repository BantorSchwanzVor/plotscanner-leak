...
public class GuiEditStructure extends GuiScreen {
  ...
  public void initGui() {
    ...
    this.doneButton = addButton(new GuiButton(0, this.width / 2 - 4 - 150, 210, 150, 20, I18n.format("gui.done", new Object[0])));
    this.cancelButton = addButton(new GuiButton(1, this.width / 2 + 4, 210, 150, 20, I18n.format("gui.cancel", new Object[0])));
    this.saveButton = addButton(new GuiButton(9, this.width / 2 + 4 + 100, 185, 50, 20, I18n.format("structure_block.button.save", new Object[0])));
    this.loadButton = addButton(new GuiButton(10, this.width / 2 + 4 + 100, 185, 50, 20, I18n.format("structure_block.button.load", new Object[0])));
    this.modeButton = addButton(new GuiButton(18, this.width / 2 - 4 - 150, 185, 50, 20, "MODE"));
    this.detectSizeButton = addButton(new GuiButton(19, this.width / 2 + 4 + 100, 120, 50, 20, I18n.format("structure_block.button.detect_size", new Object[0])));
    this.showEntitiesButton = addButton(new GuiButton(20, this.width / 2 + 4 + 100, 160, 50, 20, "ENTITIES"));
    this.mirrorButton = addButton(new GuiButton(21, this.width / 2 - 20, 185, 40, 20, "MIRROR"));
    this.showAirButton = addButton(new GuiButton(22, this.width / 2 + 4 + 100, 80, 50, 20, "SHOWAIR"));
    this.showBoundingBoxButton = addButton(new GuiButton(23, this.width / 2 + 4 + 100, 80, 50, 20, "SHOWBB"));
    this.rotateZeroDegreesButton = addButton(new GuiButton(11, this.width / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20, "0"));
    this.rotateNinetyDegreesButton = addButton(new GuiButton(12, this.width / 2 - 1 - 40 - 20, 185, 40, 20, "90"));
    this.rotate180DegreesButton = addButton(new GuiButton(13, this.width / 2 + 1 + 20, 185, 40, 20, "180"));
    this.rotate270DegressButton = addButton(new GuiButton(14, this.width / 2 + 1 + 40 + 1 + 20, 185, 40, 20, "270"));
  ...
  private boolean sendToServer(int p_189820_1_) {
    try {
      ...
      this.tileStructure.writeCoordinates((ByteBuf)packetbuffer);
      ...
      packetbuffer.writeInt(parseCoordinate(this.posXEdit.getText()));
      packetbuffer.writeInt(parseCoordinate(this.posYEdit.getText()));
      packetbuffer.writeInt(parseCoordinate(this.posZEdit.getText()));
      packetbuffer.writeInt(parseCoordinate(this.sizeXEdit.getText()));
      packetbuffer.writeInt(parseCoordinate(this.sizeYEdit.getText()));
      packetbuffer.writeInt(parseCoordinate(this.sizeZEdit.getText()));
      ...
      packetbuffer.writeFloat(parseIntegrity(this.integrityEdit.getText()));
      packetbuffer.writeVarLong(parseSeed(this.seedEdit.getText()));
  ...
  private static boolean isValidCharacterForName(char p_190301_0_, int p_190301_1_) {
    ...
    byte b;
    int i, arrayOfInt[];
    for (i = (arrayOfInt = LEGAL_KEY_CODES).length, b = 0; b < i; ) {
      int j = arrayOfInt[b];
      if (j == p_190301_1_)
        return true; 
      b++;
    ...
    char[] arrayOfChar;
    for (i = (arrayOfChar = ChatAllowedCharacters.ILLEGAL_STRUCTURE_CHARACTERS).length, b = 0; b < i; ) {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    drawCenteredString(this.fontRendererObj, I18n.format("tile.structureBlock.name", new Object[0]), this.width / 2, 10, 16777215);
    if (tileentitystructure$mode != TileEntityStructure.Mode.DATA) {
      drawString(this.fontRendererObj, I18n.format("structure_block.structure_name", new Object[0]), this.width / 2 - 153, 30, 10526880);
    ...
    if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD || tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
      drawString(this.fontRendererObj, I18n.format("structure_block.position", new Object[0]), this.width / 2 - 153, 70, 10526880);
      ...
      drawString(this.fontRendererObj, s, this.width / 2 + 154 - i, 150, 10526880);
    } 
    if (tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
      drawString(this.fontRendererObj, I18n.format("structure_block.size", new Object[0]), this.width / 2 - 153, 110, 10526880);
      ...
      drawString(this.fontRendererObj, s2, this.width / 2 + 154 - k, 110, 10526880);
    ...
    if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD) {
      drawString(this.fontRendererObj, I18n.format("structure_block.integrity", new Object[0]), this.width / 2 - 153, 110, 10526880);
      ...
      drawString(this.fontRendererObj, s3, this.width / 2 + 154 - l, 70, 10526880);
    } 
    if (tileentitystructure$mode == TileEntityStructure.Mode.DATA) {
      drawString(this.fontRendererObj, I18n.format("structure_block.custom_data", new Object[0]), this.width / 2 - 153, 110, 10526880);
      this.dataEdit.drawTextBox();
    } 
    String s4 = "structure_block.mode_info." + tileentitystructure$mode.getName();
    drawString(this.fontRendererObj, I18n.format(s4, new Object[0]), this.width / 2 - 153, 174, 10526880);
