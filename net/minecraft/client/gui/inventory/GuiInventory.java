...
public class GuiInventory extends InventoryEffectRenderer implements IRecipeShownListener {
  ...
  public void updateScreen() {
    if (this.mc.playerController.isInCreativeMode())
      this.mc.displayGuiScreen((GuiScreen)new GuiContainerCreative((EntityPlayer)this.mc.player)); 
  ...
  protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
    ...
    drawEntityOnScreen(i + 51, j + 75, 30, (i + 51) - this.oldMouseX, (j + 75 - 50) - this.oldMouseY, (EntityLivingBase)this.mc.player);
  }
