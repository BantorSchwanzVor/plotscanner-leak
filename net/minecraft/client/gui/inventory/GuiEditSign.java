...
public class GuiEditSign extends GuiScreen {
  ...
  public void initGui() {
    ...
    this.doneBtn = addButton(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 120, I18n.format("gui.done", new Object[0])));
  ...
  public void onGuiClosed() {
    ...
    if (nethandlerplayclient != null)
      nethandlerplayclient.sendPacket((Packet)new CPacketUpdateSign(this.tileSign.getPos(), this.tileSign.signText)); 
