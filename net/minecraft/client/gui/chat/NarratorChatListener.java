...
public class NarratorChatListener implements IChatListener {
  ...
  public void func_193641_a(int p_193641_1_) {
    ...
    if (this.field_192580_a.active()) {
      if (p_193641_1_ == 0) {
        SystemToast.func_193657_a(guitoast, SystemToast.Type.NARRATOR_TOGGLE, (ITextComponent)new TextComponentTranslation("narrator.toast.disabled", new Object[0]), null);
      } else {
        SystemToast.func_193657_a(guitoast, SystemToast.Type.NARRATOR_TOGGLE, (ITextComponent)new TextComponentTranslation("narrator.toast.enabled", new Object[0]), (ITextComponent)new TextComponentTranslation(GameSettings.field_193632_b[p_193641_1_], new Object[0]));
      } 
    } else {
      SystemToast.func_193657_a(guitoast, SystemToast.Type.NARRATOR_TOGGLE, (ITextComponent)new TextComponentTranslation("narrator.toast.disabled", new Object[0]), (ITextComponent)new TextComponentTranslation("options.narrator.notavailable", new Object[0]));
    } 
  }
