  ...
  public static class Cache {
    ...
    public ResourceLocation getResourceLocation(String id, List<BannerPattern> patternList, List<EnumDyeColor> colorList) {
      ...
      if (bannertextures$cacheentry == null) {
        ...
        bannertextures$cacheentry = new BannerTextures.CacheEntry(null);
        bannertextures$cacheentry.textureLocation = new ResourceLocation(id);
        Minecraft.getMinecraft().getTextureManager().loadTexture(bannertextures$cacheentry.textureLocation, (ITextureObject)new LayeredColorMaskTexture(this.cacheResourceLocation, list, colorList));
