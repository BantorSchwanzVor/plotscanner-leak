...
public class DebugRendererSolidFace implements DebugRenderer.IDebugRenderer {
  ...
  public void render(float p_190060_1_, long p_190060_2_) {
    EntityPlayerSP entityPlayerSP = this.field_193851_a.player;
    ...
    Iterable<BlockPos> iterable = BlockPos.func_191532_a(MathHelper.floor(((EntityPlayer)entityPlayerSP).posX - 6.0D), MathHelper.floor(((EntityPlayer)entityPlayerSP).posY - 6.0D), MathHelper.floor(((EntityPlayer)entityPlayerSP).posZ - 6.0D), MathHelper.floor(((EntityPlayer)entityPlayerSP).posX + 6.0D), MathHelper.floor(((EntityPlayer)entityPlayerSP).posY + 6.0D), MathHelper.floor(((EntityPlayer)entityPlayerSP).posZ + 6.0D));
    ...
    for (BlockPos blockpos : iterable) {
      ...
      if (iblockstate.getBlock() != Blocks.AIR) {
        ...
        float f2 = 0.0F;
        float f3 = 0.5F;
        if (iblockstate.func_193401_d((IBlockAccess)world, blockpos, EnumFacing.WEST) == BlockFaceShape.SOLID) {
        ...
        if (iblockstate.func_193401_d((IBlockAccess)world, blockpos, EnumFacing.SOUTH) == BlockFaceShape.SOLID) {
        ...
        if (iblockstate.func_193401_d((IBlockAccess)world, blockpos, EnumFacing.EAST) == BlockFaceShape.SOLID) {
        ...
        if (iblockstate.func_193401_d((IBlockAccess)world, blockpos, EnumFacing.NORTH) == BlockFaceShape.SOLID) {
        ...
        if (iblockstate.func_193401_d((IBlockAccess)world, blockpos, EnumFacing.DOWN) == BlockFaceShape.SOLID) {
        ...
        if (iblockstate.func_193401_d((IBlockAccess)world, blockpos, EnumFacing.UP) == BlockFaceShape.SOLID) {
