...
public class DebugRenderer {
  ...
  public static void renderDebugText(String str, double x, double y, double z, float partialTicks, int color) {
    ...
    if (minecraft.player != null && minecraft.getRenderManager() != null && (minecraft.getRenderManager()).options != null) {
      ...
      double d0 = ((EntityPlayer)entityPlayerSP).lastTickPosX + (((EntityPlayer)entityPlayerSP).posX - ((EntityPlayer)entityPlayerSP).lastTickPosX) * partialTicks;
      double d1 = ((EntityPlayer)entityPlayerSP).lastTickPosY + (((EntityPlayer)entityPlayerSP).posY - ((EntityPlayer)entityPlayerSP).lastTickPosY) * partialTicks;
      double d2 = ((EntityPlayer)entityPlayerSP).lastTickPosZ + (((EntityPlayer)entityPlayerSP).posZ - ((EntityPlayer)entityPlayerSP).lastTickPosZ) * partialTicks;
      ...
      GlStateManager.rotate(((rendermanager.options.thirdPersonView == 2) ? true : -1) * rendermanager.playerViewX, 1.0F, 0.0F, 0.0F);
