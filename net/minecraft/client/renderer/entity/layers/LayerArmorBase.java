...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase> {
    ...
    if (itemstack.getItem() instanceof ItemArmor) {
      ...
      if (itemarmor.getEquipmentSlot() == slotIn) {
        ...
        if (Reflector.ForgeHooksClient_getArmorTexture.exists()) {
          ...
          t.render((Entity)entityLivingBaseIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale);
          if (!this.skipRenderGlint && itemstack.hasEffect() && (!Config.isCustomItems() || !CustomItems.renderCustomArmorEffect(entityLivingBaseIn, itemstack, (ModelBase)t, limbSwing, limbSwingAmount, partialTicks, ageInTicks, netHeadYaw, headPitch, scale)))
        ...
        if (!this.skipRenderGlint && itemstack.isItemEnchanted() && (!Config.isCustomItems() || !CustomItems.renderCustomArmorEffect(entityLivingBaseIn, itemstack, (ModelBase)t, limbSwing, limbSwingAmount, partialTicks, ageInTicks, netHeadYaw, headPitch, scale)))
          renderEnchantedGlint(this.renderer, entityLivingBaseIn, (ModelBase)t, limbSwing, limbSwingAmount, partialTicks, ageInTicks, netHeadYaw, headPitch, scale); 
      } 
    } 
  }
  ...
  public ResourceLocation getArmorResource(Entity p_getArmorResource_1_, ItemStack p_getArmorResource_2_, EntityEquipmentSlot p_getArmorResource_3_, String p_getArmorResource_4_) {
    ...
    String s2 = String.format("%s:textures/models/armor/%s_layer_%d%s.png", new Object[] { s1, s, Integer.valueOf(isLegSlot(p_getArmorResource_3_) ? 2 : 1), (p_getArmorResource_4_ == null) ? "" : String.format("_%s", new Object[] { p_getArmorResource_4_ }) });
