...
public class LayerCustomHead implements LayerRenderer<EntityLivingBase> {
  ...
  public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    if (!itemstack.func_190926_b()) {
      ...
      boolean flag = !(!(entitylivingbaseIn instanceof net.minecraft.entity.passive.EntityVillager) && !(entitylivingbaseIn instanceof net.minecraft.entity.monster.EntityZombieVillager));
      if (entitylivingbaseIn.isChild() && !(entitylivingbaseIn instanceof net.minecraft.entity.passive.EntityVillager)) {
        float f = 2.0F;
        float f1 = 1.4F;
