...
public abstract class Render<T extends Entity> implements IEntityRenderer {
  ...
  private void renderShadowSingle(IBlockState state, double p_188299_2_, double p_188299_4_, double p_188299_6_, BlockPos p_188299_8_, float p_188299_9_, float p_188299_10_, double p_188299_11_, double p_188299_13_, double p_188299_15_) {
    if (state.isFullCube()) {
      Tessellator tessellator = Tessellator.getInstance();
      BufferBuilder bufferbuilder = tessellator.getBuffer();
      double d0 = (p_188299_9_ - (p_188299_4_ - p_188299_8_.getY() + p_188299_13_) / 2.0D) * 0.5D * getWorldFromRenderManager().getLightBrightness(p_188299_8_);
      if (d0 >= 0.0D) {
        if (d0 > 1.0D)
          d0 = 1.0D; 
        AxisAlignedBB axisalignedbb = state.getBoundingBox((IBlockAccess)getWorldFromRenderManager(), p_188299_8_);
