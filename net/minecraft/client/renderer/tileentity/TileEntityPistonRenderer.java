...
public class TileEntityPistonRenderer extends TileEntitySpecialRenderer<TileEntityPiston> {
  ...
  public void func_192841_a(TileEntityPiston p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_) {
    ...
    if (iblockstate.getMaterial() != Material.AIR && p_192841_1_.getProgress(p_192841_8_) < 1.0F) {
      ...
      if (block == Blocks.PISTON_HEAD && p_192841_1_.getProgress(p_192841_8_) <= 0.25F) {
        ...
        iblockstate1 = iblockstate1.withProperty((IProperty)BlockPistonExtension.SHORT, Boolean.valueOf((p_192841_1_.getProgress(p_192841_8_) >= 0.5F)));
        ...
        iblockstate = iblockstate.withProperty((IProperty)BlockPistonBase.EXTENDED, Boolean.valueOf(true));
        renderStateModel(blockpos, iblockstate, bufferbuilder, world, true);
      } else {
  ...
  private boolean renderStateModel(BlockPos p_188186_1_, IBlockState p_188186_2_, BufferBuilder p_188186_3_, World p_188186_4_, boolean p_188186_5_) {
    return this.blockRenderer.getBlockModelRenderer().renderModel((IBlockAccess)p_188186_4_, this.blockRenderer.getModelForState(p_188186_2_), p_188186_2_, p_188186_1_, p_188186_3_, p_188186_5_);
  }
}
