...
public class ChunkRenderWorker implements Runnable {
  ...
  protected void processTask(final ChunkCompileTaskGenerator generator) throws InterruptedException {
    ...
    try {
      ...
      BlockPos blockpos = new BlockPos((Entity)(Minecraft.getMinecraft()).player);
      BlockPos blockpos1 = generator.getRenderChunk().getPosition();
      int i = 16;
      int j = 8;
      int k = 24;
      if (blockpos1.add(8, 8, 8).distanceSq((Vec3i)blockpos) > 576.0D) {
    ...
    if (entity1 == null) {
      ...
      if (chunkcompiletaskgenerator$type == ChunkCompileTaskGenerator.Type.REBUILD_CHUNK) {
        ...
        for (i = (arrayOfBlockRenderLayer = BlockRenderLayer.values()).length, b = 0; b < i; ) {
          BlockRenderLayer blockrenderlayer = arrayOfBlockRenderLayer[b];
