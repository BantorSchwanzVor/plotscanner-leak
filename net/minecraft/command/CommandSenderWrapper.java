...
public class CommandSenderWrapper implements ICommandSender {
  ...
  public CommandSenderWrapper func_193999_a(int p_193999_1_) {
    return (this.field_194004_d != null && this.field_194004_d.intValue() <= p_193999_1_) ? this : new CommandSenderWrapper(this.field_193043_a, this.field_194002_b, this.field_194003_c, Integer.valueOf(p_193999_1_), this.field_194005_e, this.field_194006_f);
  }
  
  public CommandSenderWrapper func_194001_a(boolean p_194001_1_) {
    return (this.field_194006_f == null || (this.field_194006_f.booleanValue() && !p_194001_1_)) ? new CommandSenderWrapper(this.field_193043_a, this.field_194002_b, this.field_194003_c, this.field_194004_d, this.field_194005_e, Boolean.valueOf(p_194001_1_)) : this;
  }
  
  public CommandSenderWrapper func_194000_i() {
    return (this.field_194002_b != null) ? this : new CommandSenderWrapper(this.field_193043_a, getPositionVector(), getPosition(), this.field_194004_d, this.field_194005_e, this.field_194006_f);
  }
