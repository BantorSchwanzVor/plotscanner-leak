...
public class CommandTeleport extends CommandBase {
  ...
  public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
    ...
    if (entity.world != null) {
      ...
      CommandBase.CoordinateArg commandbase$coordinatearg3 = parseCoordinate((args.length > j) ? entity1.rotationYaw : entity.rotationYaw, (args.length > j) ? args[j] : "~", false);
      j++;
      CommandBase.CoordinateArg commandbase$coordinatearg4 = parseCoordinate((args.length > j) ? entity1.rotationPitch : entity.rotationPitch, (args.length > j) ? args[j] : "~", false);
      ...
      notifyCommandListener(sender, (ICommand)this, "commands.teleport.success.coordinates", new Object[] { entity.getName(), Double.valueOf(commandbase$coordinatearg.getResult()), Double.valueOf(commandbase$coordinatearg1.getResult()), Double.valueOf(commandbase$coordinatearg2.getResult()) });
    } 
  }
