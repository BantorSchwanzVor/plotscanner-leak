...
public class CommandScoreboard extends CommandBase {
  ...
  private boolean handleUserWildcards(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
    ...
    for (String s1 : list1) {
      ...
      try {
        ...
        sender.addChatMessage((ITextComponent)textcomponenttranslation);
      } 
    } 
    args[i] = s;
  ...
  protected void addObjective(ICommandSender sender, String[] commandArgs, int argStartIndex, MinecraftServer server) throws CommandException {
    ...
    notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.objectives.add.success", new Object[] { s });
  }
  ...
  protected void addTeam(ICommandSender sender, String[] p_184910_2_, int p_184910_3_, MinecraftServer server) throws CommandException {
    ...
    notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.teams.add.success", new Object[] { s });
  }
  ...
  protected void setTeamOption(ICommandSender sender, String[] p_184923_2_, int p_184923_3_, MinecraftServer server) throws CommandException {
    ...
    if (scoreplayerteam != null) {
      ...
      notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.teams.option.success", new Object[] { s, scoreplayerteam.getRegisteredName(), s1 });
    } 
  }
  ...
  protected void removeTeam(ICommandSender sender, String[] p_184921_2_, int p_184921_3_, MinecraftServer server) throws CommandException {
    ...
    if (scoreplayerteam != null) {
      ...
      notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.teams.remove.success", new Object[] { scoreplayerteam.getRegisteredName() });
    } 
  }
  ...
  protected void listTeams(ICommandSender sender, String[] p_184922_2_, int p_184922_3_, MinecraftServer server) throws CommandException {
    ...
    if (p_184922_2_.length > p_184922_3_) {
      ...
      sender.addChatMessage((ITextComponent)textcomponenttranslation);
      sender.addChatMessage((ITextComponent)new TextComponentString(joinNiceString(collection.toArray())));
    } else {
      ...
      for (ScorePlayerTeam scoreplayerteam1 : collection1) {
        sender.addChatMessage((ITextComponent)new TextComponentTranslation("commands.scoreboard.teams.list.entry", new Object[] { scoreplayerteam1.getRegisteredName(), scoreplayerteam1.getTeamName(), Integer.valueOf(scoreplayerteam1.getMembershipCollection().size()) }));
      } 
    } 
  }
  ...
  protected void joinTeam(ICommandSender sender, String[] p_184916_2_, int p_184916_3_, MinecraftServer server) throws CommandException {
    ...
    if (sender instanceof net.minecraft.entity.player.EntityPlayer && p_184916_3_ == p_184916_2_.length) {
    ...
    if (!set.isEmpty()) {
      ...
      notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.teams.join.success", new Object[] { Integer.valueOf(set.size()), s, joinNiceString(set.toArray((Object[])new String[set.size()])) });
    } 
    if (!set1.isEmpty())
  ...
  protected void leaveTeam(ICommandSender sender, String[] p_184911_2_, int p_184911_3_, MinecraftServer server) throws CommandException {
    ...
    Set<String> set = Sets.newHashSet();
    Set<String> set1 = Sets.newHashSet();
    if (sender instanceof net.minecraft.entity.player.EntityPlayer && p_184911_3_ == p_184911_2_.length) {
    ...
    if (!set.isEmpty()) {
      sender.setCommandStat(CommandResultStats.Type.AFFECTED_ENTITIES, set.size());
      notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.teams.leave.success", new Object[] { Integer.valueOf(set.size()), joinNiceString(set.toArray((Object[])new String[set.size()])) });
    } 
    if (!set1.isEmpty())
  ...
  protected void emptyTeam(ICommandSender sender, String[] p_184917_2_, int p_184917_3_, MinecraftServer server) throws CommandException {
    ...
    if (scoreplayerteam != null) {
      ...
      notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.teams.empty.success", new Object[] { Integer.valueOf(collection.size()), scoreplayerteam.getRegisteredName() });
    } 
  }
  ...
  protected void removeObjective(ICommandSender sender, String name, MinecraftServer server) throws CommandException {
    ...
    notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.objectives.remove.success", new Object[] { name });
  }
  ...
  protected void listObjectives(ICommandSender sender, MinecraftServer server) throws CommandException {
    ...
    for (ScoreObjective scoreobjective : collection) {
      sender.addChatMessage((ITextComponent)new TextComponentTranslation("commands.scoreboard.objectives.list.entry", new Object[] { scoreobjective.getName(), scoreobjective.getDisplayName(), scoreobjective.getCriteria().getName() }));
    } 
  }
  ...
  protected void setDisplayObjective(ICommandSender sender, String[] p_184919_2_, int p_184919_3_, MinecraftServer server) throws CommandException {
    ...
    if (scoreobjective != null) {
      notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.objectives.setdisplay.successSet", new Object[] { Scoreboard.getObjectiveDisplaySlot(i), scoreobjective.getName() });
    } else {
      notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.objectives.setdisplay.successCleared", new Object[] { Scoreboard.getObjectiveDisplaySlot(i) });
    } 
  }
  ...
  protected void listPlayers(ICommandSender sender, String[] p_184920_2_, int p_184920_3_, MinecraftServer server) throws CommandException {
    ...
    if (p_184920_2_.length > p_184920_3_) {
      ...
      for (Score score : map.values()) {
        sender.addChatMessage((ITextComponent)new TextComponentTranslation("commands.scoreboard.players.list.player.entry", new Object[] { Integer.valueOf(score.getScorePoints()), score.getObjective().getDisplayName(), score.getObjective().getName() }));
      } 
    } else {
  ...
  protected void addPlayerScore(ICommandSender sender, String[] p_184918_2_, int p_184918_3_, MinecraftServer server) throws CommandException {
    ...
    notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.players.set.success", new Object[] { scoreobjective.getName(), s1, Integer.valueOf(score.getScorePoints()) });
  }
  ...
  protected void resetPlayerScore(ICommandSender sender, String[] p_184912_2_, int p_184912_3_, MinecraftServer server) throws CommandException {
    ...
    if (p_184912_2_.length > p_184912_3_) {
      ...
      notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.players.resetscore.success", new Object[] { scoreobjective.getName(), s });
    } else {
      scoreboard.removeObjectiveFromEntity(s, null);
      notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.players.reset.success", new Object[] { s });
    } 
  }
  ...
  protected void enablePlayerTrigger(ICommandSender sender, String[] p_184914_2_, int p_184914_3_, MinecraftServer server) throws CommandException {
    ...
    notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.players.enable.success", new Object[] { scoreobjective.getName(), s });
  }
  ...
  protected void testPlayerScore(ICommandSender sender, String[] p_184907_2_, int p_184907_3_, MinecraftServer server) throws CommandException {
    ...
    if (score.getScorePoints() >= i && score.getScorePoints() <= j) {
      notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.players.test.success", new Object[] { Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j) });
    } else {
  ...
  protected void applyPlayerOperation(ICommandSender sender, String[] p_184906_2_, int p_184906_3_, MinecraftServer server) throws CommandException {
    ...
    notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.players.operation.success", new Object[0]);
  }
  ...
  protected void applyPlayerTag(MinecraftServer server, ICommandSender sender, String[] p_184924_3_, int p_184924_4_) throws CommandException {
    ...
    if ("list".equals(s1)) {
      if (!set.isEmpty()) {
        ...
        textcomponenttranslation.getStyle().setColor(TextFormatting.DARK_GREEN);
        sender.addChatMessage((ITextComponent)textcomponenttranslation);
        sender.addChatMessage((ITextComponent)new TextComponentString(joinNiceString(set.toArray())));
      } 
      ...
      if ("add".equals(s1)) {
        ...
        notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.players.tag.success.add", new Object[] { s2 });
      } else {
        if (!"remove".equals(s1))
          throw new WrongUsageException("commands.scoreboard.players.tag.usage", new Object[0]); 
        if (!entity.removeTag(s2))
          throw new CommandException("commands.scoreboard.players.tag.notFound", new Object[] { s2 }); 
        notifyCommandListener(sender, (ICommand)this, "commands.scoreboard.players.tag.success.remove", new Object[] { s2 });
      } 
    } 
  }
