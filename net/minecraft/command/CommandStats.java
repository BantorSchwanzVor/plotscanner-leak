  ...
  public List<String> getTabCompletionOptions(MinecraftServer server, ICommandSender sender, String[] args, @Nullable BlockPos pos) {
    ...
    if ((args.length != 3 || !"entity".equals(args[0])) && (args.length != 5 || !"block".equals(args[0]))) {
      if ((args.length != 4 || !"entity".equals(args[0])) && (args.length != 6 || !"block".equals(args[0])))
        return ((args.length != 6 || !"entity".equals(args[0])) && (args.length != 8 || !"block".equals(args[0]))) ? Collections.<String>emptyList() : getListOfStringsMatchingLastWord(args, getObjectiveNames(server)); 
