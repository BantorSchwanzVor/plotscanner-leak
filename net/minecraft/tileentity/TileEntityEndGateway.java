...
public class TileEntityEndGateway extends TileEntityEndPortal implements ITickable {
  ...
  public NBTTagCompound writeToNBT(NBTTagCompound compound) {
    ...
    if (this.exitPortal != null)
      compound.setTag("ExitPortal", (NBTBase)NBTUtil.createPosTag(this.exitPortal)); 
  ...
  public void update() {
    ...
    if (flag1) {
      ...
      List<Entity> list = this.world.getEntitiesWithinAABB(Entity.class, new AxisAlignedBB(getPos()));
      if (!list.isEmpty())
  ...
  public SPacketUpdateTileEntity getUpdatePacket() {
    return new SPacketUpdateTileEntity(this.pos, 8, getUpdateTag());
  }
  ...
  public void triggerCooldown() {
    if (!this.world.isRemote) {
      ...
      this.world.addBlockEvent(getPos(), getBlockType(), 1, 0);
      markDirty();
    } 
  }
  ...
  public void teleportEntity(Entity entityIn) {
    if (!this.world.isRemote && !isCoolingDown()) {
      this.teleportCooldown = 100;
      if (this.exitPortal == null && this.world.provider instanceof net.minecraft.world.WorldProviderEnd)
        findExitPortal(); 
      if (this.exitPortal != null) {
        BlockPos blockpos = this.exactTeleport ? this.exitPortal : findExitPosition();
  ...
  private void createExitPortal(BlockPos posIn) {
    ...
    if (tileentity instanceof TileEntityEndGateway) {
      ...
      tileentityendgateway.exitPortal = new BlockPos((Vec3i)getPos());
  ...
  public boolean shouldRenderFace(EnumFacing p_184313_1_) {
    return getBlockType().getDefaultState().shouldSideBeRendered((IBlockAccess)this.world, getPos(), p_184313_1_);
  }
