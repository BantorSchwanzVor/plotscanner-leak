...
public class TileEntityShulkerBox extends TileEntityLockableLoot implements ITickable, ISidedInventory {
  ...
  public AxisAlignedBB func_190584_a(IBlockState p_190584_1_) {
    return func_190587_b((EnumFacing)p_190584_1_.getValue((IProperty)BlockShulkerBox.field_190957_a));
  }
  
  public AxisAlignedBB func_190587_b(EnumFacing p_190587_1_) {
    return Block.FULL_BLOCK_AABB.addCoord((0.5F * func_190585_a(1.0F) * p_190587_1_.getFrontOffsetX()), (0.5F * func_190585_a(1.0F) * p_190587_1_.getFrontOffsetY()), (0.5F * func_190585_a(1.0F) * p_190587_1_.getFrontOffsetZ()));
  }
  ...
  private void func_190589_G() {
    ...
    if (iblockstate.getBlock() instanceof BlockShulkerBox) {
      EnumFacing enumfacing = (EnumFacing)iblockstate.getValue((IProperty)BlockShulkerBox.field_190957_a);
      AxisAlignedBB axisalignedbb = func_190588_c(enumfacing).offset(this.pos);
  ...
  public void openInventory(EntityPlayer player) {
    if (!player.isSpectator()) {
      ...
      this.field_190598_h++;
      this.world.addBlockEvent(this.pos, getBlockType(), 1, this.field_190598_h);
  ...
  public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
    return (Container)new ContainerShulkerBox(playerInventory, (IInventory)this, playerIn);
  }
  ...
  public String getName() {
    return hasCustomName() ? this.field_190577_o : "container.shulkerBox";
  }
  
  public static void func_190593_a(DataFixer p_190593_0_) {
    p_190593_0_.registerWalker(FixTypes.BLOCK_ENTITY, (IDataWalker)new ItemStackDataLists(TileEntityShulkerBox.class, new String[] { "Items" }));
  }
  ...
  public void func_190586_e(NBTTagCompound p_190586_1_) {
    this.field_190596_f = NonNullList.func_191197_a(getSizeInventory(), ItemStack.field_190927_a);
  ...
  public EnumDyeColor func_190592_s() {
    if (this.field_190602_l == null)
      this.field_190602_l = BlockShulkerBox.func_190954_c(getBlockType()); 
    return this.field_190602_l;
  }
  
  @Nullable
  public SPacketUpdateTileEntity getUpdatePacket() {
    return new SPacketUpdateTileEntity(this.pos, 10, getUpdateTag());
  }
  ...
  public boolean func_190582_F() {
    return !(func_190581_E() && func_191420_l() && !hasCustomName() && this.lootTable == null);
  }
