...
public class BlockPistonExtension extends BlockDirectional {
  ...
  private AxisAlignedBB getArmShape(IBlockState state) {
    boolean flag = ((Boolean)state.getValue((IProperty)SHORT)).booleanValue();
    switch ((EnumFacing)state.getValue((IProperty)FACING)) {
      default:
  ...
  public boolean isFullyOpaque(IBlockState state) {
    return (state.getValue((IProperty)FACING) == EnumFacing.UP);
  }
  ...
  public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
    return new ItemStack((state.getValue((IProperty)TYPE) == EnumPistonType.STICKY) ? Blocks.STICKY_PISTON : Blocks.PISTON);
  }
  ...
  protected BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, new IProperty[] { (IProperty)FACING, (IProperty)TYPE, (IProperty)SHORT });
  }
  
  public BlockFaceShape func_193383_a(IBlockAccess p_193383_1_, IBlockState p_193383_2_, BlockPos p_193383_3_, EnumFacing p_193383_4_) {
    return (p_193383_4_ == p_193383_2_.getValue((IProperty)FACING)) ? BlockFaceShape.SOLID : BlockFaceShape.UNDEFINED;
  }
