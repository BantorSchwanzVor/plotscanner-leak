...
public class BlockRedstoneWire extends Block {
  ...
  private static int getAABBIndex(IBlockState state) {
    int i = 0;
    boolean flag = (state.getValue((IProperty)NORTH) != EnumAttachPosition.NONE);
    boolean flag1 = (state.getValue((IProperty)EAST) != EnumAttachPosition.NONE);
    boolean flag2 = (state.getValue((IProperty)SOUTH) != EnumAttachPosition.NONE);
    boolean flag3 = (state.getValue((IProperty)WEST) != EnumAttachPosition.NONE);
  ...
  public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side) {
    if (!this.canProvidePower)
      return 0; 
    int i = ((Integer)blockState.getValue((IProperty)POWER)).intValue();
    if (i == 0)
      return 0; 
  ...
  private boolean isPowerSourceAt(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
    ...
    if (!flag1 && flag && canConnectUpwardsTo(worldIn, blockpos.up()))
      return true; 
    if (canConnectTo(iblockstate, side))
      return true; 
    if (iblockstate.getBlock() == Blocks.POWERED_REPEATER && iblockstate.getValue((IProperty)BlockRedstoneDiode.FACING) == side)
      return true; 
  ...
  protected static boolean canConnectTo(IBlockState blockState, @Nullable EnumFacing side) {
    ...
    if (Blocks.field_190976_dk == blockState.getBlock())
      return (side == blockState.getValue((IProperty)BlockObserver.FACING)); 
  ...
  public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
    int i = ((Integer)stateIn.getValue((IProperty)POWER)).intValue();
    if (i != 0) {
  ...
  protected BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, new IProperty[] { (IProperty)NORTH, (IProperty)EAST, (IProperty)SOUTH, (IProperty)WEST, (IProperty)POWER });
  }
