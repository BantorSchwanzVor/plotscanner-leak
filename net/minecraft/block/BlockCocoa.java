...
public class BlockCocoa extends BlockHorizontal implements IGrowable {
  ...
  public boolean canBlockStay(World worldIn, BlockPos pos, IBlockState state) {
    ...
    return (iblockstate.getBlock() == Blocks.LOG && iblockstate.getValue((IProperty)BlockOldLog.VARIANT) == BlockPlanks.EnumType.JUNGLE);
  }
  ...
  protected BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, new IProperty[] { (IProperty)FACING, (IProperty)AGE });
  }
