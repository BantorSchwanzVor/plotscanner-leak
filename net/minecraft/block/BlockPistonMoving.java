...
public class BlockPistonMoving extends BlockContainer {
  ...
  public static TileEntity createTilePiston(IBlockState blockStateIn, EnumFacing facingIn, boolean extendingIn, boolean shouldHeadBeRenderedIn) {
    return (TileEntity)new TileEntityPiston(blockStateIn, facingIn, extendingIn, shouldHeadBeRenderedIn);
  }
  ...
  public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune) {
    if (!worldIn.isRemote) {
      TileEntityPiston tileentitypiston = getTilePistonAt((IBlockAccess)worldIn, pos);
  ...
  protected BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, new IProperty[] { (IProperty)FACING, (IProperty)TYPE });
  }
