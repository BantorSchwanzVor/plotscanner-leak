...
public abstract class BlockStoneSlabNew extends BlockSlab {
  ...
  public String getLocalizedName() {
    return I18n.translateToLocal(String.valueOf(getUnlocalizedName()) + ".red_sandstone.name");
  }
  ...
  public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
    return new ItemStack(Blocks.STONE_SLAB2, 1, ((EnumType)state.getValue((IProperty)VARIANT)).getMetadata());
  }
