...
public class Block {
  ...
  public AxisAlignedBB getSelectedBoundingBox(IBlockState state, World worldIn, BlockPos pos) {
    return state.getBoundingBox((IBlockAccess)worldIn, pos).offset(pos);
  }
  
  @Deprecated
  public void addCollisionBoxToList(IBlockState state, World worldIn, BlockPos pos, AxisAlignedBB entityBox, List<AxisAlignedBB> collidingBoxes, @Nullable Entity entityIn, boolean p_185477_7_) {
    addCollisionBoxToList(pos, entityBox, collidingBoxes, state.getCollisionBoundingBox((IBlockAccess)worldIn, pos));
  }
  ...
  public RayTraceResult collisionRayTrace(IBlockState blockState, World worldIn, BlockPos pos, Vec3d start, Vec3d end) {
    return rayTrace(pos, start, end, blockState.getBoundingBox((IBlockAccess)worldIn, pos));
  }
  ...
  public String getLocalizedName() {
    return I18n.translateToLocal(String.valueOf(getUnlocalizedName()) + ".name");
  }
  ...
  public Vec3d func_190949_e(IBlockState p_190949_1_, IBlockAccess p_190949_2_, BlockPos p_190949_3_) {
    ...
    return new Vec3d((((float)(i >> 16L & 0xFL) / 15.0F) - 0.5D) * 0.5D, (block$enumoffsettype == EnumOffsetType.XYZ) ? ((((float)(i >> 20L & 0xFL) / 15.0F) - 1.0D) * 0.2D) : 0.0D, (((float)(i >> 24L & 0xFL) / 15.0F) - 0.5D) * 0.5D);
  }
  ...
  public static void registerBlocks() {
    ...
    Set<Block> set = Sets.newHashSet((Object[])new Block[] { (Block)REGISTRY.getObject(new ResourceLocation("tripwire")) });
    for (Block block16 : REGISTRY) {
      System.out.println(block16);
