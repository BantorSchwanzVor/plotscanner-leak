...
public class BlockChorusFlower extends Block {
  ...
  private void placeGrownFlower(World p_185602_1_, BlockPos p_185602_2_, int p_185602_3_) {
    p_185602_1_.setBlockState(p_185602_2_, getDefaultState().withProperty((IProperty)AGE, Integer.valueOf(p_185602_3_)), 2);
    p_185602_1_.playEvent(1033, p_185602_2_, 0);
  }
  
  private void placeDeadFlower(World p_185605_1_, BlockPos p_185605_2_) {
    p_185605_1_.setBlockState(p_185605_2_, getDefaultState().withProperty((IProperty)AGE, Integer.valueOf(5)), 2);
  ...
  private static void growTreeRecursive(World worldIn, BlockPos p_185601_1_, Random rand, BlockPos p_185601_3_, int p_185601_4_, int p_185601_5_) {
    ...
    if (!flag)
      worldIn.setBlockState(p_185601_1_.up(i), Blocks.CHORUS_FLOWER.getDefaultState().withProperty((IProperty)AGE, Integer.valueOf(5)), 2); 
  }
