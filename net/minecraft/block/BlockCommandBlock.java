...
public class BlockCommandBlock extends BlockContainer {
  ...
  public BlockCommandBlock(MapColor color) {
    ...
    setDefaultState(this.blockState.getBaseState().withProperty((IProperty)FACING, (Comparable)EnumFacing.NORTH).withProperty((IProperty)CONDITIONAL, Boolean.valueOf(false)));
  }
  ...
  public TileEntity createNewTileEntity(World worldIn, int meta) {
    ...
    return (TileEntity)tileentitycommandblock;
  }
  ...
  private void func_193387_a(IBlockState p_193387_1_, World p_193387_2_, BlockPos p_193387_3_, CommandBlockBaseLogic p_193387_4_, boolean p_193387_5_) {
    ...
    func_193386_c(p_193387_2_, p_193387_3_, (EnumFacing)p_193387_1_.getValue((IProperty)FACING));
  }
  ...
  public IBlockState getStateFromMeta(int meta) {
    return getDefaultState().withProperty((IProperty)FACING, (Comparable)EnumFacing.getFront(meta & 0x7)).withProperty((IProperty)CONDITIONAL, Boolean.valueOf(((meta & 0x8) != 0)));
  }
  
  public int getMetaFromState(IBlockState state) {
    return ((EnumFacing)state.getValue((IProperty)FACING)).getIndex() | (((Boolean)state.getValue((IProperty)CONDITIONAL)).booleanValue() ? 8 : 0);
  }
  ...
  protected BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, new IProperty[] { (IProperty)FACING, (IProperty)CONDITIONAL });
  }
  
  public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
    return getDefaultState().withProperty((IProperty)FACING, (Comparable)EnumFacing.func_190914_a(pos, placer)).withProperty((IProperty)CONDITIONAL, Boolean.valueOf(false));
  }
  ...
  private static void func_193386_c(World p_193386_0_, BlockPos p_193386_1_, EnumFacing p_193386_2_) {
    ...
    int i;
    for (i = gamerules.getInt("maxCommandChainLength"); i-- > 0; p_193386_2_ = (EnumFacing)iblockstate.getValue((IProperty)FACING)) {
      blockpos$mutableblockpos.move(p_193386_2_);
      IBlockState iblockstate = p_193386_0_.getBlockState((BlockPos)blockpos$mutableblockpos);
      Block block = iblockstate.getBlock();
      if (block != Blocks.CHAIN_COMMAND_BLOCK)
        break; 
      TileEntity tileentity = p_193386_0_.getTileEntity((BlockPos)blockpos$mutableblockpos);
      if (!(tileentity instanceof TileEntityCommandBlock))
        break; 
      TileEntityCommandBlock tileentitycommandblock = (TileEntityCommandBlock)tileentity;
      if (tileentitycommandblock.getMode() != TileEntityCommandBlock.Mode.SEQUENCE)
      ...
      if (tileentitycommandblock.isPowered() || tileentitycommandblock.isAuto()) {
        ...
        if (tileentitycommandblock.setConditionMet()) {
          if (!commandblockbaselogic.trigger(p_193386_0_))
            break; 
          p_193386_0_.updateComparatorOutputLevel((BlockPos)blockpos$mutableblockpos, block);
        } else if (tileentitycommandblock.isConditional()) {
          commandblockbaselogic.setSuccessCount(0);
        } 
      } 
