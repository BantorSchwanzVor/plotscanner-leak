...
public class BlockStateContainer {
  ...
  public BlockStateContainer(Block blockIn, IProperty... properties) {
    this(blockIn, (IProperty<?>[])properties, null);
  }
  ...
  protected StateImplementation createState(Block p_createState_1_, ImmutableMap<IProperty<?>, Comparable<?>> p_createState_2_, @Nullable ImmutableMap<IUnlistedProperty<?>, Optional<?>> p_createState_3_) {
    return new StateImplementation(p_createState_1_, p_createState_2_, null);
  }
  ...
  protected BlockStateContainer(Block p_i9_1_, IProperty[] p_i9_2_, ImmutableMap<IUnlistedProperty<?>, Optional<?>> p_i9_3_) {
    ...
    for (i = (arrayOfIProperty = p_i9_2_).length, b = 0; b < i; ) {
      IProperty<?> iproperty = arrayOfIProperty[b];
    ...
    for (List<Comparable<?>> list1 : (Iterable<List<Comparable<?>>>)Cartesian.cartesianProduct(getAllowedValues())) {
      Map<IProperty<?>, Comparable<?>> map1 = MapPopulator.createMap((Iterable)this.properties.values(), list1);
      StateImplementation blockstatecontainer$stateimplementation = createState(p_i9_1_, ImmutableMap.copyOf(map1), p_i9_3_);
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this).add("block", Block.REGISTRY.getNameForObject(this.block)).add("properties", Iterables.transform((Iterable)this.properties.values(), GET_NAME_FUNC)).toString();
  }
  ...
  public static class Builder {
    ...
    public Builder add(IProperty... p_add_1_) {
      ...
      int i;
      IProperty[] arrayOfIProperty;
      for (i = (arrayOfIProperty = p_add_1_).length, b = 0; b < i; ) {
        IProperty<?> iproperty = arrayOfIProperty[b];
    ...
    public Builder add(IUnlistedProperty... p_add_1_) {
      ...
      for (i = (arrayOfIUnlistedProperty = p_add_1_).length, b = 0; b < i; ) {
        IUnlistedProperty<?> iunlistedproperty = arrayOfIUnlistedProperty[b];
    ...
    public BlockStateContainer build() {
      ...
      iproperty = this.listed.<IProperty>toArray(iproperty);
      ...
      iunlistedproperty = this.unlisted.<IUnlistedProperty>toArray(iunlistedproperty);
  ...
  static class StateImplementation extends BlockStateBase {
    ...
    public void buildPropertyValueTable(Map<Map<IProperty<?>, Comparable<?>>, StateImplementation> map) {
      ...
      while (unmodifiableiterator.hasNext()) {
        ...
        for (Comparable<?> comparable : (Iterable<Comparable<?>>)iproperty.getAllowedValues()) {
    ...
    public AxisAlignedBB getBoundingBox(IBlockAccess blockAccess, BlockPos pos) {
      ...
      if (block$enumoffsettype != Block.EnumOffsetType.NONE && !(this.block instanceof net.minecraft.block.BlockFlower)) {
