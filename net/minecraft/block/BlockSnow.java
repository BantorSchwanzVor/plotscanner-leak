...
public class BlockSnow extends Block {
  ...
  public boolean isFullyOpaque(IBlockState state) {
    return (((Integer)state.getValue((IProperty)LAYERS)).intValue() == 8);
  }
  ...
  public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
    ...
    if (block != Blocks.ICE && block != Blocks.PACKED_ICE && block != Blocks.BARRIER) {
      BlockFaceShape blockfaceshape = iblockstate.func_193401_d((IBlockAccess)worldIn, pos.down(), EnumFacing.UP);
      return !(blockfaceshape != BlockFaceShape.SOLID && iblockstate.getMaterial() != Material.LEAVES && (block != this || ((Integer)iblockstate.getValue((IProperty)LAYERS)).intValue() != 8));
    } 
    return false;
  }
  ...
  public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side) {
    ...
    return (iblockstate.getBlock() == this && ((Integer)iblockstate.getValue((IProperty)LAYERS)).intValue() >= ((Integer)blockState.getValue((IProperty)LAYERS)).intValue()) ? false : super.shouldSideBeRendered(blockState, blockAccess, pos, side);
  }
