...
public class BlockJukebox extends BlockContainer {
  ...
  public static void registerFixesJukebox(DataFixer fixer) {
    fixer.registerWalker(FixTypes.BLOCK_ENTITY, (IDataWalker)new ItemStackData(TileEntityJukebox.class, new String[] { "RecordItem" }));
  }
  ...
  protected BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, new IProperty[] { (IProperty)HAS_RECORD });
  }
