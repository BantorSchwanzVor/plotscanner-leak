...
public abstract class WorldProvider {
  ...
  protected void createBiomeProvider() {
    ...
    if (worldtype == WorldType.FLAT) {
      ...
      this.biomeProvider = (BiomeProvider)new BiomeProviderSingle(Biome.getBiome(flatgeneratorinfo.getBiome(), Biomes.DEFAULT));
    } else if (worldtype == WorldType.DEBUG_WORLD) {
      this.biomeProvider = (BiomeProvider)new BiomeProviderSingle(Biomes.PLAINS);
    } else {
  ...
  public IChunkGenerator createChunkGenerator() {
    if (this.terrainType == WorldType.FLAT)
      return (IChunkGenerator)new ChunkGeneratorFlat(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), this.generatorSettings); 
    if (this.terrainType == WorldType.DEBUG_WORLD)
      return (IChunkGenerator)new ChunkGeneratorDebug(this.worldObj); 
    return (this.terrainType == WorldType.CUSTOMIZED) ? (IChunkGenerator)new ChunkGeneratorOverworld(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), this.generatorSettings) : (IChunkGenerator)new ChunkGeneratorOverworld(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), this.generatorSettings);
  }
