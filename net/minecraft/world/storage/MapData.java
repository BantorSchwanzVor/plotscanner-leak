...
public class MapData extends WorldSavedData {
  ...
  public static void func_191094_a(ItemStack p_191094_0_, BlockPos p_191094_1_, String p_191094_2_, MapDecoration.Type p_191094_3_) {
    ...
    if (p_191094_0_.hasTagCompound() && p_191094_0_.getTagCompound().hasKey("Decorations", 9)) {
      ...
      p_191094_0_.setTagInfo("Decorations", (NBTBase)nbttaglist);
    } 
  ...
  public class MapInfo {
    ...
    public Packet<?> getPacket(ItemStack stack) {
      if (this.isDirty) {
        this.isDirty = false;
        return (Packet<?>)new SPacketMaps(stack.getMetadata(), MapData.this.scale, MapData.this.trackingPosition, MapData.this.mapDecorations.values(), MapData.this.colors, this.minX, this.minY, this.maxX + 1 - this.minX, this.maxY + 1 - this.minY);
      } 
      return (this.tick++ % 5 == 0) ? (Packet<?>)new SPacketMaps(stack.getMetadata(), MapData.this.scale, MapData.this.trackingPosition, MapData.this.mapDecorations.values(), MapData.this.colors, 0, 0, 0, 0) : null;
    }
