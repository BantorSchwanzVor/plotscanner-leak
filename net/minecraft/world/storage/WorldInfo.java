...
public class WorldInfo {
    ...
    fixer.registerWalker(FixTypes.LEVEL, new IDataWalker() {
          public NBTTagCompound process(IDataFixer fixer, NBTTagCompound compound, int versionIn) {
            if (compound.hasKey("Player", 10))
              compound.setTag("Player", (NBTBase)fixer.process((IFixType)FixTypes.PLAYER, compound.getCompoundTag("Player"), versionIn)); 
            return compound;
          }
        });
  }
  ...
  private void updateTagCompound(NBTTagCompound nbt, NBTTagCompound playerNbt) {
    ...
    nbt.setTag("Version", (NBTBase)nbttagcompound);
    ...
    nbt.setTag("DimensionData", (NBTBase)nbttagcompound1);
    if (playerNbt != null)
