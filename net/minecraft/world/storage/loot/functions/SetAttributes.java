...
public class SetAttributes extends LootFunction {
  ...
  public ItemStack apply(ItemStack stack, Random rand, LootContext context) {
    ...
    for (i = (arrayOfModifier = this.modifiers).length, b = 0; b < i; ) {
      Modifier setattributes$modifier = arrayOfModifier[b];
  ...
  static class Modifier {
    ...
    public JsonObject serialize(JsonSerializationContext context) {
      ...
      if (this.slots.length == 1) {
        ...
        for (i = (arrayOfEntityEquipmentSlot = this.slots).length, b = 0; b < i; ) {
  ...
  public static class Serializer extends LootFunction.Serializer<SetAttributes> {
    ...
    public void serialize(JsonObject object, SetAttributes functionClazz, JsonSerializationContext serializationContext) {
      ...
      for (i = (arrayOfModifier = functionClazz.modifiers).length, b = 0; b < i; ) {
        SetAttributes.Modifier setattributes$modifier = arrayOfModifier[b];
