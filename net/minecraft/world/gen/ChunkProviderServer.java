...
public class ChunkProviderServer implements IChunkProvider {
  ...
  private final Long2ObjectMap<Chunk> id2ChunkMap = (Long2ObjectMap<Chunk>)new Long2ObjectOpenHashMap(8192);
  ...
  public boolean saveChunks(boolean p_186027_1_) {
    int i = 0;
    List<Chunk> list = Lists.newArrayList((Iterable)this.id2ChunkMap.values());
