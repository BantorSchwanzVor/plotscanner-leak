...
public class ComponentScatteredFeaturePieces {
  public static void registerScatteredFeaturePieces() {
    ...
    MapGenStructureIO.registerStructureComponent((Class)Igloo.class, "Iglu");
  }
  ...
  public static class DesertPyramid extends Feature {
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      IBlockState iblockstate1 = Blocks.SANDSTONE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.NORTH);
      IBlockState iblockstate2 = Blocks.SANDSTONE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.SOUTH);
      IBlockState iblockstate3 = Blocks.SANDSTONE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.EAST);
      IBlockState iblockstate = Blocks.SANDSTONE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.WEST);
      int l = (EnumDyeColor.ORANGE.getDyeDamage() ^ 0xFFFFFFFF) & 0xF;
      int i1 = (EnumDyeColor.BLUE.getDyeDamage() ^ 0xFFFFFFFF) & 0xF;
      ...
      setBlockState(worldIn, iblockstate1, this.scatteredFeatureSizeX - 3, 10, 0, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate2, this.scatteredFeatureSizeX - 3, 10, 4, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate3, this.scatteredFeatureSizeX - 5, 10, 2, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate, this.scatteredFeatureSizeX - 1, 10, 2, structureBoundingBoxIn);
      ...
      setBlockState(worldIn, iblockstate1, this.scatteredFeatureSizeX - 3, 4, 5, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate1, this.scatteredFeatureSizeX - 3, 3, 4, structureBoundingBoxIn);
      ...
      setBlockState(worldIn, Blocks.SANDSTONE.getDefaultState(), this.scatteredFeatureSizeX - 2, 1, 2, structureBoundingBoxIn);
      ...
      setBlockState(worldIn, iblockstate3, this.scatteredFeatureSizeX - 3, 1, 2, structureBoundingBoxIn);
      ...
      for (int j1 = 5; j1 <= 17; j1 += 2) {
        ...
        setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), this.scatteredFeatureSizeX - 5, 1, j1, structureBoundingBoxIn);
        setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), this.scatteredFeatureSizeX - 5, 2, j1, structureBoundingBoxIn);
      } 
      ...
      for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
        if (!this.hasPlacedChest[enumfacing.getHorizontalIndex()]) {
          ...
          this.hasPlacedChest[enumfacing.getHorizontalIndex()] = generateChest(worldIn, structureBoundingBoxIn, randomIn, 10 + k1, -11, 10 + l1, LootTableList.CHESTS_DESERT_PYRAMID);
        } 
      } 
      return true;
    }
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      if (randomIn.nextDouble() < 0.5D) {
        ...
        for (int j = 0; j < i; j++) {
          ...
          template1.addBlocksToWorldChunk(worldIn, blockpos.add((Vec3i)blockpos1), placementsettings);
        } 
        BlockPos blockpos4 = blockpos.add((Vec3i)template.calculateConnectedPos(placementsettings, new BlockPos(3, -1 - i * 3, 5), placementsettings, new BlockPos(3, 5, 7)));
        ...
        worldIn.setBlockState(blockpos.add((Vec3i)blockpos3), Blocks.SNOW.getDefaultState(), 3);
      } 
      return true;
    }
  }
  ...
  public static class JunglePyramid extends Feature {
    ...
    private static final Stones junglePyramidsRandomScatteredStones = new Stones(null);
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      IBlockState iblockstate2 = Blocks.STONE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.EAST);
      IBlockState iblockstate3 = Blocks.STONE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.WEST);
      ...
      IBlockState iblockstate1 = Blocks.STONE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.NORTH);
      ...
      setBlockState(worldIn, Blocks.TRIPWIRE_HOOK.getDefaultState().withProperty((IProperty)BlockTripWireHook.FACING, (Comparable)EnumFacing.EAST).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 1, -3, 8, structureBoundingBoxIn);
      setBlockState(worldIn, Blocks.TRIPWIRE_HOOK.getDefaultState().withProperty((IProperty)BlockTripWireHook.FACING, (Comparable)EnumFacing.WEST).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 4, -3, 8, structureBoundingBoxIn);
      ...
      if (!this.placedTrap1)
        this.placedTrap1 = createDispenser(worldIn, structureBoundingBoxIn, randomIn, 3, -2, 1, EnumFacing.NORTH, LootTableList.CHESTS_JUNGLE_TEMPLE_DISPENSER); 
      setBlockState(worldIn, Blocks.VINE.getDefaultState().withProperty((IProperty)BlockVine.SOUTH, Boolean.valueOf(true)), 3, -2, 2, structureBoundingBoxIn);
      setBlockState(worldIn, Blocks.TRIPWIRE_HOOK.getDefaultState().withProperty((IProperty)BlockTripWireHook.FACING, (Comparable)EnumFacing.NORTH).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 7, -3, 1, structureBoundingBoxIn);
      setBlockState(worldIn, Blocks.TRIPWIRE_HOOK.getDefaultState().withProperty((IProperty)BlockTripWireHook.FACING, (Comparable)EnumFacing.SOUTH).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 7, -3, 5, structureBoundingBoxIn);
      ...
      if (!this.placedTrap2)
        this.placedTrap2 = createDispenser(worldIn, structureBoundingBoxIn, randomIn, 9, -2, 3, EnumFacing.WEST, LootTableList.CHESTS_JUNGLE_TEMPLE_DISPENSER); 
      setBlockState(worldIn, Blocks.VINE.getDefaultState().withProperty((IProperty)BlockVine.EAST, Boolean.valueOf(true)), 8, -1, 3, structureBoundingBoxIn);
      setBlockState(worldIn, Blocks.VINE.getDefaultState().withProperty((IProperty)BlockVine.EAST, Boolean.valueOf(true)), 8, -2, 3, structureBoundingBoxIn);
      if (!this.placedMainChest)
        this.placedMainChest = generateChest(worldIn, structureBoundingBoxIn, randomIn, 8, -3, 3, LootTableList.CHESTS_JUNGLE_TEMPLE); 
      ...
      IBlockState iblockstate4 = Blocks.LEVER.getDefaultState().withProperty((IProperty)BlockLever.FACING, (Comparable)BlockLever.EnumOrientation.NORTH);
      ...
      setBlockState(worldIn, Blocks.STICKY_PISTON.getDefaultState().withProperty((IProperty)BlockPistonBase.FACING, (Comparable)EnumFacing.UP), 9, -2, 8, structureBoundingBoxIn);
      setBlockState(worldIn, Blocks.STICKY_PISTON.getDefaultState().withProperty((IProperty)BlockPistonBase.FACING, (Comparable)EnumFacing.WEST), 10, -2, 8, structureBoundingBoxIn);
      setBlockState(worldIn, Blocks.STICKY_PISTON.getDefaultState().withProperty((IProperty)BlockPistonBase.FACING, (Comparable)EnumFacing.WEST), 10, -1, 8, structureBoundingBoxIn);
      setBlockState(worldIn, Blocks.UNPOWERED_REPEATER.getDefaultState().withProperty((IProperty)BlockRedstoneRepeater.FACING, (Comparable)EnumFacing.NORTH), 10, -2, 10, structureBoundingBoxIn);
      if (!this.placedHiddenChest)
        this.placedHiddenChest = generateChest(worldIn, structureBoundingBoxIn, randomIn, 9, -3, 10, LootTableList.CHESTS_JUNGLE_TEMPLE); 
      return true;
    }
  ...
  public static class SwampHut extends Feature {
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      IBlockState iblockstate = Blocks.SPRUCE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.NORTH);
      IBlockState iblockstate1 = Blocks.SPRUCE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.EAST);
      IBlockState iblockstate2 = Blocks.SPRUCE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.WEST);
      IBlockState iblockstate3 = Blocks.SPRUCE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.SOUTH);
      ...
      if (!this.hasWitch) {
        ...
        if (structureBoundingBoxIn.isVecInside((Vec3i)new BlockPos(l, i1, k))) {
          this.hasWitch = true;
