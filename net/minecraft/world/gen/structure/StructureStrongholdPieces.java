...
public class StructureStrongholdPieces {
  ...
  private static final Stones STRONGHOLD_STONES = new Stones(null);
  ...
  public static void prepareStructurePieces() {
    ...
    for (i = (arrayOfPieceWeight = PIECE_WEIGHTS).length, b = 0; b < i; ) {
  ...
  public static class ChestCorridor extends Stronghold {
    ...
    public ChestCorridor(int p_i45582_1_, Random p_i45582_2_, StructureBoundingBox p_i45582_3_, EnumFacing p_i45582_4_) {
      ...
      this.entryDoor = getRandomDoor(p_i45582_2_);
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 1, 1, 0);
  ...
  public static class Crossing extends Stronghold {
    ...
    public Crossing(int p_i45580_1_, Random p_i45580_2_, StructureBoundingBox p_i45580_3_, EnumFacing p_i45580_4_) {
      ...
      this.entryDoor = getRandomDoor(p_i45580_2_);
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 4, 3, 0);
      if (this.leftLow)
      ...
      setBlockState(worldIn, Blocks.TORCH.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.SOUTH), 6, 5, 6, structureBoundingBoxIn);
      return true;
    }
  }
  ...
  public static class LeftTurn extends Stronghold {
    ...
    public LeftTurn(int p_i45579_1_, Random p_i45579_2_, StructureBoundingBox p_i45579_3_, EnumFacing p_i45579_4_) {
      ...
      this.entryDoor = getRandomDoor(p_i45579_2_);
  ...
  public static class Library extends Stronghold {
    ...
    public Library(int p_i45578_1_, Random p_i45578_2_, StructureBoundingBox p_i45578_3_, EnumFacing p_i45578_4_) {
      ...
      this.entryDoor = getRandomDoor(p_i45578_2_);
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 4, 1, 0);
      ...
      for (int l = 1; l <= 13; l++) {
        if ((l - 1) % 4 == 0) {
          ...
          setBlockState(worldIn, Blocks.TORCH.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.EAST), 2, 3, l, structureBoundingBoxIn);
          setBlockState(worldIn, Blocks.TORCH.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.WEST), 11, 3, l, structureBoundingBoxIn);
          if (this.isLargeRoom) {
      ...
      if (this.isLargeRoom) {
        ...
        IBlockState iblockstate1 = Blocks.LADDER.getDefaultState().withProperty((IProperty)BlockLadder.FACING, (Comparable)EnumFacing.SOUTH);
        ...
        IBlockState iblockstate = Blocks.TORCH.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.UP);
  ...
  public static class PortalRoom extends Stronghold {
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      IBlockState iblockstate3 = Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.NORTH);
      ...
      IBlockState iblockstate4 = Blocks.END_PORTAL_FRAME.getDefaultState().withProperty((IProperty)BlockEndPortalFrame.FACING, (Comparable)EnumFacing.NORTH);
      IBlockState iblockstate = Blocks.END_PORTAL_FRAME.getDefaultState().withProperty((IProperty)BlockEndPortalFrame.FACING, (Comparable)EnumFacing.SOUTH);
      IBlockState iblockstate1 = Blocks.END_PORTAL_FRAME.getDefaultState().withProperty((IProperty)BlockEndPortalFrame.FACING, (Comparable)EnumFacing.EAST);
      IBlockState iblockstate2 = Blocks.END_PORTAL_FRAME.getDefaultState().withProperty((IProperty)BlockEndPortalFrame.FACING, (Comparable)EnumFacing.WEST);
      boolean flag = true;
      ...
      setBlockState(worldIn, iblockstate4.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[0])), 4, 3, 8, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate4.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[1])), 5, 3, 8, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate4.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[2])), 6, 3, 8, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[3])), 4, 3, 12, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[4])), 5, 3, 12, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[5])), 6, 3, 12, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate1.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[6])), 3, 3, 9, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate1.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[7])), 3, 3, 10, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate1.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[8])), 3, 3, 11, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate2.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[9])), 7, 3, 9, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate2.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[10])), 7, 3, 10, structureBoundingBoxIn);
      setBlockState(worldIn, iblockstate2.withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[11])), 7, 3, 11, structureBoundingBoxIn);
      if (flag) {
  ...
  public static class Prison extends Stronghold {
    ...
    public Prison(int p_i45576_1_, Random p_i45576_2_, StructureBoundingBox p_i45576_3_, EnumFacing p_i45576_4_) {
      ...
      this.entryDoor = getRandomDoor(p_i45576_2_);
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      IBlockState iblockstate = Blocks.IRON_DOOR.getDefaultState().withProperty((IProperty)BlockDoor.FACING, (Comparable)EnumFacing.WEST);
      IBlockState iblockstate1 = Blocks.IRON_DOOR.getDefaultState().withProperty((IProperty)BlockDoor.FACING, (Comparable)EnumFacing.WEST).withProperty((IProperty)BlockDoor.HALF, (Comparable)BlockDoor.EnumDoorHalf.UPPER);
  ...
  public static class RoomCrossing extends Stronghold {
    ...
    public RoomCrossing(int p_i45575_1_, Random p_i45575_2_, StructureBoundingBox p_i45575_3_, EnumFacing p_i45575_4_) {
      ...
      this.entryDoor = getRandomDoor(p_i45575_2_);
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      switch (this.roomType) {
        case 0:
          ...
          setBlockState(worldIn, Blocks.TORCH.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.WEST), 4, 3, 5, structureBoundingBoxIn);
          setBlockState(worldIn, Blocks.TORCH.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.EAST), 6, 3, 5, structureBoundingBoxIn);
          setBlockState(worldIn, Blocks.TORCH.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.SOUTH), 5, 3, 4, structureBoundingBoxIn);
          setBlockState(worldIn, Blocks.TORCH.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.NORTH), 5, 3, 6, structureBoundingBoxIn);
        ...
        case 2:
          ...
          iblockstate = Blocks.LADDER.getDefaultState().withProperty((IProperty)BlockLadder.FACING, (Comparable)EnumFacing.WEST);
  ...
  public static class Stairs extends Stronghold {
    ...
    public Stairs(int p_i45574_1_, Random p_i45574_2_, StructureBoundingBox p_i45574_3_, EnumFacing p_i45574_4_) {
      ...
      this.entryDoor = getRandomDoor(p_i45574_2_);
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 1, 7, 0);
  ...
  public static class StairsStraight extends Stronghold {
    ...
    public StairsStraight(int p_i45572_1_, Random p_i45572_2_, StructureBoundingBox p_i45572_3_, EnumFacing p_i45572_4_) {
      ...
      this.entryDoor = getRandomDoor(p_i45572_2_);
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      IBlockState iblockstate = Blocks.STONE_STAIRS.getDefaultState().withProperty((IProperty)BlockStairs.FACING, (Comparable)EnumFacing.SOUTH);
      for (int i = 0; i < 6; i++) {
  ...
  public static class Straight extends Stronghold {
    ...
    public Straight(int p_i45573_1_, Random p_i45573_2_, StructureBoundingBox p_i45573_3_, EnumFacing p_i45573_4_) {
      ...
      this.entryDoor = getRandomDoor(p_i45573_2_);
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
      ...
      placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 1, 1, 0);
      placeDoor(worldIn, randomIn, structureBoundingBoxIn, StructureStrongholdPieces.Stronghold.Door.OPENING, 1, 1, 6);
      IBlockState iblockstate = Blocks.TORCH.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.EAST);
      IBlockState iblockstate1 = Blocks.TORCH.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.WEST);
  ...
  static abstract class Stronghold extends StructureComponent {
    ...
    protected void placeDoor(World worldIn, Random p_74990_2_, StructureBoundingBox p_74990_3_, Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_) {
      switch (p_74990_4_) {
        ...
        case WOOD_DOOR:
          ...
          setBlockState(worldIn, Blocks.OAK_DOOR.getDefaultState().withProperty((IProperty)BlockDoor.HALF, (Comparable)BlockDoor.EnumDoorHalf.UPPER), p_74990_5_ + 1, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
          break;
        case null:
        ...
        case IRON_DOOR:
          ...
          setBlockState(worldIn, Blocks.IRON_DOOR.getDefaultState().withProperty((IProperty)BlockDoor.HALF, (Comparable)BlockDoor.EnumDoorHalf.UPPER), p_74990_5_ + 1, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
          setBlockState(worldIn, Blocks.STONE_BUTTON.getDefaultState().withProperty((IProperty)BlockButton.FACING, (Comparable)EnumFacing.NORTH), p_74990_5_ + 2, p_74990_6_ + 1, p_74990_7_ + 1, p_74990_3_);
          setBlockState(worldIn, Blocks.STONE_BUTTON.getDefaultState().withProperty((IProperty)BlockButton.FACING, (Comparable)EnumFacing.SOUTH), p_74990_5_ + 2, p_74990_6_ + 1, p_74990_7_ - 1, p_74990_3_);
          break;
      } 
    }
    ...
    protected StructureComponent getNextComponentNormal(StructureStrongholdPieces.Stairs2 p_74986_1_, List<StructureComponent> p_74986_2_, Random p_74986_3_, int p_74986_4_, int p_74986_5_) {
      ...
      if (enumfacing != null)
        switch (enumfacing) {
          case NORTH:
            return StructureStrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX + p_74986_4_, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ - 1, enumfacing, getComponentType());
          case SOUTH:
            return StructureStrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX + p_74986_4_, this.boundingBox.minY + p_74986_5_, this.boundingBox.maxZ + 1, enumfacing, getComponentType());
          case WEST:
            return StructureStrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ + p_74986_4_, enumfacing, getComponentType());
          case EAST:
            return StructureStrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ + p_74986_4_, enumfacing, getComponentType());
        }  
      return null;
    }
    ...
    protected StructureComponent getNextComponentX(StructureStrongholdPieces.Stairs2 p_74989_1_, List<StructureComponent> p_74989_2_, Random p_74989_3_, int p_74989_4_, int p_74989_5_) {
      ...
      if (enumfacing != null)
        switch (enumfacing) {
          case NORTH:
            return StructureStrongholdPieces.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ + p_74989_5_, EnumFacing.WEST, getComponentType());
          case SOUTH:
            return StructureStrongholdPieces.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ + p_74989_5_, EnumFacing.WEST, getComponentType());
          case WEST:
            return StructureStrongholdPieces.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX + p_74989_5_, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, getComponentType());
          case EAST:
            return StructureStrongholdPieces.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX + p_74989_5_, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, getComponentType());
        }  
      return null;
    ...
    protected StructureComponent getNextComponentZ(StructureStrongholdPieces.Stairs2 p_74987_1_, List<StructureComponent> p_74987_2_, Random p_74987_3_, int p_74987_4_, int p_74987_5_) {
      ...
      if (enumfacing != null)
        switch (enumfacing) {
          case NORTH:
            return StructureStrongholdPieces.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74987_4_, this.boundingBox.minZ + p_74987_5_, EnumFacing.EAST, getComponentType());
          case SOUTH:
            return StructureStrongholdPieces.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74987_4_, this.boundingBox.minZ + p_74987_5_, EnumFacing.EAST, getComponentType());
          case WEST:
            return StructureStrongholdPieces.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.minX + p_74987_5_, this.boundingBox.minY + p_74987_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, getComponentType());
          case EAST:
            return StructureStrongholdPieces.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.minX + p_74987_5_, this.boundingBox.minY + p_74987_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, getComponentType());
        }  
      return null;
