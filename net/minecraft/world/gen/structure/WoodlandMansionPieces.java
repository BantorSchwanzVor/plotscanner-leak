...
public class WoodlandMansionPieces {
  public static void func_191153_a() {
    MapGenStructureIO.registerStructureComponent((Class)MansionTemplate.class, "WMP");
  }
  ...
  static class Grid {
    ...
    public Grid(Random p_i47362_1_) {
      ...
      func_191110_a(this.field_191118_b, this.field_191121_e, this.field_191122_f - 2, EnumFacing.WEST, 6);
      func_191110_a(this.field_191118_b, this.field_191121_e, this.field_191122_f + 3, EnumFacing.WEST, 6);
      func_191110_a(this.field_191118_b, this.field_191121_e - 2, this.field_191122_f - 1, EnumFacing.WEST, 3);
      func_191110_a(this.field_191118_b, this.field_191121_e - 2, this.field_191122_f + 2, EnumFacing.WEST, 3);
      do {
      
      } while (func_191111_a(this.field_191118_b));
      ...
      func_191116_a(this.field_191118_b, this.field_191120_d[0]);
      func_191116_a(this.field_191118_b, this.field_191120_d[1]);
      ...
      func_191115_b();
      func_191116_a(this.field_191119_c, this.field_191120_d[2]);
    }
    ...
    private void func_191115_b() {
      ...
      for (int i = 0; i < this.field_191119_c.field_191150_c; i++) {
        for (int j = 0; j < this.field_191119_c.field_191149_b; j++) {
          ...
          int l = k & 0xF0000;
          if (l == 131072 && (k & 0x200000) == 2097152)
      ...
      if (list.isEmpty()) {
        ...
        woodlandmansionpieces$simplegrid.func_191144_a(((Integer)tuple.getFirst()).intValue(), ((Integer)tuple.getSecond()).intValue(), l1 | 0x400000);
        EnumFacing enumfacing1 = func_191113_b(this.field_191118_b, ((Integer)tuple.getFirst()).intValue(), ((Integer)tuple.getSecond()).intValue(), 1, l1 & 0xFFFF);
        ...
        int j;
        EnumFacing[] arrayOfEnumFacing;
        for (j = (arrayOfEnumFacing = EnumFacing.Plane.HORIZONTAL.facings()).length, b = 0; b < j; ) {
          EnumFacing enumfacing = arrayOfEnumFacing[b];
        ...
        if (list1.isEmpty()) {
          ...
          func_191110_a(this.field_191119_c, i2 + enumfacing2.getFrontOffsetX(), i1 + enumfacing2.getFrontOffsetZ(), enumfacing2, 4);
          do {
          
          } while (func_191111_a(this.field_191119_c));
        } 
      } 
    }
    ...
    protected void handleDataMarker(String p_186175_1_, BlockPos p_186175_2_, World p_186175_3_, Random p_186175_4_, StructureBoundingBox p_186175_5_) {
      if (p_186175_1_.startsWith("Chest")) {
        ...
        if ("ChestWest".equals(p_186175_1_)) {
          iblockstate = iblockstate.withProperty((IProperty)BlockChest.FACING, (Comparable)rotation.rotate(EnumFacing.WEST));
        } else if ("ChestEast".equals(p_186175_1_)) {
          iblockstate = iblockstate.withProperty((IProperty)BlockChest.FACING, (Comparable)rotation.rotate(EnumFacing.EAST));
        } else if ("ChestSouth".equals(p_186175_1_)) {
          iblockstate = iblockstate.withProperty((IProperty)BlockChest.FACING, (Comparable)rotation.rotate(EnumFacing.SOUTH));
        } else if ("ChestNorth".equals(p_186175_1_)) {
          iblockstate = iblockstate.withProperty((IProperty)BlockChest.FACING, (Comparable)rotation.rotate(EnumFacing.NORTH));
        } 
        ...
        p_186175_3_.spawnEntityInWorld((Entity)entityevoker);
        ...
        entityvindicator.onInitialSpawn(p_186175_3_.getDifficultyForLocation(new BlockPos((Entity)entityvindicator)), null);
        p_186175_3_.spawnEntityInWorld((Entity)entityvindicator);
        p_186175_3_.setBlockState(p_186175_2_, Blocks.AIR.getDefaultState(), 2);
      } 
    }
  }
  ...
  static class Placer {
    ...
    public void func_191125_a(BlockPos p_191125_1_, Rotation p_191125_2_, List<WoodlandMansionPieces.MansionTemplate> p_191125_3_, WoodlandMansionPieces.Grid p_191125_4_) {
      WoodlandMansionPieces.PlacementData woodlandmansionpieces$placementdata = new WoodlandMansionPieces.PlacementData(null);
      ...
      WoodlandMansionPieces.PlacementData woodlandmansionpieces$placementdata1 = new WoodlandMansionPieces.PlacementData(null);
      ...
      func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata, woodlandmansionpieces$simplegrid, EnumFacing.SOUTH, this.field_191136_c, this.field_191137_d, i, j);
      func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata1, woodlandmansionpieces$simplegrid, EnumFacing.SOUTH, this.field_191136_c, this.field_191137_d, i, j);
      WoodlandMansionPieces.PlacementData woodlandmansionpieces$placementdata2 = new WoodlandMansionPieces.PlacementData(null);
      ...
      awoodlandmansionpieces$roomcollection[0] = new WoodlandMansionPieces.FirstFloor(null);
      awoodlandmansionpieces$roomcollection[1] = new WoodlandMansionPieces.SecondFloor(null);
      awoodlandmansionpieces$roomcollection[2] = new WoodlandMansionPieces.ThirdFloor(null);
        ...
        for (int i1 = 0; i1 < woodlandmansionpieces$simplegrid3.field_191150_c; i1++) {
          for (int j1 = 0; j1 < woodlandmansionpieces$simplegrid3.field_191149_b; j1++) {
            if (woodlandmansionpieces$simplegrid3.func_191145_a(j1, i1) == 1) {
              ...
              if (woodlandmansionpieces$simplegrid3.func_191145_a(j1, i1 - 1) == 1 || (woodlandmansionpieces$simplegrid2.func_191145_a(j1, i1 - 1) & 0x800000) == 8388608)
              ...
              if (woodlandmansionpieces$simplegrid3.func_191145_a(j1 + 1, i1) == 1 || (woodlandmansionpieces$simplegrid2.func_191145_a(j1 + 1, i1) & 0x800000) == 8388608)
        ...
        for (int k1 = 0; k1 < woodlandmansionpieces$simplegrid3.field_191150_c; k1++) {
          for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.field_191149_b; l1++) {
            ...
            if (woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1) == 2 || flag1) {
              ...
              int j2 = i2 & 0xF0000;
              int k2 = i2 & 0xFFFF;
              flag1 = (flag1 && (i2 & 0x800000) == 8388608);
              list.clear();
              if ((i2 & 0x200000) == 2097152) {
                byte b;
                int m;
                EnumFacing[] arrayOfEnumFacing;
                for (m = (arrayOfEnumFacing = EnumFacing.Plane.HORIZONTAL.facings()).length, b = 0; b < m; ) {
                  EnumFacing enumfacing = arrayOfEnumFacing[b];
              ...
              if (j2 == 65536) {
                ...
                boolean flag2 = ((i2 & 0x400000) == 4194304);
