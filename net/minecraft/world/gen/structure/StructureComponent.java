...
public abstract class StructureComponent {
  ...
  protected boolean isLiquidInStructureBoundingBox(World worldIn, StructureBoundingBox boundingboxIn) {
    ...
    for (int k1 = i; k1 <= l; k1++) {
      for (int l1 = k; l1 <= j1; l1++) {
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.setPos(k1, j, l1)).getMaterial().isLiquid())
          return true; 
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.setPos(k1, i1, l1)).getMaterial().isLiquid())
          return true; 
      } 
    } 
    for (int i2 = i; i2 <= l; i2++) {
      for (int k2 = j; k2 <= i1; k2++) {
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.setPos(i2, k2, k)).getMaterial().isLiquid())
          return true; 
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.setPos(i2, k2, j1)).getMaterial().isLiquid())
          return true; 
      } 
    } 
    for (int j2 = k; j2 <= j1; j2++) {
      for (int l2 = j; l2 <= i1; l2++) {
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.setPos(i, l2, j2)).getMaterial().isLiquid())
          return true; 
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.setPos(l, l2, j2)).getMaterial().isLiquid())
          return true; 
      } 
    } 
    return false;
  ...
  protected int getYWithOffset(int y) {
    return (getCoordBaseMode() == null) ? y : (y + this.boundingBox.minY);
  }
  ...
  protected int func_189916_b(World p_189916_1_, int p_189916_2_, int p_189916_3_, int p_189916_4_, StructureBoundingBox p_189916_5_) {
    ...
    BlockPos blockpos = new BlockPos(i, j, k);
    return !p_189916_5_.isVecInside((Vec3i)blockpos) ? EnumSkyBlock.SKY.defaultLightValue : p_189916_1_.getLightFor(EnumSkyBlock.SKY, blockpos);
  }
  ...
  protected boolean func_191080_a(World p_191080_1_, StructureBoundingBox p_191080_2_, Random p_191080_3_, BlockPos p_191080_4_, ResourceLocation p_191080_5_, @Nullable IBlockState p_191080_6_) {
    if (p_191080_2_.isVecInside((Vec3i)p_191080_4_) && p_191080_1_.getBlockState(p_191080_4_).getBlock() != Blocks.CHEST) {
      if (p_191080_6_ == null)
  ...
  protected boolean createDispenser(World p_189419_1_, StructureBoundingBox p_189419_2_, Random p_189419_3_, int p_189419_4_, int p_189419_5_, int p_189419_6_, EnumFacing p_189419_7_, ResourceLocation p_189419_8_) {
    ...
    if (p_189419_2_.isVecInside((Vec3i)blockpos) && p_189419_1_.getBlockState(blockpos).getBlock() != Blocks.DISPENSER) {
      setBlockState(p_189419_1_, Blocks.DISPENSER.getDefaultState().withProperty((IProperty)BlockDispenser.FACING, (Comparable)p_189419_7_), p_189419_4_, p_189419_5_, p_189419_6_, p_189419_2_);
  ...
  protected void func_189915_a(World p_189915_1_, StructureBoundingBox p_189915_2_, Random p_189915_3_, int p_189915_4_, int p_189915_5_, int p_189915_6_, EnumFacing p_189915_7_, BlockDoor p_189915_8_) {
    setBlockState(p_189915_1_, p_189915_8_.getDefaultState().withProperty((IProperty)BlockDoor.FACING, (Comparable)p_189915_7_), p_189915_4_, p_189915_5_, p_189915_6_, p_189915_2_);
    setBlockState(p_189915_1_, p_189915_8_.getDefaultState().withProperty((IProperty)BlockDoor.FACING, (Comparable)p_189915_7_).withProperty((IProperty)BlockDoor.HALF, (Comparable)BlockDoor.EnumDoorHalf.UPPER), p_189915_4_, p_189915_5_ + 1, p_189915_6_, p_189915_2_);
  }
