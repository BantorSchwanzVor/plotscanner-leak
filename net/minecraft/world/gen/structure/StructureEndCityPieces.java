...
public class StructureEndCityPieces {
  ...
  private static final List<Tuple<Rotation, BlockPos>> TOWER_BRIDGES = Lists.newArrayList((Object[])new Tuple[] { new Tuple(Rotation.NONE, new BlockPos(1, -1, 0)), new Tuple(Rotation.CLOCKWISE_90, new BlockPos(6, -1, 1)), new Tuple(Rotation.COUNTERCLOCKWISE_90, new BlockPos(0, -1, 5)), new Tuple(Rotation.CLOCKWISE_180, new BlockPos(5, -1, 6)) });
  ...
  private static final IGenerator TOWER_GENERATOR = new IGenerator() {
      ...
      public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPieces.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_) {
        ...
        if (structureendcitypieces$citytemplate1 != null) {
          for (Tuple<Rotation, BlockPos> tuple : (Iterable<Tuple<Rotation, BlockPos>>)StructureEndCityPieces.TOWER_BRIDGES) {
  ...
  private static final IGenerator FAT_TOWER_GENERATOR = new IGenerator() {
      ...
      public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPieces.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_) {
        ...
        for (int i = 0; i < 2 && p_191086_6_.nextInt(3) != 0; i++) {
          ...
          for (Tuple<Rotation, BlockPos> tuple : (Iterable<Tuple<Rotation, BlockPos>>)StructureEndCityPieces.FAT_TOWER_BRIDGES) {
            if (p_191086_6_.nextBoolean()) {
  ...
  public static void registerPieces() {
    MapGenStructureIO.registerStructureComponent((Class)CityTemplate.class, "ECP");
  }
  ...
  public static class CityTemplate extends StructureComponentTemplate {
    ...
    protected void handleDataMarker(String p_186175_1_, BlockPos p_186175_2_, World p_186175_3_, Random p_186175_4_, StructureBoundingBox p_186175_5_) {
      if (p_186175_1_.startsWith("Chest")) {
        ...
        if (p_186175_5_.isVecInside((Vec3i)blockpos)) {
        ...
        p_186175_3_.spawnEntityInWorld((Entity)entityshulker);
        ...
        p_186175_3_.spawnEntityInWorld((Entity)entityitemframe);
      } 
    }
  }
