...
public class ChunkGeneratorHell implements IChunkGenerator {
  ...
  private final WorldGenerator quartzGen = (WorldGenerator)new WorldGenMinable(Blocks.QUARTZ_ORE.getDefaultState(), 14, (Predicate)BlockMatcher.forBlock(Blocks.NETHERRACK));
  
  private final WorldGenerator magmaGen = (WorldGenerator)new WorldGenMinable(Blocks.MAGMA.getDefaultState(), 33, (Predicate)BlockMatcher.forBlock(Blocks.NETHERRACK));
  
  private final WorldGenHellLava lavaTrapGen = new WorldGenHellLava((Block)Blocks.FLOWING_LAVA, true);
  
  private final WorldGenHellLava hellSpringGen = new WorldGenHellLava((Block)Blocks.FLOWING_LAVA, false);
