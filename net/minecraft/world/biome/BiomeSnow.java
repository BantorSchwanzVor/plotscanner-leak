...
public class BiomeSnow extends Biome {
  ...
  public BiomeSnow(boolean superIcyIn, Biome.BiomeProperties properties) {
    ...
    this.spawnableCreatureList.add(new Biome.SpawnListEntry((Class)EntityRabbit.class, 10, 2, 3));
    this.spawnableCreatureList.add(new Biome.SpawnListEntry((Class)EntityPolarBear.class, 1, 1, 2));
    ...
    this.spawnableMonsterList.add(new Biome.SpawnListEntry((Class)EntitySkeleton.class, 20, 4, 4));
    this.spawnableMonsterList.add(new Biome.SpawnListEntry((Class)EntityStray.class, 80, 4, 4));
  }
