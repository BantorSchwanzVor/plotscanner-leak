...
public class BiomeEndDecorator extends BiomeDecorator {
  ...
  protected void genDecorations(Biome biomeIn, World worldIn, Random random) {
    ...
    for (i = (arrayOfEndSpike1 = aworldgenspikes$endspike).length, b = 0; b < i; ) {
      WorldGenSpikes.EndSpike worldgenspikes$endspike = arrayOfEndSpike1[b];
  ...
  static class SpikeCacheLoader extends CacheLoader<Long, WorldGenSpikes.EndSpike[]> {
    ...
    public WorldGenSpikes.EndSpike[] load(Long p_load_1_) throws Exception {
      List<Integer> list = Lists.newArrayList((Iterable)ContiguousSet.create(Range.closedOpen(Integer.valueOf(0), Integer.valueOf(10)), DiscreteDomain.integers()));
