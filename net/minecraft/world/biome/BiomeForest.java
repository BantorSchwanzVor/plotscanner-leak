...
public class BiomeForest extends Biome {
  ...
  public BiomeForest(Type typeIn, Biome.BiomeProperties properties) {
    ...
    if (this.type == Type.NORMAL)
      this.spawnableCreatureList.add(new Biome.SpawnListEntry((Class)EntityWolf.class, 5, 4, 4)); 
  ...
  public WorldGenAbstractTree genBigTreeChance(Random rand) {
    if (this.type == Type.ROOFED && rand.nextInt(3) > 0)
      return (WorldGenAbstractTree)ROOF_TREE; 
    ...
    return (WorldGenAbstractTree)BIRCH_TREE;
  }
  ...
  public Class<? extends Biome> getBiomeClass() {
    return (Class)BiomeForest.class;
  }
