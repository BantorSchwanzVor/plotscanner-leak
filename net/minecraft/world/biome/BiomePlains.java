...
public class BiomePlains extends Biome {
  ...
  protected BiomePlains(boolean p_i46699_1_, Biome.BiomeProperties properties) {
    ...
    this.spawnableCreatureList.add(new Biome.SpawnListEntry((Class)EntityHorse.class, 5, 2, 6));
    this.spawnableCreatureList.add(new Biome.SpawnListEntry((Class)EntityDonkey.class, 1, 1, 3));
  ...
  public WorldGenAbstractTree genBigTreeChance(Random rand) {
    return (rand.nextInt(3) == 0) ? (WorldGenAbstractTree)BIG_TREE_FEATURE : (WorldGenAbstractTree)TREE_FEATURE;
  }
}
