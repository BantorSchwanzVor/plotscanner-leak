...
public class BiomeHills extends Biome {
  ...
  protected BiomeHills(Type p_i46710_1_, Biome.BiomeProperties properties) {
    ...
    this.spawnableCreatureList.add(new Biome.SpawnListEntry((Class)EntityLlama.class, 5, 4, 6));
    this.type = p_i46710_1_;
  }
  
  public WorldGenAbstractTree genBigTreeChance(Random rand) {
    return (rand.nextInt(3) > 0) ? (WorldGenAbstractTree)this.spruceGenerator : super.genBigTreeChance(rand);
  }
