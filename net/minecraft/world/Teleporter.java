...
public class Teleporter {
  ...
  private final Long2ObjectMap<PortalPosition> destinationCoordinateCache = (Long2ObjectMap<PortalPosition>)new Long2ObjectOpenHashMap(4096);
  ...
  public boolean makePortal(Entity entityIn) {
    ...
    for (int j2 = j - 16; j2 <= j + 16; j2++) {
      ...
      for (int l2 = l - 16; l2 <= l + 16; l2++) {
        ...
        for (int j3 = this.worldServerInstance.getActualHeight() - 1; j3 >= 0; j3--) {
          if (this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.setPos(j2, j3, l2))) {
            while (j3 > 0 && this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.setPos(j2, j3 - 1, l2)))
              j3--; 
            int k3;
              ...
              for (int j4 = 0; j4 < 3; j4++) {
                for (int k4 = 0; k4 < 4; k4++) {
                  for (int l4 = -1; l4 < 4; ) {
                    ...
                    if (l4 >= 0 || this.worldServerInstance.getBlockState((BlockPos)blockpos$mutableblockpos).getMaterial().isSolid()) {
      ...
      for (int l5 = j - 16; l5 <= j + 16; l5++) {
        ...
        for (int j6 = l - 16; j6 <= l + 16; j6++) {
          ...
          for (int i7 = this.worldServerInstance.getActualHeight() - 1; i7 >= 0; i7--) {
            if (this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.setPos(l5, i7, j6))) {
              while (i7 > 0 && this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.setPos(l5, i7 - 1, j6)))
                i7--; 
              int k7;
              label167: for (k7 = i2; k7 < i2 + 2; k7++) {
                ...
                for (int j10 = 0; j10 < 4; j10++) {
                  for (int j11 = -1; j11 < 4; ) {
                    ...
                    if (j11 >= 0 || this.worldServerInstance.getBlockState((BlockPos)blockpos$mutableblockpos).getMaterial().isSolid()) {
    ...
    IBlockState iblockstate = Blocks.PORTAL.getDefaultState().withProperty((IProperty)BlockPortal.AXIS, (l6 == 0) ? (Comparable)EnumFacing.Axis.Z : (Comparable)EnumFacing.Axis.X);
