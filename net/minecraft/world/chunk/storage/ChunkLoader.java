  ...
  public static void convertToAnvilFormat(AnvilConverterData converterData, NBTTagCompound compound, BiomeProvider provider) {
    ...
    for (int l2 = 0; l2 < 16; l2++) {
      for (int i3 = 0; i3 < 16; i3++) {
        ...
        abyte[i3 << 4 | l2] = (byte)(Biome.getIdForBiome(provider.getBiome((BlockPos)blockpos$mutableblockpos, Biomes.DEFAULT)) & 0xFF);
      } 
    } 
    compound.setByteArray("Biomes", abyte);
    compound.setTag("Entities", (NBTBase)converterData.entities);
    compound.setTag("TileEntities", (NBTBase)converterData.tileEntities);
    if (converterData.tileTicks != null)
      compound.setTag("TileTicks", (NBTBase)converterData.tileTicks); 
  }
