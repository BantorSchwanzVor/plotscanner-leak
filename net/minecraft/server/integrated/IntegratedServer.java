...
public class IntegratedServer extends MinecraftServer {
  ...
  public IntegratedServer(Minecraft clientIn, String folderNameIn, String worldNameIn, WorldSettings worldSettingsIn, YggdrasilAuthenticationService authServiceIn, MinecraftSessionService sessionServiceIn, GameProfileRepository profileRepoIn, PlayerProfileCache profileCacheIn) {
    ...
    this.mc = clientIn;
    this.theWorldSettings = isDemo() ? WorldServerDemo.DEMO_WORLD_SETTINGS : worldSettingsIn;
  }
  ...
  public void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, String generatorOptions) {
    ...
    if (Reflector.DimensionManager.exists()) {
      WorldServer worldserver = isDemo() ? (WorldServer)(new WorldServerDemo(this, isavehandler, worldinfo, 0, this.theProfiler)).init() : (WorldServer)(new WorldServerOF(this, isavehandler, worldinfo, 0, this.theProfiler)).init();
      ...
      for (int j1 = 0; j1 < i1; j1++) {
        ...
        worldserver1.addEventListener((IWorldEventListener)new ServerWorldEventHandler(this, worldserver1));
        if (!isSinglePlayer())
      ...
      for (int l = 0; l < this.worldServers.length; l++) {
        ...
        this.worldServers[l].addEventListener((IWorldEventListener)new ServerWorldEventHandler(this, this.worldServers[l]));
      } 
      getPlayerList().setPlayerManager(this.worldServers);
  ...
  public boolean startServer() throws IOException {
    ...
    loadAllWorlds(getFolderName(), getWorldName(), this.theWorldSettings.getSeed(), this.theWorldSettings.getTerrainType(), this.theWorldSettings.getGeneratorOptions());
