...
public class NetHandlerLoginServer implements INetHandlerLoginServer, ITickable {
  ...
  public void update() {
    ...
    if (this.connectionTimer++ == 600)
      func_194026_b((ITextComponent)new TextComponentTranslation("multiplayer.disconnect.slow_login", new Object[0])); 
  }
  
  public void func_194026_b(ITextComponent p_194026_1_) {
    try {
      LOGGER.info("Disconnecting {}: {}", getConnectionInfo(), p_194026_1_.getUnformattedText());
      this.networkManager.sendPacket((Packet)new SPacketDisconnect(p_194026_1_));
  ...
  public void tryAcceptPlayer() {
    ...
    if (s != null) {
      func_194026_b((ITextComponent)new TextComponentTranslation(s, new Object[0]));
    } else {
      ...
      if (this.server.getNetworkCompressionThreshold() >= 0 && !this.networkManager.isLocalChannel())
        this.networkManager.sendPacket((Packet)new SPacketEnableCompression(this.server.getNetworkCompressionThreshold()), (GenericFutureListener)new ChannelFutureListener() {
      ...
      this.networkManager.sendPacket((Packet)new SPacketLoginSuccess(this.loginGameProfile));
      EntityPlayerMP entityplayermp = this.server.getPlayerList().getPlayerByUUID(this.loginGameProfile.getId());
      if (entityplayermp != null) {
  ...
  public void processLoginStart(CPacketLoginStart packetIn) {
    ...
    if (this.server.isServerInOnlineMode() && !this.networkManager.isLocalChannel()) {
      ...
      this.networkManager.sendPacket((Packet)new SPacketEncryptionRequest("", this.server.getKeyPair().getPublic(), this.verifyToken));
    } else {
      this.currentLoginState = LoginState.READY_TO_ACCEPT;
    } 
  }
    ...
    (new Thread("User Authenticator #" + AUTHENTICATOR_THREAD_ID.incrementAndGet()) {
        public void run() {
          ...
          try {
            ...
            NetHandlerLoginServer.this.loginGameProfile = NetHandlerLoginServer.this.server.getMinecraftSessionService().hasJoinedServer(new GameProfile(null, gameprofile.getName()), s, func_191235_a());
            if (NetHandlerLoginServer.this.loginGameProfile != null) {
              ...
              NetHandlerLoginServer.this.func_194026_b((ITextComponent)new TextComponentTranslation("multiplayer.disconnect.unverified_username", new Object[0]));
            ...
            if (NetHandlerLoginServer.this.server.isSinglePlayer()) {
              ...
              NetHandlerLoginServer.this.func_194026_b((ITextComponent)new TextComponentTranslation("multiplayer.disconnect.authservers_down", new Object[0]));
