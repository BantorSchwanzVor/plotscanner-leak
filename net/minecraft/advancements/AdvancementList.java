  ...
  public void func_192083_a(Map<ResourceLocation, Advancement.Builder> p_192083_1_) {
    ...
    while (!p_192083_1_.isEmpty()) {
      ...
      while (iterator.hasNext()) {
        ...
        if (advancement$builder.func_192058_a((Function<ResourceLocation, Advancement>)function)) {
      ...
      if (!flag) {
        ...
        while (iterator.hasNext()) {
          Map.Entry<ResourceLocation, Advancement.Builder> entry1 = iterator.next();
