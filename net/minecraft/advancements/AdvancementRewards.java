...
public class AdvancementRewards {
  ...
  public void func_192113_a(final EntityPlayerMP p_192113_1_) {
    ...
    LootContext lootcontext = (new LootContext.Builder(p_192113_1_.getServerWorld())).withLootedEntity((Entity)p_192113_1_).build();
    boolean flag = false;
    byte b;
    int i;
    ResourceLocation[] arrayOfResourceLocation;
    for (i = (arrayOfResourceLocation = this.field_192116_c).length, b = 0; b < i; ) {
