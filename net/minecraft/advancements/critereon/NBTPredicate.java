...
public class NBTPredicate {
  ...
  public boolean func_193478_a(ItemStack p_193478_1_) {
    return (this == field_193479_a) ? true : func_193477_a((NBTBase)p_193478_1_.getTagCompound());
  }
  
  public boolean func_193475_a(Entity p_193475_1_) {
    return (this == field_193479_a) ? true : func_193477_a((NBTBase)CommandBase.entityToNBT(p_193475_1_));
  }
  
  public boolean func_193477_a(@Nullable NBTBase p_193477_1_) {
    if (p_193477_1_ == null)
      return (this == field_193479_a); 
    return !(this.field_193480_b != null && !NBTUtil.areNBTEquals((NBTBase)this.field_193480_b, p_193477_1_, true));
  }
