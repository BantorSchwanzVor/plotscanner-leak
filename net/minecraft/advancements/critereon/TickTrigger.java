...
public class TickTrigger implements ICriterionTrigger<TickTrigger.Instance> {
  ...
  static class Listeners {
    ...
    public void func_193503_b() {
      for (ICriterionTrigger.Listener<TickTrigger.Instance> listener : (Iterable<ICriterionTrigger.Listener<TickTrigger.Instance>>)Lists.newArrayList(this.field_193505_b))
