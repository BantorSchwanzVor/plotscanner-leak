...
public class MobEffectsPredicate {
  ...
  public boolean func_193469_a(Entity p_193469_1_) {
    if (this == field_193473_a)
      return true; 
    return (p_193469_1_ instanceof EntityLivingBase) ? func_193470_a(((EntityLivingBase)p_193469_1_).func_193076_bZ()) : false;
  }
  
  public boolean func_193472_a(EntityLivingBase p_193472_1_) {
    return (this == field_193473_a) ? true : func_193470_a(p_193472_1_.func_193076_bZ());
  }
  ...
  public boolean func_193470_a(Map<Potion, PotionEffect> p_193470_1_) {
    ...
    for (Map.Entry<Potion, InstancePredicate> entry : this.field_193474_b.entrySet()) {
      ...
      if (!((InstancePredicate)entry.getValue()).func_193463_a(potioneffect))
        return false; 
    } 
    return true;
  }
