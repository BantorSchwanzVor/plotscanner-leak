...
public class BredAnimalsTrigger implements ICriterionTrigger<BredAnimalsTrigger.Instance> {
  ...
  public static class Instance extends AbstractCriterionInstance {
    ...
    public boolean func_192246_a(EntityPlayerMP p_192246_1_, EntityAnimal p_192246_2_, EntityAnimal p_192246_3_, EntityAgeable p_192246_4_) {
      if (!this.field_192249_c.func_192482_a(p_192246_1_, (Entity)p_192246_4_))
        return false; 
      return !((!this.field_192247_a.func_192482_a(p_192246_1_, (Entity)p_192246_2_) || !this.field_192248_b.func_192482_a(p_192246_1_, (Entity)p_192246_3_)) && (!this.field_192247_a.func_192482_a(p_192246_1_, (Entity)p_192246_3_) || !this.field_192248_b.func_192482_a(p_192246_1_, (Entity)p_192246_2_)));
    }
  }
