...
public class AdvancementManager {
  ...
  public void func_192779_a() {
    ...
    Map<ResourceLocation, Advancement.Builder> map = func_192781_c();
    func_192777_a(map);
  ...
  private void func_192777_a(Map<ResourceLocation, Advancement.Builder> p_192777_1_) {
    ...
    try {
      ...
      if (url != null) {
        ...
        Iterator<Path> iterator = Files.walk(path, new java.nio.file.FileVisitOption[0]).iterator();
      ...
      this.field_193768_e = true;
    } catch (IOException|java.net.URISyntaxException urisyntaxexception) {
