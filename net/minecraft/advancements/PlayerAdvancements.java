...
public class PlayerAdvancements {
  ...
  private void func_192740_f() {
    if (this.field_192757_e.isFile())
      try {
        ...
        for (Map.Entry<ResourceLocation, AdvancementProgress> entry : (Iterable<Map.Entry<ResourceLocation, AdvancementProgress>>)stream.collect((Collector)Collectors.toList())) {
    ...
    if (advancementprogress.func_192109_a(p_192750_2_)) {
      ...
      if (!flag1 && advancementprogress.func_192105_a()) {
        ...
        if (p_192750_1_.func_192068_c() != null && p_192750_1_.func_192068_c().func_193220_i() && this.field_192762_j.world.getGameRules().getBoolean("announceAdvancements"))
          this.field_192756_d.getPlayerList().sendChatMsg((ITextComponent)new TextComponentTranslation("chat.type.advancement." + p_192750_1_.func_192068_c().func_192291_d().func_192307_a(), new Object[] { this.field_192762_j.getDisplayName(), p_192750_1_.func_193123_j() })); 
      } 
    } 
  ...
  public void func_192741_b(EntityPlayerMP p_192741_1_) {
    if (!this.field_192760_h.isEmpty() || !this.field_192761_i.isEmpty()) {
      ...
      if (!map.isEmpty() || !set.isEmpty() || !set1.isEmpty()) {
        p_192741_1_.connection.sendPacket((Packet)new SPacketAdvancementInfo(this.field_192763_k, set, set1, map));
        this.field_192760_h.clear();
        this.field_192761_i.clear();
      } 
    } 
  ...
  public void func_194220_a(@Nullable Advancement p_194220_1_) {
    ...
    if (advancement != this.field_194221_k)
      this.field_192762_j.connection.sendPacket((Packet)new SPacketSelectAdvancementsTab((this.field_194221_k == null) ? null : this.field_194221_k.func_192067_g())); 
  }
  ...
  private void func_192742_b(Advancement p_192742_1_) {
    ...
    if (flag != flag1 && p_192742_1_.func_192070_b() != null)
      func_192742_b(p_192742_1_.func_192070_b()); 
