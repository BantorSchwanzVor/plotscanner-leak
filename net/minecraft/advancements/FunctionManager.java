...
public class FunctionManager implements ITickable {
  ...
  private final ICommandSender field_193073_g = new ICommandSender() {
      ...
      public World getEntityWorld() {
        return (World)FunctionManager.this.field_193069_c.worldServers[0];
      }
  ...
  public void update() {
    ...
    if (!s.equals(this.field_193071_e)) {
      ...
      this.field_193072_f = func_193058_a(new ResourceLocation(s));
    } 
  ...
  public int func_194019_a(FunctionObject p_194019_1_, ICommandSender p_194019_2_) {
    int l, i = func_193065_c();
    if (this.field_194021_h) {
      if (this.field_194020_g.size() < i)
        this.field_194020_g.addFirst(new QueuedCommand(this, p_194019_2_, (FunctionObject.Entry)new FunctionObject.FunctionEntry(p_194019_1_))); 
      return 0;
    } 
    try {
