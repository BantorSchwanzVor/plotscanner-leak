...
public class PathNavigateFlying extends PathNavigate {
  ...
  protected boolean canNavigate() {
    return !((!func_192880_g() || !isInLiquid()) && this.theEntity.isRiding());
  }
  ...
  public void onUpdateNavigation() {
    ...
    if (!noPath()) {
      if (canNavigate()) {
        ...
        Vec3d vec3d = this.currentPath.getVectorFromIndex((Entity)this.theEntity, this.currentPath.getCurrentPathIndex());
      ...
      func_192876_m();
      if (!noPath()) {
        Vec3d vec3d1 = this.currentPath.getPosition((Entity)this.theEntity);
