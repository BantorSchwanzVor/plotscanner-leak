...
public class FlyingNodeProcessor extends WalkNodeProcessor {
  ...
  public PathPoint getStart() {
    ...
    BlockPos blockpos1 = new BlockPos((Entity)this.entity);
    PathNodeType pathnodetype1 = func_192558_a(this.entity, blockpos1.getX(), i, blockpos1.getZ());
    if (this.entity.getPathPriority(pathnodetype1) < 0.0F) {
      ...
      for (BlockPos blockpos : set) {
        PathNodeType pathnodetype = func_192559_a(this.entity, blockpos);
  ...
  protected PathPoint openPoint(int x, int y, int z) {
    ...
    PathNodeType pathnodetype = func_192558_a(this.entity, x, y, z);
  ...
  private PathNodeType func_192558_a(EntityLiving p_192558_1_, int p_192558_2_, int p_192558_3_, int p_192558_4_) {
    return getPathNodeType(this.blockaccess, p_192558_2_, p_192558_3_, p_192558_4_, p_192558_1_, this.entitySizeX, this.entitySizeY, this.entitySizeZ, getCanBreakDoors(), getCanEnterDoors());
  }
}
