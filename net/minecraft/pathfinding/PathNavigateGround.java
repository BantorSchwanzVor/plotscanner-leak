...
public class PathNavigateGround extends PathNavigate {
  ...
  protected boolean canNavigate() {
    return !(!this.theEntity.onGround && (!getCanSwim() || !isInLiquid()) && !this.theEntity.isRiding());
  }
  
  protected Vec3d getEntityPosition() {
    return new Vec3d(this.theEntity.posX, getPathablePosY(), this.theEntity.posZ);
  }
    ...
    for (int k = i; k < i + sizeX; k++) {
      for (int l = j; l < j + sizeZ; l++) {
        ...
        if (d0 * p_179683_8_ + d1 * p_179683_10_ >= 0.0D) {
          PathNodeType pathnodetype = this.nodeProcessor.getPathNodeType((IBlockAccess)this.worldObj, k, y - 1, l, this.theEntity, sizeX, sizeY, sizeZ, true, true);
          ...
          if (pathnodetype == PathNodeType.OPEN)
            return false; 
          pathnodetype = this.nodeProcessor.getPathNodeType((IBlockAccess)this.worldObj, k, y, l, this.theEntity, sizeX, sizeY, sizeZ, true, true);
