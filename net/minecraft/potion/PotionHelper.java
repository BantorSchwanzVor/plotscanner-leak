...
public class PotionHelper {
  ...
  public static void init() {
    ...
    func_193356_a(PotionTypes.AWKWARD, Ingredient.func_193369_a(new ItemStack[] { new ItemStack(Items.FISH, 1, ItemFishFood.FishType.PUFFERFISH.getMetadata()) }), PotionTypes.WATER_BREATHING);
  ...
  private static void func_193355_a(ItemPotion p_193355_0_, Item p_193355_1_, ItemPotion p_193355_2_) {
    POTION_ITEM_CONVERSIONS.add(new MixPredicate(p_193355_0_, Ingredient.func_193368_a(new Item[] { p_193355_1_ }, ), p_193355_2_));
  }
  
  private static void func_193354_a(ItemPotion p_193354_0_) {
    POTION_ITEMS.add(Ingredient.func_193368_a(new Item[] { (Item)p_193354_0_ }));
  }
  
  private static void func_193357_a(PotionType p_193357_0_, Item p_193357_1_, PotionType p_193357_2_) {
    func_193356_a(p_193357_0_, Ingredient.func_193368_a(new Item[] { p_193357_1_ }, ), p_193357_2_);
  }
