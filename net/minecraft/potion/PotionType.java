...
public class PotionType {
  ...
  public String getNamePrefixed(String p_185174_1_) {
    return (this.baseName == null) ? (String.valueOf(p_185174_1_) + ((ResourceLocation)REGISTRY.getNameForObject(this)).getResourcePath()) : (String.valueOf(p_185174_1_) + this.baseName);
  }
