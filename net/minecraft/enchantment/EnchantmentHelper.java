...
public class EnchantmentHelper {
  private static final ModifierDamage ENCHANTMENT_MODIFIER_DAMAGE = new ModifierDamage(null);
  
  private static final ModifierLiving ENCHANTMENT_MODIFIER_LIVING = new ModifierLiving(null);
  ...
  public static List<EnchantmentData> buildEnchantmentList(Random randomIn, ItemStack itemStackIn, int p_77513_2_, boolean allowTreasure) {
    ...
    p_77513_2_ = MathHelper.clamp(Math.round(p_77513_2_ + p_77513_2_ * f), 1, 2147483647);
    List<EnchantmentData> list1 = getEnchantmentDatas(p_77513_2_, itemStackIn, allowTreasure);
    if (!list1.isEmpty()) {
      list.add((EnchantmentData)WeightedRandom.getRandomItem(randomIn, list1));
