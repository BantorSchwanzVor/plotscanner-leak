...
public abstract class Enchantment {
  ...
  public List<ItemStack> getEntityEquipment(EntityLivingBase entityIn) {
    ...
    for (i = (arrayOfEntityEquipmentSlot = this.applicableEquipmentTypes).length, b = 0; b < i; ) {
  ...
  public String getTranslatedName(int level) {
    ...
    return (level == 1 && getMaxLevel() == 1) ? s : (String.valueOf(s) + " " + I18n.translateToLocal("enchantment.level." + level));
  }
