  ...
  ParameterBindingsImpl(PreparedQuery<?> query, Session session, ResultSetFactory resultSetFactory) throws SQLException {
    ...
    for (int j = 0; j < paramCount; j++) {
      ...
      switch (this.queryBindings.getBindValues()[j].getMysqlType()) {
        ...
        default:
          try {
            charsetIndex = CharsetMapping.getCollationIndexForJavaEncoding((String)this.propertySet
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\com\mysql\cj\jdbc\ParameterBindingsImpl.class
