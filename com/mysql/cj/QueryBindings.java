...
public interface QueryBindings<T extends BindValue> {
  ...
  void setTimestamp(int paramInt, Timestamp paramTimestamp, Calendar paramCalendar);
  
  void setTimestamp(int paramInt, Timestamp paramTimestamp);
  
  void setTimestamp(int paramInt1, Timestamp paramTimestamp, Calendar paramCalendar, int paramInt2);
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\com\mysql\cj\QueryBindings.class
