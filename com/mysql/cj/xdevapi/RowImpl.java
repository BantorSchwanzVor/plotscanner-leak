...
public class RowImpl implements Row {
  ...
  public Timestamp getTimestamp(int pos) {
    return (Timestamp)this.row.getValue(pos, (ValueFactory)new SqlTimestampValueFactory(this.pset, null, this.defaultTimeZone));
  }
}


/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\com\mysql\cj\xdevapi\RowImpl.class
