...
public class NativePacketPayload implements Message {
  ...
  public final boolean isEOFPacket() {
    return ((this.byteBuffer[0] & 0xFF) == 254 && getPayloadLength() <= 5);
  }
  ...
  public final boolean isResultSetOKPacket() {
    return ((this.byteBuffer[0] & 0xFF) == 254 && getPayloadLength() < 16777215);
  }
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\com\mysql\cj\protocol\a\NativePacketPayload.class
