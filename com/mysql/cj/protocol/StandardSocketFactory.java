...
public class StandardSocketFactory implements SocketFactory {
  ...
  public <T extends java.io.Closeable> T performTlsHandshake(SocketConnection socketConnection, ServerSession serverSession) throws IOException {
    this.sslSocket = ExportControlled.performTlsHandshake(this.rawSocket, socketConnection, (serverSession == null) ? null : serverSession
        .getServerVersion());
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\com\mysql\cj\protocol\StandardSocketFactory.class
