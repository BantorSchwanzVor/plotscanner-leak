...
public abstract class AbstractQueryBindings<T extends BindValue> implements QueryBindings<T> {
  ...
  public void setObject(int parameterIndex, Object parameterObj) {
    ...
    } else if (((Boolean)this.treatUtilDateAsTimestamp.getValue()).booleanValue() && parameterObj instanceof Date) {
          ...
          case YEAR:
            ...
            switch (targetMysqlType) {
              ...
              case YEAR:
                ...
                setNumericObject(parameterIndex, Integer.valueOf(cal.get(1)), targetMysqlType, scaleOrLength);
                break;
            } 
            return;
          case TIME:
        ...
        if (parameterAsNum instanceof BigDecimal) {
          ...
          try {
            ...
            try {
              ...
              throw (WrongArgumentException)ExceptionFactory.createException(WrongArgumentException.class, 
                  Messages.getString("PreparedStatement.65", new Object[] { Integer.valueOf(scale), parameterAsNum }), this.session.getExceptionInterceptor());
            } 
          } 
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\com\mysql\cj\AbstractQueryBindings.class
