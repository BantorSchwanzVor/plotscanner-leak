...
public class Shaders {
  ...
  private static void printChat(String str) {
    mc.ingameGUI.getChatGUI().printChatMessage((ITextComponent)new TextComponentString(str));
  }
  ...
  public static void beginRender(Minecraft minecraft, float partialTicks, long finishTimeNano) {
    ...
    checkWorldChanged((World)mc.world);
    mc = minecraft;
    ...
    if (entity != null) {
      ...
      if (mc.player != null) {
        ...
        if (mc.player.isPotionActive(MobEffects.NIGHT_VISION))
          nightVision = (Config.getMinecraft()).entityRenderer.getNightVisionBrightness((EntityLivingBase)mc.player, partialTicks); 
        blindness = 0.0F;
  ...
  public static void pushEntity(Block block) {
    ...
    entityData[entityDataIndex * 2] = Block.REGISTRY.getIDForObject(block) & 0xFFFF | i << 16;
    entityData[entityDataIndex * 2 + 1] = 0;
  }
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\shadersmod\client\Shaders.class
