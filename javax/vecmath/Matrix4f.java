...
public class Matrix4f implements Serializable, Cloneable {
  ...
  public final float determinant() {
    float det = this.m00 * (this.m11 * this.m22 * this.m33 + this.m12 * this.m23 * this.m31 + this.m13 * this.m21 * this.m32 - 
  ...
  public final void transform(Tuple4f vec, Tuple4f vecOut) {
    float x = this.m00 * vec.x + this.m01 * vec.y + 
      this.m02 * vec.z + this.m03 * vec.w;
    float y = this.m10 * vec.x + this.m11 * vec.y + 
      this.m12 * vec.z + this.m13 * vec.w;
    float z = this.m20 * vec.x + this.m21 * vec.y + 
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\javax\vecmath\Matrix4f.class
