...
public class Matrix4d implements Serializable, Cloneable {
  ...
  public String toString() {
    return 
      String.valueOf(this.m00) + ", " + this.m01 + ", " + this.m02 + ", " + this.m03 + "\n" + 
  ...
  static void luBacksubstitution(double[] matrix1, int[] row_perm, double[] matrix2) {
    ...
    for (int k = 0; k < 4; k++) {
      ...
      rv -= 4;
      matrix2[cv + 8] = (matrix2[cv + 8] - 
        matrix1[rv + 3] * matrix2[cv + 12]) / matrix1[rv + 2];
      rv -= 4;
      matrix2[cv + 4] = (matrix2[cv + 4] - 
        matrix1[rv + 2] * matrix2[cv + 8] - 
        matrix1[rv + 3] * matrix2[cv + 12]) / matrix1[rv + 1];
      rv -= 4;
  ...
  public final double determinant() {
    double det = this.m00 * (this.m11 * this.m22 * this.m33 + this.m12 * this.m23 * this.m31 + this.m13 * this.m21 * this.m32 - 
  ...
  public final void transform(Tuple4d vec, Tuple4d vecOut) {
    double x = this.m00 * vec.x + this.m01 * vec.y + 
      this.m02 * vec.z + this.m03 * vec.w;
    double y = this.m10 * vec.x + this.m11 * vec.y + 
      this.m12 * vec.z + this.m13 * vec.w;
    double z = this.m20 * vec.x + this.m21 * vec.y + 
      this.m22 * vec.z + this.m23 * vec.w;
    vecOut.w = this.m30 * vec.x + this.m31 * vec.y + 
      this.m32 * vec.z + this.m33 * vec.w;
    vecOut.x = x;
    vecOut.y = y;
    vecOut.z = z;
  }
  ...
  public final void transform(Tuple4d vec) {
    ...
    double z = this.m20 * vec.x + this.m21 * vec.y + 
      this.m22 * vec.z + this.m23 * vec.w;
    vec.w = this.m30 * vec.x + this.m31 * vec.y + 
      this.m32 * vec.z + this.m33 * vec.w;
    vec.x = x;
    vec.y = y;
    vec.z = z;
  ...
  public final void transform(Tuple4f vec, Tuple4f vecOut) {
    float x = (float)(this.m00 * vec.x + this.m01 * vec.y + 
      this.m02 * vec.z + this.m03 * vec.w);
    float y = (float)(this.m10 * vec.x + this.m11 * vec.y + 
      this.m12 * vec.z + this.m13 * vec.w);
    float z = (float)(this.m20 * vec.x + this.m21 * vec.y + 
      this.m22 * vec.z + this.m23 * vec.w);
    vecOut.w = 
      (float)(this.m30 * vec.x + this.m31 * vec.y + this.m32 * vec.z + this.m33 * vec.w);
    vecOut.x = x;
    vecOut.y = y;
    vecOut.z = z;
  }
...
/* Location:              C:\Users\BSV\AppData\Local\Temp\Rar$DRa6216.20396\Preview\Preview.jar!\javax\vecmath\Matrix4d.class
